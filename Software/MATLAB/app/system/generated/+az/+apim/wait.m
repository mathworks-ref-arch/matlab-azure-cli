classdef wait < azure.AzureBase
    ...
    methods
        function this = wait()
            % az apim wait : Place the CLI in a waiting state until a condition of an apim is met.
            % Command group 'apim' is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az apim wait ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az apim wait"')
