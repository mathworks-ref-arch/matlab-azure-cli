classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az apim api show : Show details of an API Management API.
            % Command group 'apim api' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az apim api show ';
        end
        ...
        function this = service_name(this, varargin)
            % The name of the API Management service instance. API Arguments
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az apim api show"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --service-name      [Required] : The name of the API Management service instance.')
            fprintf('%s\n', 'API Arguments')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az apim api show"')
