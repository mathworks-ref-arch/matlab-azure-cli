classdef wait < azure.AzureBase
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --instance-id       : Wait on the VM instance with this ID. If missing, Wait on the VMSS.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az vmss wait"')
