classdef scale < azure.AzureBase
    ...
    methods
        function this = scale()
            ...
            this.BaseCmd = 'az vmss scale ';
        end
        function this = new_capacity(this, varargin)
            % Number of VMs in the VMSS.
            this.Options = [this.Options, '--new-capacity', varargin{:}];
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    az vmss scale : Change the number of VMs within a VMSS.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --new-capacity [Required] : Number of VMs in the VMSS.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az vmss scale"')
