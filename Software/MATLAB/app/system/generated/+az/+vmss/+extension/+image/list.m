classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            ...
            this.BaseCmd = 'az vmss extension image list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '            -o tsv | sort -u | xargs -I{} az vmss extension image list-names --publisher {} -l')
            fprintf('%s\n', '        westus')
            fprintf('%s\n', 'For more specific examples, use: az find "az vmss extension image list"')
