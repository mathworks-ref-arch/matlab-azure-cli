classdef list_versions < azure.AzureBase
    ...
    methods
        function this = list_versions()
            ...
            this.BaseCmd = 'az vmss extension image list-versions ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az vmss extension image list-versions"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az vmss extension image list-versions"')
