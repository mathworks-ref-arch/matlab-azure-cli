classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            ...
            this.BaseCmd = 'az vmss extension delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az vmss extension delete --name MyExtension --resource-group MyResourceGroup --vmss-name')
            fprintf('%s\n', '        MyVmss')
            fprintf('%s\n', 'For more specific examples, use: az find "az vmss extension delete"')
