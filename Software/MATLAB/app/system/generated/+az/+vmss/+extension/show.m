classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            ...
            this.BaseCmd = 'az vmss extension show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az vmss extension show --name MyExtension --resource-group MyResourceGroup --vmss-name')
            fprintf('%s\n', '        MyVmss')
            fprintf('%s\n', 'For more specific examples, use: az find "az vmss extension show"')
