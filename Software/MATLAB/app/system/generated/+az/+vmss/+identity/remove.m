classdef remove < azure.AzureBase
    ...
    methods
        function this = remove()
            ...
            this.BaseCmd = 'az vmss identity remove ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        This command is in preview. It may be changed/removed in a future release.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --identities        : Space-separated identities to remove. Use ''[system]'' to refer to the')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az vmss identity remove"')
