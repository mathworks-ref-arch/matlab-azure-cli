classdef get_instance_view < azure.AzureBase
    ...
    methods
        function this = get_instance_view()
            ...
            this.BaseCmd = 'az vmss get-instance-view ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --instance-id       : A VM instance ID or "*" to list instance view for all VMs in a scale set.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az vmss get-instance-view"')
