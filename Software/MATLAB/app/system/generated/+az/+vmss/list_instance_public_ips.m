classdef list_instance_public_ips < azure.AzureBase

    % Copyright 2020, The MathWorks Inc.

    methods
        function this = list_instance_public_ips()
            % az vmss list-instance-public-ips : List public IP addresses of VM instances within a set.
            this.BaseCmd = 'az vmss list-instance-public-ips ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az vmss list-instance-public-ips"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class list_instance_public_ips 
