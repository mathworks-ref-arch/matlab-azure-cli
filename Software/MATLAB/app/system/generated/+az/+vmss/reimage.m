classdef reimage < azure.AzureBase
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --instance-id       : VM instance ID. If missing, reimage all instances.')
            ...
            fprintf('%s\n', '        az vmss reimage --instance-id 1 --name MyScaleSet --resource-group MyResourceGroup')
            fprintf('%s\n', '        --subscription MySubscription')
            fprintf('%s\n', 'For more specific examples, use: az find "az vmss reimage"')
