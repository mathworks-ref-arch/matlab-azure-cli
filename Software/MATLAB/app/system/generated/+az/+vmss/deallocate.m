classdef deallocate < azure.AzureBase

    % Copyright 2020, The MathWorks Inc.

    methods
        function this = deallocate()
            % az vmss deallocate : Deallocate VMs within a VMSS.
            this.BaseCmd = 'az vmss deallocate ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az vmss deallocate"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class deallocate 
