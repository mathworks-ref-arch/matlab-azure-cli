classdef update_instances < azure.AzureBase

    % Copyright 2020, The MathWorks Inc.

    methods
        function this = update_instances()
            % az vmss update-instances : Upgrade VMs within a VMSS.
            this.BaseCmd = 'az vmss update-instances ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az vmss update-instances"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class update_instances 
