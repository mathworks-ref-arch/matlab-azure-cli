classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az disk-encryption-set update : Update a disk encryption set.
            this.BaseCmd = 'az disk-encryption-set update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    az disk-encryption-set update : Update a disk encryption set.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --key-url           : URL pointing to a key or secret in KeyVault.')
            fprintf('%s\n', '    --source-vault      : Name or ID of the KeyVault containing the key or secret.')
            ...
            fprintf('%s\n', '    --name -n           : Name of disk encryption set.')
            ...
            fprintf('%s\n', '        az disk-encryption-set update --name MyDiskEncryptionSet --resource-group MyResourceGroup')
            fprintf('%s\n', '        --key-url MyKey --source-vault MyVault')
            fprintf('%s\n', 'For more specific examples, use: az find "az disk-encryption-set update"')
