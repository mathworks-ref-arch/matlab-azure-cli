classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az disk-encryption-set delete : Delete a disk encryption set.
            this.BaseCmd = 'az disk-encryption-set delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az disk-encryption-set delete"')
