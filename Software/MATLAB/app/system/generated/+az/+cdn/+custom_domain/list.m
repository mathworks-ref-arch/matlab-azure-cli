classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az cdn custom-domain list : Lists all of the existing custom domains within an endpoint.
            this.BaseCmd = 'az cdn custom-domain list ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az cdn custom-domain list"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az cdn custom-domain list"')
