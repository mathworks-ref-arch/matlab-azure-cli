classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az cdn custom-domain show : Show details for the custom domain of a CDN.
            this.BaseCmd = 'az cdn custom-domain show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az cdn custom-domain show -g group --endpoint-name endpoint --profile-name profile -n')
            fprintf('%s\n', '        domain-name')
            fprintf('%s\n', 'For more specific examples, use: az find "az cdn custom-domain show"')
