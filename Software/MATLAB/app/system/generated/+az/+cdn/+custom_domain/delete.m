classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az cdn custom-domain delete : Delete the custom domain of a CDN.
            this.BaseCmd = 'az cdn custom-domain delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az cdn custom-domain delete -g group --endpoint-name endpoint --profile-name profile -n')
            fprintf('%s\n', '        domain-name')
            fprintf('%s\n', 'For more specific examples, use: az find "az cdn custom-domain delete"')
