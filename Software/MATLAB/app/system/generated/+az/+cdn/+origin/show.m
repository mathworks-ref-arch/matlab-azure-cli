classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az cdn origin show : Gets an existing origin within an endpoint.
            this.BaseCmd = 'az cdn origin show ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az cdn origin show"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az cdn origin show"')
