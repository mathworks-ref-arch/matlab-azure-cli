classdef remove < azure.AzureBase
    ...
    methods
        function this = remove()
            % az cdn endpoint rule remove : Remove a delivery rule from an endpoint.
            % Command group 'cdn endpoint rule' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az cdn endpoint rule remove ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az cdn endpoint rule remove"')
