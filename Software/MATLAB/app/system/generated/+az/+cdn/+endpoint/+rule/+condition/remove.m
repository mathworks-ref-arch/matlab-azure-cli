classdef remove < azure.AzureBase
    ...
    methods
        function this = remove()
            % az cdn endpoint rule condition remove : Remove a condition from a delivery rule.
            % Command group 'cdn endpoint rule condition' is in preview. It may be changed/removed in
            % a future release.
            this.BaseCmd = 'az cdn endpoint rule condition remove ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az cdn endpoint rule condition remove -g group -n endpoint --profile-name profile --rule-')
            fprintf('%s\n', '        name name --index 0')
            fprintf('%s\n', 'For more specific examples, use: az find "az cdn endpoint rule condition remove"')
