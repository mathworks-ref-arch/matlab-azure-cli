classdef load < azure.AzureBase
    ...
    methods
        function this = load()
            ...
            this.BaseCmd = 'az cdn endpoint load ';
        end
        function this = content_paths(this, varargin)
            % The path to the content to be loaded. Path should be a relative file URL of the origin.
            this.Options = [this.Options, '--content-paths', varargin{:}];
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    az cdn endpoint load : Pre-load content for a CDN endpoint.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --content-paths [Required] : The path to the content to be loaded. Path should be a relative')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az cdn endpoint load"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class load 
