classdef add < azure.AzureBase
    ...
    methods
        function this = add()
            % az cdn endpoint rule action add : Add an action to a delivery rule.
            % Command group 'cdn endpoint rule action' is in preview. It may be changed/removed in a
            % future release.
            this.BaseCmd = 'az cdn endpoint rule action add ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az cdn endpoint rule action add"')
