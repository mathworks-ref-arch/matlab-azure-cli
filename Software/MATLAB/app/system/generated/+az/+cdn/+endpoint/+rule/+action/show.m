classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az cdn endpoint rule action show : Show delivery rules asscociate with the endpoint.
            % Command group 'cdn endpoint rule action' is in preview. It may be changed/removed in a
            % future release.
            this.BaseCmd = 'az cdn endpoint rule action show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az cdn endpoint rule action show"')
