classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az cdn endpoint waf policy show : Show which CDN WAF policy is applied to a CDN endpoint.
            % Command group 'cdn endpoint waf policy' is in preview. It may be changed/removed in a
            % future release.
            this.BaseCmd = 'az cdn endpoint waf policy show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az cdn endpoint waf policy show"')
