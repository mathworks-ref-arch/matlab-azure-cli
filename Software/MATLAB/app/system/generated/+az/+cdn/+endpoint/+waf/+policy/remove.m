classdef remove < azure.AzureBase
    ...
    methods
        function this = remove()
            % az cdn endpoint waf policy remove : Remove a CDN WAF policy from a CDN endpoint.
            % Command group 'cdn endpoint waf policy' is in preview. It may be changed/removed in a
            % future release.
            this.BaseCmd = 'az cdn endpoint waf policy remove ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az cdn endpoint waf policy remove"')
