classdef purge < azure.AzureBase
    ...
    methods
        function this = purge()
            ...
            this.BaseCmd = 'az cdn endpoint purge ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    az cdn endpoint purge : Purge pre-loaded content for a CDN endpoint.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --content-paths [Required] : The path to the content to be purged. Can describe a file path or a')
            fprintf('%s\n', '                                 wild card directory.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az cdn endpoint purge"')
