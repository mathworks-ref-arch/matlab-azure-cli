classdef sync < azure.AzureBase
    ...
    methods
        function this = sync()
            % az functionapp deployment source sync : Synchronize from the repository. Only needed under
            % manual integration mode.
            this.BaseCmd = 'az functionapp deployment source sync ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az functionapp deployment source sync"')
