classdef config < azure.AzureBase
    ...
    methods
        function this = config()
            ...
            this.BaseCmd = 'az functionapp deployment container config ';
        end
        function this = enable_cd(this, varargin)
            % Enable/disable continuous deployment.  Allowed values: false, true.
            this.Options = [this.Options, '--enable-cd', varargin{:}];
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az functionapp deployment container config --enable-cd true --name MyFunctionApp --resource-')
            fprintf('%s\n', '        group MyResourceGroup')
            fprintf('%s\n', 'For more specific examples, use: az find "az functionapp deployment container config"')
