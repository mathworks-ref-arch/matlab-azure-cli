classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az functionapp deployment source show : Get the details of a source control deployment
            % configuration.
            this.BaseCmd = 'az functionapp deployment source show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az functionapp deployment source show"')
