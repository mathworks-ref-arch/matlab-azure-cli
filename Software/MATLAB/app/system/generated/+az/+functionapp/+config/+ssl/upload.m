classdef upload < azure.AzureBase
    ...
    methods
        function this = upload()
            ...
            this.BaseCmd = 'az functionapp config ssl upload ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az functionapp config ssl upload --certificate-file {certificate-file} --certificate-')
            fprintf('%s\n', '        password {certificate-password} --name MyFunctionApp     --resource-group MyResourceGroup')
            fprintf('%s\n', 'For more specific examples, use: az find "az functionapp config ssl upload"')
