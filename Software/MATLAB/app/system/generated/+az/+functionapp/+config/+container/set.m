classdef set < azure.AzureBase
    ...
    methods
        function this = set()
            ...
            this.BaseCmd = 'az functionapp config container set ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az functionapp config container set --docker-custom-image-name MyDockerCustomImage --docker-')
            ...
            fprintf('%s\n', '        MyFunctionApp --resource-group MyResourceGroup')
            fprintf('%s\n', 'For more specific examples, use: az find "az functionapp config container set"')
