classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az functionapp config access-restriction show : Show Access Restriction settings for
            % functionapp.
            % Command group 'functionapp config access-restriction' is in preview. It may be
            % changed/removed in a future release.
            this.BaseCmd = 'az functionapp config access-restriction show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az functionapp config access-restriction show"')
