classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            ...
            this.BaseCmd = 'az functionapp config hostname list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --webapp-name       [Required] : Name of the web app. You can configure the default using `az')
            ...
            fprintf('%s\n', 'Examples')
            fprintf('%s\n', '    List all hostname bindings for a function app. (autogenerated)')
            fprintf('%s\n', '        az functionapp config hostname list --resource-group MyResourceGroup --webapp-name MyWebapp')
            fprintf('%s\n', 'For more specific examples, use: az find "az functionapp config hostname list"')
