classdef add < azure.AzureBase
    ...
    methods
        function this = add()
            ...
            this.BaseCmd = 'az functionapp config hostname add ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'Examples')
            fprintf('%s\n', '    Bind a hostname to a function app. (autogenerated)')
            fprintf('%s\n', '        az functionapp config hostname add --hostname www.yourdomain.com --name MyFunctionApp')
            fprintf('%s\n', '        --resource-group MyResourceGroup')
            fprintf('%s\n', 'For more specific examples, use: az find "az functionapp config hostname add"')
