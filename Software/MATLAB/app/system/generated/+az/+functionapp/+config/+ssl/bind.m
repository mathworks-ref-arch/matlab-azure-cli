classdef bind < azure.AzureBase
    ...
    methods
        function this = bind()
            ...
            this.BaseCmd = 'az functionapp config ssl bind ';
        end
        ...
        function this = ssl_type(this, varargin)
            % The ssl cert type.  Allowed values: IP, SNI.
            this.Options = [this.Options, '--ssl-type', varargin{:}];
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --ssl-type               [Required] : The ssl cert type.  Allowed values: IP, SNI.')
            ...
            fprintf('%s\n', '        az functionapp config ssl bind --certificate-thumbprint {certificate-thumbprint} --name')
            fprintf('%s\n', '        MyFunctionApp --resource-group MyResourceGroup --ssl-type SNI')
            fprintf('%s\n', 'For more specific examples, use: az find "az functionapp config ssl bind"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class bind 
