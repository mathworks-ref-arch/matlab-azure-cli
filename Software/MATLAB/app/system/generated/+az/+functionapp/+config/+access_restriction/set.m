classdef set < azure.AzureBase
    ...
    methods
        function this = set()
            % az functionapp config access-restriction set : Sets if SCM site is using the same restrictions
            % as the main site.
            % Command group 'functionapp config access-restriction' is in preview. It may be
            % changed/removed in a future release.
            this.BaseCmd = 'az functionapp config access-restriction set ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az functionapp config access-restriction set -g ResourceGroup -n AppName --use-same-')
            fprintf('%s\n', '        restrictions-for-scm-site true')
            fprintf('%s\n', 'For more specific examples, use: az find "az functionapp config access-restriction set"')
