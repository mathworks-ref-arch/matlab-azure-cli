classdef set < azure.AzureBase
    ...
    methods
        function this = set()
            ...
            this.BaseCmd = 'az functionapp config appsettings set ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --slot-settings     : Space-separated slot app settings in a format of `<name>=<value>`.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az functionapp config appsettings set"')
