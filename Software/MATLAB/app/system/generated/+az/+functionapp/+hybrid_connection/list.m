classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az functionapp hybrid-connection list : List the hybrid-connections on a functionapp.
            % Command group 'functionapp hybrid-connection' is in preview. It may be changed/removed
            % in a future release.
            this.BaseCmd = 'az functionapp hybrid-connection list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az functionapp hybrid-connection list"')
