classdef remove < azure.AzureBase
    ...
    methods
        function this = remove()
            % az functionapp hybrid-connection remove : Remove a hybrid-connection from a functionapp.
            % Command group 'functionapp hybrid-connection' is in preview. It may be changed/removed
            % in a future release.
            this.BaseCmd = 'az functionapp hybrid-connection remove ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az functionapp hybrid-connection remove -g MyResourceGroup -n MyWebapp --namespace')
            fprintf('%s\n', '        [HybridConnectionNamespace] --hybrid-connection [HybridConnectionName] -s [slot]')
            fprintf('%s\n', 'For more specific examples, use: az find "az functionapp hybrid-connection remove"')
