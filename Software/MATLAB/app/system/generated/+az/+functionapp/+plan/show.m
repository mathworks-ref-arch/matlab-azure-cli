classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az functionapp plan show : Get the App Service Plans for a resource group or a set of resource
            % groups.
            this.BaseCmd = 'az functionapp plan show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az functionapp plan show"')
