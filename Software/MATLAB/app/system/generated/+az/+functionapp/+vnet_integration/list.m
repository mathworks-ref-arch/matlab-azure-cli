classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az functionapp vnet-integration list : List the virtual network integrations on a functionapp.
            % Command group 'functionapp vnet-integration' is in preview. It may be changed/removed
            % in a future release.
            this.BaseCmd = 'az functionapp vnet-integration list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az functionapp vnet-integration list"')
