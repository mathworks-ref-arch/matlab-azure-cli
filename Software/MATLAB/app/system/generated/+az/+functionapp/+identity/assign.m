classdef assign < azure.AzureBase
    ...
    methods
        function this = assign()
            % az functionapp identity assign : Assign managed service identity to the web app.
            this.BaseCmd = 'az functionapp identity assign ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az functionapp identity assign -g MyResourceGroup -n MyUniqueApp --role reader --scope')
            fprintf('%s\n', '        /subscriptions/xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx/MyResourceGroup')
            ...
            fprintf('%s\n', '        az functionapp identity assign -g MyResourceGroup -n MyUniqueApp --identities [system]')
            fprintf('%s\n', '        myAssignedId')
            fprintf('%s\n', 'For more specific examples, use: az find "az functionapp identity assign"')
