classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            ...
            this.BaseCmd = 'az functionapp identity show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'Examples')
            fprintf('%s\n', '    display functionapp''s managed service identity (autogenerated)')
            fprintf('%s\n', '        az functionapp identity show --name MyFunctionApp --resource-group MyResourceGroup')
            fprintf('%s\n', 'For more specific examples, use: az find "az functionapp identity show"')
