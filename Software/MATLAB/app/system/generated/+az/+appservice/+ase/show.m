classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az appservice ase show : Show details of an app service environment.
            % Command group 'appservice ase' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az appservice ase show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az appservice ase show"')
