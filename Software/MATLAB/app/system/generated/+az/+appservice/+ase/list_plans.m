classdef list_plans < azure.AzureBase

    % Copyright 2020, The MathWorks Inc.

    methods
        function this = list_plans()
            ...
            % release.
            this.BaseCmd = 'az appservice ase list-plans ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az appservice ase list-plans"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class list_plans 
