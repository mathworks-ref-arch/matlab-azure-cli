classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az appservice plan show : Get the app service plans for a resource group or a set of resource
            % groups.
            this.BaseCmd = 'az appservice plan show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az appservice plan show"')
