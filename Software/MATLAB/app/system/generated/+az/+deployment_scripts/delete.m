classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            ...
            % Command group 'deployment-scripts' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az deployment-scripts delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        release.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --name              [Required] : Deployment script resource name.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az deployment-scripts delete"')
