classdef cancel < azure.AzureBase
    ...
    methods
        function this = cancel()
            % az ams job cancel : Cancel a job.
            this.BaseCmd = 'az ams job cancel ';
        end
        function this = delete(this, varargin)
            % Delete the job being cancelled.
            this.Options = [this.Options, '--delete', varargin{:}];
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az ams job cancel"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az ams job cancel"')
