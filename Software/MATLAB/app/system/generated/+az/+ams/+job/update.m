classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az ams job update : Update an existing job.
            this.BaseCmd = 'az ams job update ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az ams job update"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --priority          : The priority with which the job should be processed.  Allowed values:')
            fprintf('%s\n', '                          High, Low, Normal.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az ams job update"')
