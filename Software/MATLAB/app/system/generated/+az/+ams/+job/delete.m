classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az ams job delete : Delete a job.
            this.BaseCmd = 'az ams job delete ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az ams job delete"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az ams job delete"')
