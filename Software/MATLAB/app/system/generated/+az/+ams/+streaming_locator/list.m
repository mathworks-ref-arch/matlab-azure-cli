classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az ams streaming-locator list : List all the streaming locators within an Azure Media Services
            % account.
            this.BaseCmd = 'az ams streaming-locator list ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az ams streaming-locator list"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az ams streaming-locator list"')
