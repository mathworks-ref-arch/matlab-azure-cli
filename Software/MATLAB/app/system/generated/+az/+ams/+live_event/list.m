classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            ...
            this.BaseCmd = 'az ams live-event list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az ams live-event list -a amsAccount -g resourceGroup --query')
            fprintf('%s\n', '        [].{liveEventName:name,state:resourceState}')
            fprintf('%s\n', 'For more specific examples, use: az find "az ams live-event list"')
