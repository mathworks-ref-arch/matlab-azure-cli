classdef wait < azure.AzureBase
    ...
    methods
        function this = wait()
            % az ams live-event wait : Place the CLI in a waiting state until a condition of the live event is
            % met.
            this.BaseCmd = 'az ams live-event wait ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az ams live-event wait"')
