classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az ams asset update : Update the details of an asset.
            this.BaseCmd = 'az ams asset update ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az ams asset update"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az ams asset update"')
