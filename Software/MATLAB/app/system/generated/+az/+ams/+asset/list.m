classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az ams asset list : List all the assets of an Azure Media Services account.
            this.BaseCmd = 'az ams asset list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az ams asset list"')
