classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az ams account update : Update the details of an Azure Media Services account.
            this.BaseCmd = 'az ams account update ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az ams account update"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az ams account update"')
