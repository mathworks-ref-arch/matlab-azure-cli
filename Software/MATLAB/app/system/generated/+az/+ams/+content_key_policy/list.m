classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az ams content-key-policy list : List all the content key policies within an Azure Media
            % Services account.
            this.BaseCmd = 'az ams content-key-policy list ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az ams content-key-policy list"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az ams content-key-policy list"')
