classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az ams transform update : Update the details of a transform.
            this.BaseCmd = 'az ams transform update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az ams transform update -a myAmsAccount -n transformName -g myResourceGroup --set')
            fprintf('%s\n', '        outputs[0].relativePriority=High')
            fprintf('%s\n', 'For more specific examples, use: az find "az ams transform update"')
