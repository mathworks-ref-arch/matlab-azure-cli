classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az ams transform list : List all the transforms of an Azure Media Services account.
            this.BaseCmd = 'az ams transform list ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az ams transform list"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az ams transform list"')
