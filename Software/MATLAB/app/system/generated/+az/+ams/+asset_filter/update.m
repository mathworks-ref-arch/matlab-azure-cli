classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az ams asset-filter update : Update the details of an asset filter.
            this.BaseCmd = 'az ams asset-filter update ';
        end
        ...
        function this = tracks(this, varargin)
            % The JSON representing the track selections. Use @{file} to load from a file. For further information about the JSON structure please refer to swagger documentation on https://docs.microsoft .com/rest/api/media/assetfilters/createorupdate#filtertracksele ction.
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az ams asset-filter update"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '                                     ''Resource Id'' arguments.')
            fprintf('%s\n', '    --name -n                      : The name of the asset filter.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az ams asset-filter update"')
