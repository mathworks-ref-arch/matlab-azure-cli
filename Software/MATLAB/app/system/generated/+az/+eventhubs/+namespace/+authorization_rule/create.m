classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            % az eventhubs namespace authorization-rule create : Creates Authorizationrule for the given
            % Namespace.
            this.BaseCmd = 'az eventhubs namespace authorization-rule create ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az eventhubs namespace authorization-rule create --resource-group myresourcegroup')
            fprintf('%s\n', '        --namespace-name mynamespace --name myauthorule --rights Send Listen')
            fprintf('%s\n', 'For more specific examples, use: az find "az eventhubs namespace authorization-rule create"')
