classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az eventhubs namespace list : Lists the EventHubs Namespaces.
            this.BaseCmd = 'az eventhubs namespace list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az eventhubs namespace list"')
