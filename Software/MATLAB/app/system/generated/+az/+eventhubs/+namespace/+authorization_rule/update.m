classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az eventhubs namespace authorization-rule update : Updates Authorizationrule for the given
            % Namespace.
            this.BaseCmd = 'az eventhubs namespace authorization-rule update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az eventhubs namespace authorization-rule update --resource-group myresourcegroup')
            fprintf('%s\n', '        --namespace-name mynamespace --name myauthorule --rights Send')
            fprintf('%s\n', 'For more specific examples, use: az find "az eventhubs namespace authorization-rule update"')
