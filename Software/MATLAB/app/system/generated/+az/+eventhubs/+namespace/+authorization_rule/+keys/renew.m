classdef renew < azure.AzureBase
    ...
    methods
        function this = renew()
            % az eventhubs namespace authorization-rule keys renew : Regenerate the connection strings of
            % Authorizationrule for the namespace.
            this.BaseCmd = 'az eventhubs namespace authorization-rule keys renew ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az eventhubs namespace authorization-rule keys renew --resource-group myresourcegroup')
