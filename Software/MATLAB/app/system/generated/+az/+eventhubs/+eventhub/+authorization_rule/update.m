classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az eventhubs eventhub authorization-rule update : Updates Authorizationrule for the given
            % Eventhub.
            this.BaseCmd = 'az eventhubs eventhub authorization-rule update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --name -n           : Name of EventHub AuthorizationRule.')
            ...
            fprintf('%s\n', '        az eventhubs eventhub authorization-rule update --resource-group myresourcegroup')
            fprintf('%s\n', '        --namespace-name mynamespace --eventhub-name myeventhub --name myauthorule --rights Send')
            fprintf('%s\n', 'For more specific examples, use: az find "az eventhubs eventhub authorization-rule update"')
