classdef renew < azure.AzureBase
    ...
    methods
        function this = renew()
            % az eventhubs eventhub authorization-rule keys renew : Regenerate the connection strings of
            % Authorizationrule for the namespace.
            this.BaseCmd = 'az eventhubs eventhub authorization-rule keys renew ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az eventhubs eventhub authorization-rule keys renew --resource-group myresourcegroup')
            fprintf('%s\n', '        --namespace-name mynamespace --eventhub-name myeventhub --name myauthorule --key PrimaryKey')
