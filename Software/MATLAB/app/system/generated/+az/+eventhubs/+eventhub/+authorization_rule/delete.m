classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az eventhubs eventhub authorization-rule delete : Deletes the Authorizationrule of Eventhub.
            this.BaseCmd = 'az eventhubs eventhub authorization-rule delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az eventhubs eventhub authorization-rule delete --resource-group myresourcegroup')
            fprintf('%s\n', '        --namespace-name mynamespace --eventhub-name myeventhub --name myauthorule')
            fprintf('%s\n', 'For more specific examples, use: az find "az eventhubs eventhub authorization-rule delete"')
