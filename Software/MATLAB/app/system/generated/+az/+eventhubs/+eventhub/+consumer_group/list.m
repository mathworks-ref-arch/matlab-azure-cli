classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az eventhubs eventhub consumer-group list : List the ConsumerGroup by Eventhub.
            this.BaseCmd = 'az eventhubs eventhub consumer-group list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az eventhubs eventhub consumer-group list --resource-group myresourcegroup --namespace-name')
            fprintf('%s\n', '        mynamespace --eventhub-name myeventhub')
            fprintf('%s\n', 'For more specific examples, use: az find "az eventhubs eventhub consumer-group list"')
