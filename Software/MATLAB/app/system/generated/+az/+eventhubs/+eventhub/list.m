classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az eventhubs eventhub list : List the EventHub by Namepsace.
            this.BaseCmd = 'az eventhubs eventhub list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az eventhubs eventhub list"')
