classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az eventhubs eventhub consumer-group delete : Deletes the ConsumerGroup.
            this.BaseCmd = 'az eventhubs eventhub consumer-group delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az eventhubs eventhub consumer-group delete --resource-group myresourcegroup --namespace-')
            fprintf('%s\n', '        name mynamespace --eventhub-name myeventhub --name myconsumergroup')
            fprintf('%s\n', 'For more specific examples, use: az find "az eventhubs eventhub consumer-group delete"')
