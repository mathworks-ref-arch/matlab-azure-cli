classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az eventhubs georecovery-alias authorization-rule list : List of Authorizationrule by EventHubs
            % Namespace.
            this.BaseCmd = 'az eventhubs georecovery-alias authorization-rule list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az eventhubs georecovery-alias authorization-rule list --resource-group myresourcegroup')
