classdef exists < azure.AzureBase
    ...
    methods
        function this = exists()
            % az eventhubs georecovery-alias exists : Check the availability of Geo-Disaster Recovery
            % Configuration Alias Name.
            this.BaseCmd = 'az eventhubs georecovery-alias exists ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    Configuration Alias Name.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --alias -a          [Required] : Name of Geo Recovery Configs - Alias to check availability.')
            ...
            fprintf('%s\n', '        az eventhubs georecovery-alias exists --resource-group myresourcegroup --namespace-name')
            fprintf('%s\n', '        primarynamespace --alias myaliasname')
            fprintf('%s\n', 'For more specific examples, use: az find "az eventhubs georecovery-alias exists"')
