classdef list_ip_addresses < azure.AzureBase

    % Copyright 2020, The MathWorks Inc.

    methods
        function this = list_ip_addresses()
            % az vm list-ip-addresses : List IP addresses associated with a VM.
            this.BaseCmd = 'az vm list-ip-addresses ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az vm list-ip-addresses"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class list_ip_addresses 
