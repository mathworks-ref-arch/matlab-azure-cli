classdef get_instance_view < azure.AzureBase
    ...
    methods
        function this = get_instance_view()
            ...
            this.BaseCmd = 'az vm host get-instance-view ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --host-group        : Name of the Dedicated Host Group.')
            fprintf('%s\n', '    --ids               : One or more resource IDs (space-delimited). It should be a complete')
            fprintf('%s\n', '                          resource ID containing all information of ''Resource Id'' arguments. You')
            fprintf('%s\n', '                          should provide either --ids or other ''Resource Id'' arguments.')
            fprintf('%s\n', '    --name -n           : Name of the Dedicated Host.')
            ...
            fprintf('%s\n', '        az vm host get-instance-view --ids $(az vm host list -g my-rg --host-group my-host-group')
            fprintf('%s\n', '        --query "[].id" -o tsv)')
            fprintf('%s\n', 'For more specific examples, use: az find "az vm host get-instance-view"')
