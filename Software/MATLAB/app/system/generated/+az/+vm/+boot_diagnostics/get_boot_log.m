classdef get_boot_log < azure.AzureBase

    % Copyright 2020, The MathWorks Inc.

    methods
        function this = get_boot_log()
            % az vm boot-diagnostics get-boot-log : Get the boot diagnostics log from a VM.
            this.BaseCmd = 'az vm boot-diagnostics get-boot-log ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az vm boot-diagnostics get-boot-log --ids $(az vm list -g MyResourceGroup --query "[].id" -o')
            fprintf('%s\n', '        tsv)')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az vm boot-diagnostics get-boot-log"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class get_boot_log 
