classdef disable < azure.AzureBase
    ...
    methods
        function this = disable()
            ...
            this.BaseCmd = 'az vm boot-diagnostics disable ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az vm boot-diagnostics disable --ids $(az vm list --resource-group MyResourceGroup --query')
            fprintf('%s\n', '        "[].id" -o tsv) --name MyVirtualMachine --resource-group MyResourceGroup')
            fprintf('%s\n', 'For more specific examples, use: az find "az vm boot-diagnostics disable"')
