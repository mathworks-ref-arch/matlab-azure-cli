classdef generalize < azure.AzureBase

    % Copyright 2020, The MathWorks Inc.

    methods
        function this = generalize()
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az vm generalize"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class generalize 
