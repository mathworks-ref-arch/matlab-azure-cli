classdef reapply < azure.AzureBase

    % Copyright 2020, The MathWorks Inc.

    methods
        function this = reapply()
            % az vm reapply : Reapply VMs.
            this.BaseCmd = 'az vm reapply ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az vm reapply"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class reapply 
