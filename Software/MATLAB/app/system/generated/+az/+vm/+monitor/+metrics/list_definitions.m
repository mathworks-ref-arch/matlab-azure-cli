classdef list_definitions < azure.AzureBase
    ...
    methods
        function this = list_definitions()
            % az vm monitor metrics list-definitions : List the metric definitions for a VM.
            % Command group 'vm monitor metrics' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az vm monitor metrics list-definitions ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az vm monitor metrics list-definitions --name MyIDVirtualMachine --resource-group')
            fprintf('%s\n', '        MyResourceGroup --subscription MySubscription')
            fprintf('%s\n', 'For more specific examples, use: az find "az vm monitor metrics list-definitions"')
