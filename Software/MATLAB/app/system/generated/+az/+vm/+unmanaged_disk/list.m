classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            ...
            this.BaseCmd = 'az vm unmanaged-disk list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    az vm unmanaged-disk list : List unmanaged disks of a VM.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --name --vm-name -n [Required] : The name of the Virtual Machine. You can configure the default')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az vm unmanaged-disk list"')
