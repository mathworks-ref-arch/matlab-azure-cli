classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            ...
            this.BaseCmd = 'az vm availability-set update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    az vm availability-set update : Update an Azure Availability Set.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --ppg               : The name or ID of the proximity placement group the availability set')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az vm availability-set update"')
