classdef stop < azure.AzureBase
    ...
    methods
        function this = stop()
            ...
            % The VM will continue to be billed. To avoid this, you can deallocate the VM through "az vm
            % deallocate".
            this.BaseCmd = 'az vm stop ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az vm stop"')
