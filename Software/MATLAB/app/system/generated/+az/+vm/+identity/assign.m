classdef assign < azure.AzureBase
    ...
    methods
        function this = assign()
            ...
            this.BaseCmd = 'az vm identity assign ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az vm identity assign -g MyResourceGroup -n MyVm --role Reader --scope')
            ...
            fprintf('%s\n', '        az vm identity assign -g MyResourceGroup -n MyVm --role Reader --identities [system]')
            fprintf('%s\n', '        myAssignedId')
            fprintf('%s\n', 'For more specific examples, use: az find "az vm identity assign"')
