classdef accept < azure.AzureBase

    % Copyright 2020, The MathWorks Inc.

    methods
        function this = accept()
            % az vm image terms accept : Accept Azure Marketplace image terms so that the image can be used to
            % create VMs.
            this.BaseCmd = 'az vm image terms accept ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az vm image terms accept"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class accept 
