classdef list_publishers < azure.AzureBase

    % Copyright 2020, The MathWorks Inc.

    methods
        function this = list_publishers()
            % az vm image list-publishers : List the VM image publishers available in the Azure Marketplace.
            this.BaseCmd = 'az vm image list-publishers ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az vm image list-publishers"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class list_publishers 
