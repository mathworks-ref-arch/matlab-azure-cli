classdef list_vm_resize_options < azure.AzureBase

    % Copyright 2020, The MathWorks Inc.

    methods
        function this = list_vm_resize_options()
            % az vm list-vm-resize-options : List available resizing options for VMs.
            this.BaseCmd = 'az vm list-vm-resize-options ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az vm list-vm-resize-options"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class list_vm_resize_options 
