classdef wait < azure.AzureBase
    ...
    methods
        function this = wait()
            % az postgres server wait : Wait for server to satisfy certain conditions.
            this.BaseCmd = 'az postgres server wait ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az postgres server wait"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --name -n           : Name of the server. The name can contain only lowercase letters, numbers,')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az postgres server wait"')
