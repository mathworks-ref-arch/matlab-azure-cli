classdef restore < azure.AzureBase
    ...
    methods
        function this = restore()
            ...
            this.BaseCmd = 'az postgres server restore ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az postgres server restore -g testgroup -n testsvrnew --source-server testsvr --restore-')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az postgres server restore"')
