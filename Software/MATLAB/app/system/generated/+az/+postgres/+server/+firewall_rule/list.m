classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            ...
            this.BaseCmd = 'az postgres server firewall-rule list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az postgres server firewall-rule list --resource-group MyResourceGroup --server-name')
            fprintf('%s\n', '        MyServer')
            fprintf('%s\n', 'For more specific examples, use: az find "az postgres server firewall-rule list"')
