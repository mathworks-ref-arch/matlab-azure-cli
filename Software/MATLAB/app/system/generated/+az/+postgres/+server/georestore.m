classdef georestore < azure.AzureBase
    ...
    methods
        function this = georestore()
            % az postgres server georestore : Geo-restore a server from backup.
            this.BaseCmd = 'az postgres server georestore ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '            -l westus2')
            fprintf('%s\n', 'For more specific examples, use: az find "az postgres server georestore"')
