classdef stop < azure.AzureBase
    ...
    methods
        function this = stop()
            % az postgres server replica stop : Stop replication to a read replica and make it a read/write
            % server.
            this.BaseCmd = 'az postgres server replica stop ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az postgres server replica stop"')
