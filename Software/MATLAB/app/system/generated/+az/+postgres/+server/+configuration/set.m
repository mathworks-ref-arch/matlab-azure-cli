classdef set < azure.AzureBase
    ...
    methods
        function this = set()
            ...
            this.BaseCmd = 'az postgres server configuration set ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    az postgres server configuration set : Update the configuration of a server.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --value             : Value of the configuration. If not provided, configuration value will be')
            fprintf('%s\n', '                          set to default.')
            ...
            fprintf('%s\n', '        az postgres server configuration set -g testgroup -s testsvr -n {config_name} --value')
            fprintf('%s\n', '        {config_value}')
            fprintf('%s\n', '    Set a configuration value to its default.')
            fprintf('%s\n', '        az postgres server configuration set -g testgroup -s testsvr -n {config_name}')
            fprintf('%s\n', 'For more specific examples, use: az find "az postgres server configuration set"')
