classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            ...
            this.BaseCmd = 'az postgres server configuration show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az postgres server configuration show --name MyServerConfiguration --resource-group')
            fprintf('%s\n', '        MyResourceGroup --server-name MyServer')
            fprintf('%s\n', 'For more specific examples, use: az find "az postgres server configuration show"')
