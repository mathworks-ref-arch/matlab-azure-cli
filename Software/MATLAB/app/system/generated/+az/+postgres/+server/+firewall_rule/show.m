classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            ...
            this.BaseCmd = 'az postgres server firewall-rule show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az postgres server firewall-rule show --name MyFirewallRule --resource-group MyResourceGroup')
            fprintf('%s\n', '        --server-name MyServer')
            fprintf('%s\n', 'For more specific examples, use: az find "az postgres server firewall-rule show"')
