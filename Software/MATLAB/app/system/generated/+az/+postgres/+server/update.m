classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            ...
            this.BaseCmd = 'az postgres server update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az postgres server update --name testsvrnew --resource-group testgroup --ssl-enforcement')
            fprintf('%s\n', '        Enabled --minimal-tls-version TLS1_0')
            fprintf('%s\n', 'For more specific examples, use: az find "az postgres server update"')
