classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az postgres server private-endpoint-connection delete : Delete the specified private endpoint
            % connection associated with a PostgreSQL server.
            this.BaseCmd = 'az postgres server private-endpoint-connection delete ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az postgres server private-endpoint-connection delete"
