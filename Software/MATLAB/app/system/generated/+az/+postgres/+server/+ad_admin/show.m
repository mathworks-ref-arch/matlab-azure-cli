classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az postgres server ad-admin show : Get Active Directory Administrator information for a
            % PostgreSQL server.
            % Command group 'postgres server ad-admin' is in preview. It may be changed/removed in a
            % future release.
            this.BaseCmd = 'az postgres server ad-admin show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az postgres server ad-admin show"')
