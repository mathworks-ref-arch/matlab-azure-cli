classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az postgres server private-endpoint-connection show : Show details of a private endpoint
            % connection associated with a PostgreSQL server.
            this.BaseCmd = 'az postgres server private-endpoint-connection show ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az postgres server private-endpoint-connection show"
