classdef reject < azure.AzureBase
    ...
    methods
        function this = reject()
            % az postgres server private-endpoint-connection reject : Reject the specified private endpoint
            % connection associated with a PostgreSQL server.
            this.BaseCmd = 'az postgres server private-endpoint-connection reject ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az postgres server private-endpoint-connection reject"
