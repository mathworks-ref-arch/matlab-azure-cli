classdef approve < azure.AzureBase
    ...
    methods
        function this = approve()
            % az postgres server private-endpoint-connection approve : Approve the specified private endpoint
            % connection associated with a PostgreSQL server.
            this.BaseCmd = 'az postgres server private-endpoint-connection approve ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az postgres server private-endpoint-connection approve"
