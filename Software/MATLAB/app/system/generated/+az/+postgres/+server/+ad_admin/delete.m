classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az postgres server ad-admin delete : Delete an Active Directory Administrator for PostgreSQL
            % server.
            % Command group 'postgres server ad-admin' is in preview. It may be changed/removed in a
            % future release.
            this.BaseCmd = 'az postgres server ad-admin delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az postgres server ad-admin delete"')
