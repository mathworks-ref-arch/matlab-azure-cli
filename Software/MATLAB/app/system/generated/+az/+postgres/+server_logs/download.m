classdef download < azure.AzureBase
    ...
    methods
        function this = download()
            ...
            this.BaseCmd = 'az postgres server-logs download ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    az postgres server-logs download : Download log files.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --name -n           [Required] : Space-separated list of log filenames on the server to')
            fprintf('%s\n', '                                     download.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az postgres server-logs download"')
