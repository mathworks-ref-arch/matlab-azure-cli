classdef resize < azure.AzureBase
    ...
    methods
        function this = resize()
            ...
            this.BaseCmd = 'az hdinsight resize ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az hdinsight resize"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --workernode-count -c [Required] : The target worker node instance count for the operation.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az hdinsight resize"')
