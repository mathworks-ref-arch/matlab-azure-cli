classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az hdinsight host list : List the hosts of the specified HDInsight cluster.
            this.BaseCmd = 'az hdinsight host list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az hdinsight host list"')
