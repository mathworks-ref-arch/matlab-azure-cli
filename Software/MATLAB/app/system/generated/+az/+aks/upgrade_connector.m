classdef upgrade_connector < azure.AzureBase

    % Copyright 2020, The MathWorks Inc.

    methods
        function this = upgrade_connector()
            % az aks upgrade-connector : Upgrade the ACI Connector on a managed Kubernetes cluster.
            % This command is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az aks upgrade-connector ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az aks upgrade-connector"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class upgrade_connector 
