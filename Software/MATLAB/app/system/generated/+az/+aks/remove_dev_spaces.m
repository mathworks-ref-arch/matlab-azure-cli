classdef remove_dev_spaces < azure.AzureBase

    % Copyright 2020, The MathWorks Inc.

    methods
        function this = remove_dev_spaces()
            % az aks remove-dev-spaces : Remove Azure Dev Spaces from a managed Kubernetes cluster.
            this.BaseCmd = 'az aks remove-dev-spaces ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az aks remove-dev-spaces"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class remove_dev_spaces 
