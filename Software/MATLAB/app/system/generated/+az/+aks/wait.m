classdef wait < azure.AzureBase
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az aks wait --created --interval 60 --name MyManagedCluster --resource-group MyResourceGroup')
            fprintf('%s\n', '        --timeout 1800')
            fprintf('%s\n', 'For more specific examples, use: az find "az aks wait"')
