classdef upgrade < azure.AzureBase
    ...
    methods
        function this = upgrade()
            ...
            this.BaseCmd = 'az aks nodepool upgrade ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az aks nodepool upgrade"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --kubernetes-version -k [Required] : Version of Kubernetes to upgrade the node pool to, such as')
            fprintf('%s\n', '                                         "1.16.9".')
            ...
            fprintf('%s\n', '                                         logs.')
            fprintf('%s\n', 'For more specific examples, use: az find "az aks nodepool upgrade"')
