classdef scale < azure.AzureBase
    ...
    methods
        function this = scale()
            ...
            this.BaseCmd = 'az aks nodepool scale ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az aks nodepool scale"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --node-count -c                : Number of nodes in the Kubernetes node pool.  Default: 3.')
            fprintf('%s\n', 'Global Arguments')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az aks nodepool scale"')
