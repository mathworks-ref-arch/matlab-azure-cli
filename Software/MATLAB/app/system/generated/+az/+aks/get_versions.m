classdef get_versions < azure.AzureBase

    % Copyright 2020, The MathWorks Inc.

    methods
        function this = get_versions()
            % az aks get-versions : Get the versions available for creating a managed Kubernetes cluster.
            this.BaseCmd = 'az aks get-versions ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az aks get-versions"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class get_versions 
