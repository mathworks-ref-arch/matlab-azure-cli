classdef remove < azure.AzureBase
    ...
    methods
        function this = remove()
            % az acr identity remove : Remove a managed identity from a container registry.
            this.BaseCmd = 'az acr identity remove ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az acr identity remove"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    az acr identity remove : Remove a managed identity from a container registry.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --identities [Required] : Space-separated identities. Use ''[system]'' to refer to the system')
            fprintf('%s\n', '                              assigned identity.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az acr identity remove"')
