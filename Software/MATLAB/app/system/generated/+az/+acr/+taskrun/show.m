classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az acr taskrun show : Get the properties of a named taskrun for an Azure Container Registry.
            % Command group 'acr taskrun' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az acr taskrun show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        release.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --name -n     [Required] : The name of the taskrun.')
            ...
            fprintf('%s\n', 'Examples')
            fprintf('%s\n', '    Get the properties of a taskrun, displaying the results in a table.')
            fprintf('%s\n', '        az acr taskrun show -r MyRegistry -n MyTaskRun -o table')
            fprintf('%s\n', 'For more specific examples, use: az find "az acr taskrun show"')
