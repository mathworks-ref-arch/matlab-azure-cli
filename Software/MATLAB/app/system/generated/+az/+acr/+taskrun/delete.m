classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az acr taskrun delete : Delete a taskrun from an Azure Container Registry.
            % Command group 'acr taskrun' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az acr taskrun delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az acr taskrun delete"')
