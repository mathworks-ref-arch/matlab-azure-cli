classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az acr encryption show : Show the container registry's encryption details.
            % For more information, see http://aka.ms/acr/cmk.
            this.BaseCmd = 'az acr encryption show ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az acr encryption show"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az acr encryption show"')
