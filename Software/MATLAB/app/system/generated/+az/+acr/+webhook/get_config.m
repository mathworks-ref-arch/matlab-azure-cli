classdef get_config < azure.AzureBase
    ...
    methods
        function this = get_config()
            ...
            this.BaseCmd = 'az acr webhook get-config ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az acr webhook get-config"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class get_config 
