classdef list_events < azure.AzureBase

    % Copyright 2020, The MathWorks Inc.

    methods
        function this = list_events()
            % az acr webhook list-events : List recent events for a webhook.
            this.BaseCmd = 'az acr webhook list-events ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az acr webhook list-events"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class list_events 
