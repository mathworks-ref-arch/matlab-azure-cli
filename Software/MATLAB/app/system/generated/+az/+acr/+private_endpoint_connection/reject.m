classdef reject < azure.AzureBase
    ...
    methods
        function this = reject()
            % az acr private-endpoint-connection reject : Reject a private endpoint connection request for a
            % container registry.
            ...
            this.BaseCmd = 'az acr private-endpoint-connection reject ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az acr private-endpoint-connection reject"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az acr private-endpoint-connection reject"')
