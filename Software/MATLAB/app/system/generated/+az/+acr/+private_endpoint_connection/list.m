classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az acr private-endpoint-connection list : List all private endpoint connections to a container
            % registry.
            ...
            this.BaseCmd = 'az acr private-endpoint-connection list ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az acr private-endpoint-connection list"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az acr private-endpoint-connection list"')
