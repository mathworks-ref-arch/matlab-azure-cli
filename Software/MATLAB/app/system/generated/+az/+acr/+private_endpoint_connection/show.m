classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az acr private-endpoint-connection show : Show details of a container registry's private
            % endpoint connection.
            ...
            this.BaseCmd = 'az acr private-endpoint-connection show ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az acr private-endpoint-connection show"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az acr private-endpoint-connection show"')
