classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az acr private-endpoint-connection delete : Delete a private endpoint connection request for a
            % container registry.
            ...
            this.BaseCmd = 'az acr private-endpoint-connection delete ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az acr private-endpoint-connection delete"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az acr private-endpoint-connection delete"')
