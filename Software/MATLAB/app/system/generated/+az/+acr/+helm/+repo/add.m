classdef add < azure.AzureBase
    ...
    methods
        function this = add()
            % az acr helm repo add : Add a helm chart repository from an Azure Container Registry through the
            % Helm CLI.
            ...
            this.BaseCmd = 'az acr helm repo add ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az acr helm repo add"')
