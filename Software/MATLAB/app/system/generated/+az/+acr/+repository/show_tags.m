classdef show_tags < azure.AzureBase

    % Copyright 2020, The MathWorks Inc.

    methods
        function this = show_tags()
            % az acr repository show-tags : Show tags for a repository in an Azure Container Registry.
            this.BaseCmd = 'az acr repository show-tags ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        time_desc --detail')
            fprintf('%s\n', 'For more specific examples, use: az find "az acr repository show-tags"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class show_tags 
