classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az acr token update : Update a token (replace associated scope map) for an Azure Container
            % Registry.
            % Command group 'acr token' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az acr token update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --scope-map              : The name of the scope map associated with the token. If not')
            fprintf('%s\n', '                               specified, running this command will disassociate the current scope')
            fprintf('%s\n', '                               map related to the token.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az acr token update"')
