classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az acr agentpool update : Update an agent pool for an Azure Container Registry.
            % Command group 'acr agentpool' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az acr agentpool update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --count -c               : The count of the agent pool.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az acr agentpool update"')
