classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az acr agentpool list : List the agent pools for an Azure Container Registry.
            % Command group 'acr agentpool' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az acr agentpool list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az acr agentpool list"')
