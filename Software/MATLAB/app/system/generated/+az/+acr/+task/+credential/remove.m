classdef remove < azure.AzureBase
    ...
    methods
        function this = remove()
            ...
            this.BaseCmd = 'az acr task credential remove ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az acr task credential remove -n taskname -r registryname --login-server')
            fprintf('%s\n', '        myregistry.docker.io')
            fprintf('%s\n', 'For more specific examples, use: az find "az acr task credential remove"')
