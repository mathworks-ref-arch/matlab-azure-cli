classdef cancel_run < azure.AzureBase

    % Copyright 2020, The MathWorks Inc.

    methods
        function this = cancel_run()
            % az acr task cancel-run : Cancel a specified run of an Azure Container Registry.
            this.BaseCmd = 'az acr task cancel-run ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az acr task cancel-run"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class cancel_run 
