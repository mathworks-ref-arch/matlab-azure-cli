classdef show < azure.AzureBase
    ...
    methods
        ...
        function this = with_secure_properties(this, varargin)
            % Indicates whether the secure properties of a task should be returned.
            this.Options = [this.Options, '--with-secure-properties', varargin{:}];
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --with-secure-properties : Indicates whether the secure properties of a task should be returned.')
            fprintf('%s\n', 'Global Arguments')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az acr task show"')
