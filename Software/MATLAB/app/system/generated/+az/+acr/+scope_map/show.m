classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az acr scope-map show : Show details and attributes of a scope map for an Azure Container
            % Registry.
            % Command group 'acr scope-map' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az acr scope-map show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az acr scope-map show"')
