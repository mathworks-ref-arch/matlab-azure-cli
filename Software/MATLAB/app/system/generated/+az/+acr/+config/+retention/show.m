classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az acr config retention show : Show the configured retention policy for an Azure Container
            % Registry.
            % Command group 'acr config retention' is in preview. It may be changed/removed in a
            % future release.
            this.BaseCmd = 'az acr config retention show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az acr config retention show"')
