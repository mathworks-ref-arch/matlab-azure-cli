classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az acr config content-trust show : Show the configured content-trust policy for an Azure
            % Container Registry.
            this.BaseCmd = 'az acr config content-trust show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az acr config content-trust show"')
