classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az acr config content-trust update : Update content-trust policy for an Azure Container
            % Registry.
            this.BaseCmd = 'az acr config content-trust update ';
        end
        ...
        function this = status(this, varargin)
            % Indicates whether content-trust is enabled.  Allowed values: disabled, enabled.
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --status                 : Indicates whether content-trust is enabled.  Allowed values:')
            fprintf('%s\n', '                               disabled, enabled.')
            fprintf('%s\n', 'Global Arguments')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az acr config content-trust update"')
