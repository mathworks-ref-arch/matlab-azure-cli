classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az deployment tenant list : List deployments at tenant scope.
            this.BaseCmd = 'az deployment tenant list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    az deployment tenant list : List deployments at tenant scope.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --filter [Preview] : Filter expression using OData notation. You can use --filter')
            fprintf('%s\n', '                         "provisioningState eq ''{state}''" to filter provisioningState. To get more')
            fprintf('%s\n', '                         information, please visit https://docs.microsoft.com/en-')
            fprintf('%s\n', '                         us/rest/api/resources/deployments/listatsubscriptionscope#uri-parameters.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az deployment tenant list"')
