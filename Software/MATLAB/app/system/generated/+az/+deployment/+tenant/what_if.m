classdef what_if < azure.AzureBase
    ...
    methods
        function this = what_if()
            % az deployment tenant what-if : Execute a deployment What-If operation at tenant scope.
            % This command is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az deployment tenant what-if ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        This command is in preview. It may be changed/removed in a future release.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --location -l            [Required] : The location to store the deployment What-If operation')
            fprintf('%s\n', '                                          metadata.')
            ...
            fprintf('%s\n', '        az deployment tenant what-if --location WestUS --template-uri')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az deployment tenant what-if"')
