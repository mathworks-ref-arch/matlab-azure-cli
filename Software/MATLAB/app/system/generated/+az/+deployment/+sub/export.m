classdef export < azure.AzureBase
    ...
    methods
        function this = export()
            % az deployment sub export : Export the template used for a deployment.
            this.BaseCmd = 'az deployment sub export ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az deployment sub export"')
