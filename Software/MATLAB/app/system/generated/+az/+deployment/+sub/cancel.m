classdef cancel < azure.AzureBase
    ...
    methods
        function this = cancel()
            % az deployment sub cancel : Cancel a deployment at subscription scope.
            this.BaseCmd = 'az deployment sub cancel ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az deployment sub cancel"')
