classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az deployment sub delete : Delete a deployment at subscription scope.
            this.BaseCmd = 'az deployment sub delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az deployment sub delete"')
