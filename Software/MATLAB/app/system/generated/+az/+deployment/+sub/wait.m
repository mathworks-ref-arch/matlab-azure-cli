classdef wait < azure.AzureBase
    ...
    methods
        function this = wait()
            % az deployment sub wait : Place the CLI in a waiting state until a deployment condition is met.
            this.BaseCmd = 'az deployment sub wait ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az deployment sub wait"')
