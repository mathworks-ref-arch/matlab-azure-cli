classdef validate < azure.AzureBase
    ...
    methods
        function this = validate()
            % az deployment sub validate : Validate whether a template is valid at subscription scope.
            this.BaseCmd = 'az deployment sub validate ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az deployment sub validate --location westus2 --parameters MyValue=This MyArray=@array.json')
            fprintf('%s\n', '        --template-file azuredeploy.json')
            fprintf('%s\n', 'For more specific examples, use: az find "az deployment sub validate"')
