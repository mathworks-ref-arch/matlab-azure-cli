classdef what_if < azure.AzureBase
    ...
    methods
        function this = what_if()
            % az deployment sub what-if : Execute a deployment What-If operation at subscription scope.
            % This command is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az deployment sub what-if ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az deployment sub what-if --location WestUS --template-uri')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az deployment sub what-if"')
