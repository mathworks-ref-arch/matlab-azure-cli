classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az deployment sub list : List deployments at subscription scope.
            this.BaseCmd = 'az deployment sub list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az deployment sub list"')
