classdef export < azure.AzureBase
    ...
    methods
        function this = export()
            % az deployment group export : Export the template used for a deployment.
            this.BaseCmd = 'az deployment group export ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az deployment group export"')
