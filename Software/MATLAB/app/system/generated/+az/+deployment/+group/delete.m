classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az deployment group delete : Delete a deployment at resource group.
            this.BaseCmd = 'az deployment group delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az deployment group delete"')
