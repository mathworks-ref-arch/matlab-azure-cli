classdef cancel < azure.AzureBase
    ...
    methods
        function this = cancel()
            % az deployment group cancel : Cancel a deployment at resource group.
            this.BaseCmd = 'az deployment group cancel ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az deployment group cancel"')
