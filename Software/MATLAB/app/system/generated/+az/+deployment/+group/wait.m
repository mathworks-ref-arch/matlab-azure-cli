classdef wait < azure.AzureBase
    ...
    methods
        function this = wait()
            % az deployment group wait : Place the CLI in a waiting state until a deployment condition is met.
            this.BaseCmd = 'az deployment group wait ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az deployment group wait"')
