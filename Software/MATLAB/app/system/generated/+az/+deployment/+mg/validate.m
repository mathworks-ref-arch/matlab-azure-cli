classdef validate < azure.AzureBase
    ...
    methods
        function this = validate()
            % az deployment mg validate : Validate whether a template is valid at management group.
            this.BaseCmd = 'az deployment mg validate ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az deployment mg validate --management-group-id testmg --location WestUS --template-file')
            fprintf('%s\n', '        {template-file}')
            fprintf('%s\n', 'For more specific examples, use: az find "az deployment mg validate"')
