classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az deployment mg show : Show a deployment at management group.
            this.BaseCmd = 'az deployment mg show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az deployment mg show"')
