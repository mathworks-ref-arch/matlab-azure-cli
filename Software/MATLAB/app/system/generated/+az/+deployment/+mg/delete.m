classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az deployment mg delete : Delete a deployment at management group.
            this.BaseCmd = 'az deployment mg delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az deployment mg delete"')
