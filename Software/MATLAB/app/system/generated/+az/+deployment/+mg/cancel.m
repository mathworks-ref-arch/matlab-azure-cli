classdef cancel < azure.AzureBase
    ...
    methods
        function this = cancel()
            % az deployment mg cancel : Cancel a deployment at management group.
            this.BaseCmd = 'az deployment mg cancel ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az deployment mg cancel"')
