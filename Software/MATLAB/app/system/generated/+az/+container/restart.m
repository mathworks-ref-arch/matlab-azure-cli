classdef restart < azure.AzureBase
    ...
    methods
        function this = restart()
            ...
            this.BaseCmd = 'az container restart ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az container restart"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az container restart"')
