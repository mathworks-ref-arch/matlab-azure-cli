classdef logs < azure.AzureBase
    ...
    methods
        function this = logs()
            ...
            this.BaseCmd = 'az container logs ';
        end
        ...
        function this = follow(this, varargin)
            % Indicate to stream the tailing logs.
            this.Options = [this.Options, '--follow', varargin{:}];
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    az container logs : Examine the logs for a container in a container group.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --container-name    : The container name to tail the logs. If omitted, the first container in')
            fprintf('%s\n', '                          the container group will be chosen.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az container logs"')
