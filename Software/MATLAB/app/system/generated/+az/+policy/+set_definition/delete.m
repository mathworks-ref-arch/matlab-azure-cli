classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az policy set-definition delete : Delete a policy set definition.
            this.BaseCmd = 'az policy set-definition delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az policy set-definition delete"')
