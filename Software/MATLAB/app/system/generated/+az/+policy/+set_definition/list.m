classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az policy set-definition list : List policy set definitions.
            this.BaseCmd = 'az policy set-definition list ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az policy set-definition list"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az policy set-definition list"')
