classdef trigger_scan < azure.AzureBase

    % Copyright 2020, The MathWorks Inc.

    methods
        function this = trigger_scan()
            % az policy state trigger-scan : Trigger a policy compliance evaluation for a scope.
            this.BaseCmd = 'az policy state trigger-scan ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az policy state trigger-scan"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class trigger_scan 
