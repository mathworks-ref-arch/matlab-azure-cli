classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az policy remediation delete : Delete a resource policy remediation.
            this.BaseCmd = 'az policy remediation delete ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az policy remediation delete"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az policy remediation delete"')
