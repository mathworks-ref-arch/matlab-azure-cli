classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az policy remediation list : List resource policy remediations.
            this.BaseCmd = 'az policy remediation list ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az policy remediation list"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az policy remediation list"')
