classdef cancel < azure.AzureBase
    ...
    methods
        function this = cancel()
            % az policy remediation cancel : Cancel a resource policy remediation.
            this.BaseCmd = 'az policy remediation cancel ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az policy remediation cancel"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az policy remediation cancel"')
