classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az policy remediation deployment list : Lists deployments for a resource policy remediation.
            this.BaseCmd = 'az policy remediation deployment list ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az policy remediation deployment list"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az policy remediation deployment list"')
