classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az policy metadata list : List policy metadata resources.
            this.BaseCmd = 'az policy metadata list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az policy metadata list"')
