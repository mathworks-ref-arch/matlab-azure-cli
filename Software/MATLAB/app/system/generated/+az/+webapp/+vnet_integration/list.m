classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az webapp vnet-integration list : List the virtual network integrations on a webapp.
            % Command group 'webapp vnet-integration' is in preview. It may be changed/removed in a
            % future release.
            this.BaseCmd = 'az webapp vnet-integration list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az webapp vnet-integration list"')
