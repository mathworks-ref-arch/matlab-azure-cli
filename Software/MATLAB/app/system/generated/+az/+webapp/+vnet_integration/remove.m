classdef remove < azure.AzureBase
    ...
    methods
        function this = remove()
            % az webapp vnet-integration remove : Remove a regional virtual network integration from webapp.
            % Command group 'webapp vnet-integration' is in preview. It may be changed/removed in a
            % future release.
            this.BaseCmd = 'az webapp vnet-integration remove ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az webapp vnet-integration remove"')
