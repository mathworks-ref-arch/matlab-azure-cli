classdef start < azure.AzureBase
    ...
    methods
        function this = start()
            ...
            this.BaseCmd = 'az webapp webjob continuous start ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az webapp webjob continuous start --name MyWebApp --resource-group MyResourceGroup --webjob-')
            fprintf('%s\n', '        name MyWebjob')
            fprintf('%s\n', 'For more specific examples, use: az find "az webapp webjob continuous start"')
