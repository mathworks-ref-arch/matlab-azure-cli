classdef stop < azure.AzureBase
    ...
    methods
        function this = stop()
            ...
            this.BaseCmd = 'az webapp webjob continuous stop ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az webapp webjob continuous stop --name MyWebApp --resource-group MyResourceGroup --webjob-')
            fprintf('%s\n', '        name MyWebjob')
            fprintf('%s\n', 'For more specific examples, use: az find "az webapp webjob continuous stop"')
