classdef remove < azure.AzureBase
    ...
    methods
        function this = remove()
            ...
            this.BaseCmd = 'az webapp webjob triggered remove ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az webapp webjob triggered remove --name MyWebApp --resource-group MyResourceGroup --webjob-')
            fprintf('%s\n', '        name MyWebjob')
            fprintf('%s\n', 'For more specific examples, use: az find "az webapp webjob triggered remove"')
