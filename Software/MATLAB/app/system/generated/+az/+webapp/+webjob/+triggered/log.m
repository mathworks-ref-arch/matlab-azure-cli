classdef log < azure.AzureBase
    ...
    methods
        function this = log()
            ...
            this.BaseCmd = 'az webapp webjob triggered log ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az webapp webjob triggered log --name MyWebApp --resource-group MyResourceGroup')
            fprintf('%s\n', '        --subscription MySubscription --webjob-name MyWebjob')
            fprintf('%s\n', 'For more specific examples, use: az find "az webapp webjob triggered log"')
