classdef run < azure.AzureBase
    ...
    methods
        function this = run()
            ...
            this.BaseCmd = 'az webapp webjob triggered run ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az webapp webjob triggered run --name MyWebApp --resource-group MyResourceGroup --webjob-')
            fprintf('%s\n', '        name MyWebjob')
            fprintf('%s\n', 'For more specific examples, use: az find "az webapp webjob triggered run"')
