classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            ...
            this.BaseCmd = 'az webapp config hostname delete ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az webapp config hostname delete"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --webapp-name       : Webapp name. You can configure the default using `az configure --defaults')
            fprintf('%s\n', '                          web=<name>`.')
            fprintf('%s\n', 'Global Arguments')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az webapp config hostname delete"')
