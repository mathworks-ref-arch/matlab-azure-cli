classdef add < azure.AzureBase
    ...
    methods
        function this = add()
            ...
            this.BaseCmd = 'az webapp config hostname add ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az webapp config hostname add --hostname $fqdn --resource-group MyResourceGroup --webapp-')
            fprintf('%s\n', '        name MyWebapp')
            fprintf('%s\n', 'For more specific examples, use: az find "az webapp config hostname add"')
