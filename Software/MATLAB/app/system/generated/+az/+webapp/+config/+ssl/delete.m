classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            ...
            this.BaseCmd = 'az webapp config ssl delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az webapp config ssl delete --certificate-thumbprint {certificate-thumbprint} --resource-')
            fprintf('%s\n', '        group MyResourceGroup')
            fprintf('%s\n', 'For more specific examples, use: az find "az webapp config ssl delete"')
