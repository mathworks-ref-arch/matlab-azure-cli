classdef unbind < azure.AzureBase
    ...
    methods
        function this = unbind()
            ...
            this.BaseCmd = 'az webapp config ssl unbind ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az webapp config ssl unbind"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '                                          logs.')
            fprintf('%s\n', 'For more specific examples, use: az find "az webapp config ssl unbind"')
