classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            ...
            this.BaseCmd = 'az webapp config appsettings delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    az webapp config appsettings delete : Delete web app settings.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --setting-names [Required] : Space-separated appsettings names.')
            ...
            fprintf('%s\n', '        az webapp config appsettings delete --name MyWebApp --resource-group MyResourceGroup')
            fprintf('%s\n', '        --setting-names {setting-names}')
            fprintf('%s\n', 'For more specific examples, use: az find "az webapp config appsettings delete"')
