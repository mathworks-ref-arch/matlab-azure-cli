classdef bind < azure.AzureBase
    ...
    methods
        function this = bind()
            ...
            this.BaseCmd = 'az webapp config ssl bind ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az webapp config ssl bind --certificate-thumbprint {certificate-thumbprint} --name MyWebapp')
            fprintf('%s\n', '        --resource-group MyResourceGroup --ssl-type SNI')
            fprintf('%s\n', 'For more specific examples, use: az find "az webapp config ssl bind"')
