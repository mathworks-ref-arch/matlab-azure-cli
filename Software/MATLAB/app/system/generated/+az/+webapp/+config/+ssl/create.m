classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            % az webapp config ssl create : Create a Managed Certificate for a hostname in a webapp app.
            % This command is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az webapp config ssl create ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az webapp config ssl create --resource-group MyResourceGroup --name MyWebapp --hostname')
            fprintf('%s\n', '        $fqdn')
            fprintf('%s\n', 'For more specific examples, use: az find "az webapp config ssl create"')
