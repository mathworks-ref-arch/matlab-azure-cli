classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az webapp config access-restriction show : Show Access Restriction settings for webapp.
            % Command group 'webapp config access-restriction' is in preview. It may be
            % changed/removed in a future release.
            this.BaseCmd = 'az webapp config access-restriction show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az webapp config access-restriction show"')
