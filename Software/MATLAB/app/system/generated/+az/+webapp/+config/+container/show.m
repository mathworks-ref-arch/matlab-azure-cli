classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            ...
            this.BaseCmd = 'az webapp config container show ';
        end
        function this = show_multicontainer_config(this, varargin)
            % Shows decoded config if a multicontainer config is set.
            this.Options = [this.Options, '--show-multicontainer-config', varargin{:}];
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    az webapp config container show : Get details of a web app container''s settings.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --show-multicontainer-config : Shows decoded config if a multicontainer config is set.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az webapp config container show"')
