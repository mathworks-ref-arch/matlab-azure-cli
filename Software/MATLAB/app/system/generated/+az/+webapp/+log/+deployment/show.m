classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az webapp log deployment show : Show deployment logs of the latest deployment, or a specific
            % deployment if deployment-id is specified.
            % Command group 'webapp log deployment' is in preview. It may be changed/removed in a
            % future release.
            this.BaseCmd = 'az webapp log deployment show ';
        end
        ...
        function this = deployment_id(this, varargin)
            % Deployment ID. If none specified, returns the deployment logs of the latest deployment.
            this.Options = [this.Options, '--deployment-id', varargin{:}];
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --deployment-id                : Deployment ID. If none specified, returns the deployment logs')
            ...
            fprintf('%s\n', '        az webapp log deployment show --name MyWebApp --resource-group MyResourceGroup --deployment-')
            fprintf('%s\n', '        id MyDeploymentId')
            fprintf('%s\n', 'For more specific examples, use: az find "az webapp log deployment show"')
