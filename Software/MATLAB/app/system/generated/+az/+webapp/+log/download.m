classdef download < azure.AzureBase
    ...
    methods
        function this = download()
            ...
            this.BaseCmd = 'az webapp log download ';
        end
        function this = log_file(this, varargin)
            % The downloaded zipped log file path.  Default: webapp_logs.zip.
            this.Options = [this.Options, '--log-file', varargin{:}];
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        This command may not work with web apps running on Linux.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --log-file          : The downloaded zipped log file path.  Default: webapp_logs.zip.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az webapp log download"')
