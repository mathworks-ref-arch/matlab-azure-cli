classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az webapp log deployment list : List deployments associated with web app.
            % Command group 'webapp log deployment' is in preview. It may be changed/removed in a
            % future release.
            this.BaseCmd = 'az webapp log deployment list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az webapp log deployment list"')
