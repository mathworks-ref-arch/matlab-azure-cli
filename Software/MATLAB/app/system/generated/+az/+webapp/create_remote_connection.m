classdef create_remote_connection < azure.AzureBase

    % Copyright 2020, The MathWorks Inc.

    methods
        function this = create_remote_connection()
            % az webapp create-remote-connection : Creates a remote connection using a tcp tunnel to your web
            % app.
            this.BaseCmd = 'az webapp create-remote-connection ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az webapp create-remote-connection"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az webapp create-remote-connection"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class create_remote_connection 
