classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            ...
            % release.
            this.BaseCmd = 'az webapp deleted list ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az webapp deleted list"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --slot -s           : Name of the deleted web app slot.')
            fprintf('%s\n', 'Global Arguments')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az webapp deleted list"')
