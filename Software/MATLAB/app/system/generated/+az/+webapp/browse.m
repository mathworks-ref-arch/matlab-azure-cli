classdef browse < azure.AzureBase
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    az webapp browse : Open a web app in a browser.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --logs -l           : Enable viewing the log stream immediately after launching the web app.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az webapp browse"')
