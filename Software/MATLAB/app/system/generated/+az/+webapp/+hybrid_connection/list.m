classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az webapp hybrid-connection list : List the hybrid-connections on a webapp.
            % Command group 'webapp hybrid-connection' is in preview. It may be changed/removed in a
            % future release.
            this.BaseCmd = 'az webapp hybrid-connection list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az webapp hybrid-connection list"')
