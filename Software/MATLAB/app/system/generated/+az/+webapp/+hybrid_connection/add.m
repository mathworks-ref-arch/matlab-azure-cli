classdef add < azure.AzureBase
    ...
    methods
        function this = add()
            % az webapp hybrid-connection add : Add a hybrid-connection to a webapp.
            % Command group 'webapp hybrid-connection' is in preview. It may be changed/removed in a
            % future release.
            this.BaseCmd = 'az webapp hybrid-connection add ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az webapp hybrid-connection add -g MyResourceGroup -n MyWebapp --namespace')
            fprintf('%s\n', '        [HybridConnectionNamespace] --hybrid-connection [HybridConnectionName] -s [slot]')
            fprintf('%s\n', 'For more specific examples, use: az find "az webapp hybrid-connection add"')
