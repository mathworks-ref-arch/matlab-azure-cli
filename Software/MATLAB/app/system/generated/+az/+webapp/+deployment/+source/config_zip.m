classdef config_zip < azure.AzureBase
    ...
    methods
        function this = config_zip()
            ...
            % preview. Alternately the setting can be enabled using the az webapp config appsettings set
            % command.
            this.BaseCmd = 'az webapp deployment source config-zip ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az webapp deployment source config-zip"')
