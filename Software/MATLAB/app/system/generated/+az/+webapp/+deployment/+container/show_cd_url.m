classdef show_cd_url < azure.AzureBase
    ...
    methods
        function this = show_cd_url()
            % az webapp deployment container show-cd-url : Get the URL which can be used to configure webhooks
            % for continuous deployment.
            this.BaseCmd = 'az webapp deployment container show-cd-url ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        --slot staging')
            fprintf('%s\n', 'For more specific examples, use: az find "az webapp deployment container show-cd-url"')
