classdef list_publishing_profiles < azure.AzureBase
    ...
    methods
        function this = list_publishing_profiles()
            % az webapp deployment list-publishing-profiles : Get the details for available web app deployment
            % profiles.
            this.BaseCmd = 'az webapp deployment list-publishing-profiles ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az webapp deployment list-publishing-profiles --name MyWebapp --resource-group')
            fprintf('%s\n', '        MyResourceGroup --subscription MySubscription')
            fprintf('%s\n', 'For more specific examples, use: az find "az webapp deployment list-publishing-profiles"')
