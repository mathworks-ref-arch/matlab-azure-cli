classdef config_local_git < azure.AzureBase
    ...
    methods
        function this = config_local_git()
            % az webapp deployment source config-local-git : Get a URL for a git repository endpoint to clone
            % and push to for web app deployment.
            this.BaseCmd = 'az webapp deployment source config-local-git ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az webapp deployment source config-local-git"')
