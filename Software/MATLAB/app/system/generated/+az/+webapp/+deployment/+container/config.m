classdef config < azure.AzureBase
    ...
    methods
        function this = config()
            ...
            this.BaseCmd = 'az webapp deployment container config ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az webapp deployment container config --enable-cd true --name MyWebapp --resource-group')
            fprintf('%s\n', '        MyResourceGroup')
            fprintf('%s\n', 'For more specific examples, use: az find "az webapp deployment container config"')
