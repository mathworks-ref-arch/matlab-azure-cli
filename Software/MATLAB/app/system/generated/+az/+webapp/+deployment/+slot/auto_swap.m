classdef auto_swap < azure.AzureBase
    ...
    methods
        function this = auto_swap()
            ...
            this.BaseCmd = 'az webapp deployment slot auto-swap ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az webapp deployment slot auto-swap --name MyWebapp --resource-group MyResourceGroup --slot')
            fprintf('%s\n', '        staging')
            fprintf('%s\n', 'For more specific examples, use: az find "az webapp deployment slot auto-swap"')
