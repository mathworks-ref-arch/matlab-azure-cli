classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            ...
            this.BaseCmd = 'az webapp deployment slot delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az webapp deployment slot delete --name MyWebapp --resource-group MyResourceGroup --slot')
            fprintf('%s\n', '        staging')
            fprintf('%s\n', 'For more specific examples, use: az find "az webapp deployment slot delete"')
