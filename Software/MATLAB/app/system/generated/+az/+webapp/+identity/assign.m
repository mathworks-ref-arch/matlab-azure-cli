classdef assign < azure.AzureBase
    ...
    methods
        function this = assign()
            % az webapp identity assign : Assign managed service identity to the web app.
            this.BaseCmd = 'az webapp identity assign ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az webapp identity assign -g MyResourceGroup -n MyUniqueApp --role reader --scope')
            ...
            fprintf('%s\n', '        az webapp identity assign -g MyResourceGroup -n MyUniqueApp --identities [system]')
            fprintf('%s\n', '        myAssignedId')
            fprintf('%s\n', 'For more specific examples, use: az find "az webapp identity assign"')
