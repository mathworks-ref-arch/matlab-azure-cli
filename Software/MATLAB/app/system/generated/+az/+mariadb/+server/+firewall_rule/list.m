classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az mariadb server firewall-rule list : List all firewall rules for a server.
            this.BaseCmd = 'az mariadb server firewall-rule list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az mariadb server firewall-rule list"')
