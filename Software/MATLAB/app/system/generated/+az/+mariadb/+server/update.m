classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az mariadb server update : Update a server.
            this.BaseCmd = 'az mariadb server update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az mariadb server update --admin-password password --name testsvrnew --resource-group')
            fprintf('%s\n', '        testgroup')
            fprintf('%s\n', '    Update a server. (autogenerated)')
            fprintf('%s\n', '        az mariadb server update --name testsvrnew --resource-group testgroup --ssl-enforcement')
            fprintf('%s\n', '        Enabled')
            fprintf('%s\n', 'For more specific examples, use: az find "az mariadb server update"')
