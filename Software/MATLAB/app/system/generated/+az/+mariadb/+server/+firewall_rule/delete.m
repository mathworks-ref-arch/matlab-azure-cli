classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            ...
            this.BaseCmd = 'az mariadb server firewall-rule delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az mariadb server firewall-rule delete --name MyFirewallRule --resource-group')
            fprintf('%s\n', '        MyResourceGroup --server-name MyServer --subscription MySubscription --yes')
            fprintf('%s\n', 'For more specific examples, use: az find "az mariadb server firewall-rule delete"')
