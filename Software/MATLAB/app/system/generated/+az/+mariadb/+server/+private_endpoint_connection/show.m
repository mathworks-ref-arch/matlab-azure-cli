classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az mariadb server private-endpoint-connection show : Show details of a private endpoint
            % connection associated with a MariaDB server.
            this.BaseCmd = 'az mariadb server private-endpoint-connection show ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az mariadb server private-endpoint-connection show"
