classdef approve < azure.AzureBase
    ...
    methods
        function this = approve()
            % az mariadb server private-endpoint-connection approve : Approve the specified private endpoint
            % connection associated with a MariaDB server.
            this.BaseCmd = 'az mariadb server private-endpoint-connection approve ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az mariadb server private-endpoint-connection approve"
