classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            % az mariadb server replica create : Create a read replica for a server.
            this.BaseCmd = 'az mariadb server replica create ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az mariadb server replica create"')
