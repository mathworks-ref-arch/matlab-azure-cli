classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            % az mariadb server vnet-rule create : Create a virtual network rule to allows access to a MariaDB
            % server.
            this.BaseCmd = 'az mariadb server vnet-rule create ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az mariadb server vnet-rule create -g testgroup -s testsvr -n vnetRuleName --subnet /subscri')
            fprintf('%s\n', '        ptions/{SubID}/resourceGroups/{ResourceGroup}/providers/Microsoft.Network/virtualNetworks/vn')
            ...
            fprintf('%s\n', '        az mariadb server vnet-rule create -g testgroup -s testsvr -n vnetRuleName --subnet')
            fprintf('%s\n', '        subnetName --vnet-name vnetName')
            fprintf('%s\n', 'For more specific examples, use: az find "az mariadb server vnet-rule create"')
