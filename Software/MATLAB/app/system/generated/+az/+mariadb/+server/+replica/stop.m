classdef stop < azure.AzureBase
    ...
    methods
        function this = stop()
            % az mariadb server replica stop : Stop replication to a read replica and make it a read/write
            % server.
            this.BaseCmd = 'az mariadb server replica stop ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az mariadb server replica stop"')
