classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az mariadb server firewall-rule show : Get the details of a firewall rule.
            this.BaseCmd = 'az mariadb server firewall-rule show ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az mariadb server firewall-rule show"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az mariadb server firewall-rule show"')
