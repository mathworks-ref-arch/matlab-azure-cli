classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            % az mariadb db create : Create a MariaDB database.
            this.BaseCmd = 'az mariadb db create ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az mariadb db create -g testgroup -s testsvr -n testdb --charset {valid_charset} --collation')
            fprintf('%s\n', '        {valid_collation}')
            fprintf('%s\n', 'For more specific examples, use: az find "az mariadb db create"')
