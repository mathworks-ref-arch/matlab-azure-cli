classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            ...
            this.BaseCmd = 'az mysql server firewall-rule show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az mysql server firewall-rule show --name MyFirewallRule --resource-group MyResourceGroup')
            fprintf('%s\n', '        --server-name MyServer')
            fprintf('%s\n', 'For more specific examples, use: az find "az mysql server firewall-rule show"')
