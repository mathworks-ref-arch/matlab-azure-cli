classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            % az mysql server replica create : Create a read replica for a server.
            this.BaseCmd = 'az mysql server replica create ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        QL/servers/testsvr2"')
            fprintf('%s\n', 'For more specific examples, use: az find "az mysql server replica create"')
