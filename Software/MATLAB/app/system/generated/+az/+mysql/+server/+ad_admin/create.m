classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            % az mysql server ad-admin create : Create an Active Directory administrator for MySQL server.
            % Command group 'mysql server ad-admin' is in preview. It may be changed/removed in a
            % future release.
            this.BaseCmd = 'az mysql server ad-admin create ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az mysql server ad-admin create --server-name testsvr -g testgroup --display-name')
            fprintf('%s\n', '        username@domain.com --object-id 1FCD6583-267B-4484-BF9B-507E4B62DE79')
            fprintf('%s\n', 'For more specific examples, use: az find "az mysql server ad-admin create"')
