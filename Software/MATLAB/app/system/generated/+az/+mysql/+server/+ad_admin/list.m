classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az mysql server ad-admin list : List all Active Directory Administrators for MySQL server.
            % Command group 'mysql server ad-admin' is in preview. It may be changed/removed in a
            % future release.
            this.BaseCmd = 'az mysql server ad-admin list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az mysql server ad-admin list"')
