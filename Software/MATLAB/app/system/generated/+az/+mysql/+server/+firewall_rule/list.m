classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            ...
            this.BaseCmd = 'az mysql server firewall-rule list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az mysql server firewall-rule list --resource-group MyResourceGroup --server-name MyServer')
            fprintf('%s\n', 'For more specific examples, use: az find "az mysql server firewall-rule list"')
