classdef set < azure.AzureBase
    ...
    methods
        function this = set()
            ...
            this.BaseCmd = 'az mysql server configuration set ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az mysql server configuration set -g testgroup -s testsvr -n {config_name} --value')
            fprintf('%s\n', '        {config_value}')
            fprintf('%s\n', '    Set a configuration value to its default.')
            fprintf('%s\n', '        az mysql server configuration set -g testgroup -s testsvr -n {config_name}')
            fprintf('%s\n', 'For more specific examples, use: az find "az mysql server configuration set"')
