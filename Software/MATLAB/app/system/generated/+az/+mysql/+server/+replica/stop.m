classdef stop < azure.AzureBase
    ...
    methods
        function this = stop()
            % az mysql server replica stop : Stop replication to a read replica and make it a read/write
            % server.
            this.BaseCmd = 'az mysql server replica stop ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az mysql server replica stop"')
