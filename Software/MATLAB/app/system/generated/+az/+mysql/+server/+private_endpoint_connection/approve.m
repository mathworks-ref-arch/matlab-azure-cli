classdef approve < azure.AzureBase
    ...
    methods
        function this = approve()
            % az mysql server private-endpoint-connection approve : Approve the specified private endpoint
            % connection associated with a MySQL server.
            this.BaseCmd = 'az mysql server private-endpoint-connection approve ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az mysql server private-endpoint-connection approve"
