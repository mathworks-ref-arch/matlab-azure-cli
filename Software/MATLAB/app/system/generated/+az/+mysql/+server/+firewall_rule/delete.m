classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            ...
            this.BaseCmd = 'az mysql server firewall-rule delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az mysql server firewall-rule delete --name MyFirewallRule --resource-group MyResourceGroup')
            fprintf('%s\n', '        --server-name MyServer')
            fprintf('%s\n', 'For more specific examples, use: az find "az mysql server firewall-rule delete"')
