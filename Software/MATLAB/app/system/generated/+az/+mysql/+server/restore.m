classdef restore < azure.AzureBase
    ...
    methods
        function this = restore()
            ...
            this.BaseCmd = 'az mysql server restore ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az mysql server restore -g testgroup -n testsvrnew --source-server testsvr --restore-point-')
            fprintf('%s\n', '        in-time "2017-06-15T13:10:00Z"')
            ...
            fprintf('%s\n', '            -s "/subscriptions/${SubID}/resourceGroups/${ResourceGroup}/providers/Microsoft.DBforMyS')
            fprintf('%s\n', '        QL/servers/testsvr2" \')
            fprintf('%s\n', '            --restore-point-in-time "2017-06-15T13:10:00Z"')
            fprintf('%s\n', 'For more specific examples, use: az find "az mysql server restore"')
