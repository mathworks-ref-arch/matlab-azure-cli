classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            % az mysql server key create : Create server key.
            % Command group 'mysql server key' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az mysql server key create ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az mysql server key create"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az mysql server key create"')
