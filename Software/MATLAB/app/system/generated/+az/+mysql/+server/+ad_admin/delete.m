classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az mysql server ad-admin delete : Delete an Active Directory Administrator for MySQL server.
            % Command group 'mysql server ad-admin' is in preview. It may be changed/removed in a
            % future release.
            this.BaseCmd = 'az mysql server ad-admin delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az mysql server ad-admin delete"')
