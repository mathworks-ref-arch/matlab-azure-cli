classdef wait < azure.AzureBase
    ...
    methods
        function this = wait()
            % az mysql server wait : Wait for server to satisfy certain conditions.
            this.BaseCmd = 'az mysql server wait ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az mysql server wait"')
