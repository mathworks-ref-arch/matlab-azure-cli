classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az mysql server ad-admin show : Get Active Directory Administrator information for a MySQL
            % server.
            % Command group 'mysql server ad-admin' is in preview. It may be changed/removed in a
            % future release.
            this.BaseCmd = 'az mysql server ad-admin show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az mysql server ad-admin show"')
