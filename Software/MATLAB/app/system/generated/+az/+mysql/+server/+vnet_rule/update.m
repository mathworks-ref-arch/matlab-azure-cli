classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az mysql server vnet-rule update : Update a virtual network rule.
            this.BaseCmd = 'az mysql server vnet-rule update ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az mysql server vnet-rule update"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az mysql server vnet-rule update"')
