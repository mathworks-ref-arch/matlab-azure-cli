classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            ...
            this.BaseCmd = 'az mysql db create ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az mysql db create -g testgroup -s testsvr -n testdb --charset {valid_charset} --collation')
            fprintf('%s\n', '        {valid_collation}')
            fprintf('%s\n', 'For more specific examples, use: az find "az mysql db create"')
