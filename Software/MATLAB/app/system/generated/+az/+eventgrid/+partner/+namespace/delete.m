classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az eventgrid partner namespace delete : Delete a partner namespace.
            % Command group 'eventgrid partner namespace' is in preview. It may be changed/removed in
            % a future release.
            this.BaseCmd = 'az eventgrid partner namespace delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az eventgrid partner namespace delete"')
