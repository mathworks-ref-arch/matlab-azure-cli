classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az eventgrid partner namespace event-channel delete : Delete a partner namespace.
            % Command group 'eventgrid partner namespace event-channel' is in preview. It may be
            % changed/removed in a future release.
            this.BaseCmd = 'az eventgrid partner namespace event-channel delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az eventgrid partner namespace event-channel delete -g rg1 --partner-namespace-name')
