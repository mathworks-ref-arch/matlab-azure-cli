classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az eventgrid partner topic list : List available partner topics.
            % Command group 'eventgrid partner topic' is in preview. It may be changed/removed in a
            % future release.
            this.BaseCmd = 'az eventgrid partner topic list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az eventgrid partner topic list"')
