classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az eventgrid partner namespace list : List available partner namespaces.
            % Command group 'eventgrid partner namespace' is in preview. It may be changed/removed in
            % a future release.
            this.BaseCmd = 'az eventgrid partner namespace list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az eventgrid partner namespace list"')
