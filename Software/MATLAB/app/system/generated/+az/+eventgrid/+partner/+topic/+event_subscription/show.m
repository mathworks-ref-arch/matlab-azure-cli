classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az eventgrid partner topic event-subscription show : Get the details of an event subscription of
            % a partner topic.
            % Command group 'eventgrid partner topic event-subscription' is in preview. It may be
            % changed/removed in a future release.
            this.BaseCmd = 'az eventgrid partner topic event-subscription show ';
        end
