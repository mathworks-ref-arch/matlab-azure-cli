classdef activate < azure.AzureBase
    ...
    methods
        function this = activate()
            % az eventgrid partner topic activate : Activate a partner topic.
            % Command group 'eventgrid partner topic' is in preview. It may be changed/removed in a
            % future release.
            this.BaseCmd = 'az eventgrid partner topic activate ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az eventgrid partner topic activate"')
