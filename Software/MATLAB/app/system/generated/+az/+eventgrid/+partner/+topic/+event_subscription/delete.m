classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az eventgrid partner topic event-subscription delete : Delete an event subscription of a partner
            % topic.
            % Command group 'eventgrid partner topic event-subscription' is in preview. It may be
            % changed/removed in a future release.
            this.BaseCmd = 'az eventgrid partner topic event-subscription delete ';
        end
