classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az eventgrid partner namespace key list : List shared access keys of a partner namespace.
            % Command group 'eventgrid partner namespace' is in preview. It may be changed/removed in
            % a future release.
            this.BaseCmd = 'az eventgrid partner namespace key list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az eventgrid partner namespace key list --partner-namespace-name MyNamespace --resource-')
            fprintf('%s\n', '        group MyResourceGroup')
            fprintf('%s\n', 'For more specific examples, use: az find "az eventgrid partner namespace key list"')
