classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            % az eventgrid domain topic create : Create a domain topic under a domain.
            this.BaseCmd = 'az eventgrid domain topic create ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --name -n           [Required] : Name of the domain topic.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az eventgrid domain topic create"')
