classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az eventgrid domain show : Get the details of a domain.
            this.BaseCmd = 'az eventgrid domain show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az eventgrid domain show"')
