classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az eventgrid domain update : Update a domain.
            this.BaseCmd = 'az eventgrid domain update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az eventgrid domain update -g rg1 --name domain1 --sku Basic --identity noidentity --public-')
            fprintf('%s\n', '        network-access enabled --inbound-ip-rules 10.0.0.0/8 Allow --inbound-ip-rules 10.2.0.0/8')
            fprintf('%s\n', '        Allow --tags Dept=IT --sku basic')
            fprintf('%s\n', 'For more specific examples, use: az find "az eventgrid domain update"')
