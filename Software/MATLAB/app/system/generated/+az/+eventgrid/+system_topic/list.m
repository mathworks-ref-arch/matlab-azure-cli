classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az eventgrid system-topic list : List available system topics.
            % Command group 'eventgrid system-topic' is in preview. It may be changed/removed in a
            % future release.
            this.BaseCmd = 'az eventgrid system-topic list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az eventgrid system-topic list"')
