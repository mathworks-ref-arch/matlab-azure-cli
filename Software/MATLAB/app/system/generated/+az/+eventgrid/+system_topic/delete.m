classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az eventgrid system-topic delete : Delete a system topic.
            % Command group 'eventgrid system-topic' is in preview. It may be changed/removed in a
            % future release.
            this.BaseCmd = 'az eventgrid system-topic delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az eventgrid system-topic delete"')
