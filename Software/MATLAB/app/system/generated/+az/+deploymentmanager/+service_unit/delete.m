classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az deploymentmanager service-unit delete : Deletes the service unit.
            % Command group 'deploymentmanager' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az deploymentmanager service-unit delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az deploymentmanager service-unit delete -g rg1 --service-topology-name')
            fprintf('%s\n', '        contosoServiceTopology --service-name contosoService1 -n ContosoService1Storage')
            fprintf('%s\n', 'For more specific examples, use: az find "az deploymentmanager service-unit delete"')
