classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az deploymentmanager service list : List all services in a service topology.
            % Command group 'deploymentmanager' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az deploymentmanager service list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '                                         logs.')
            fprintf('%s\n', 'Examples')
            fprintf('%s\n', '    List all the services under the given service topology.')
            fprintf('%s\n', '        az deploymentmanager service list -g rg1 --service-topology-name contosoServiceTopology')
            fprintf('%s\n', 'For more specific examples, use: az find "az deploymentmanager service list"')
