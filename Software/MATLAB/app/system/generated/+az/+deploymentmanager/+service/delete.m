classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az deploymentmanager service delete : Deletes the service topology.
            % Command group 'deploymentmanager' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az deploymentmanager service delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az deploymentmanager service delete -g rg1 --service-topology-name contosoServiceTopology -n')
            fprintf('%s\n', '        contosoService1')
            fprintf('%s\n', 'For more specific examples, use: az find "az deploymentmanager service delete"')
