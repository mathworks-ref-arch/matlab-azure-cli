classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az deploymentmanager step show : Get the details of the step.
            % Command group 'deploymentmanager' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az deploymentmanager step show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az deploymentmanager step show"')
