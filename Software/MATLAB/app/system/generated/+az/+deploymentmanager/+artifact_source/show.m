classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az deploymentmanager artifact-source show : Get the details of an artifact source.
            % Command group 'deploymentmanager' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az deploymentmanager artifact-source show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az deploymentmanager artifact-source show"')
