classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az deploymentmanager rollout show : Gets the rollout.
            % Command group 'deploymentmanager' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az deploymentmanager rollout show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --retry-attempt                     : Rollout retry attempt ordinal to get the result of. If not')
            ...
            fprintf('%s\n', '    Gets the specific retry attempt of a rollout. Shows the steps run during that attempt.')
            fprintf('%s\n', '        az deploymentmanager rollout show -g rg1 -n contosoServiceRollout --retry-attempt 1')
            fprintf('%s\n', 'For more specific examples, use: az find "az deploymentmanager rollout show"')
