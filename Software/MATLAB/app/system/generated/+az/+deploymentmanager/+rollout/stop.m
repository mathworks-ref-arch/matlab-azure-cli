classdef stop < azure.AzureBase
    ...
    methods
        function this = stop()
            % az deploymentmanager rollout stop : Stop the rollout.
            % Command group 'deploymentmanager' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az deploymentmanager rollout stop ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az deploymentmanager rollout stop"')
