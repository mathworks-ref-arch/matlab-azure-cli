classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az deploymentmanager service-topology show : Get the details of a service topology.
            % Command group 'deploymentmanager' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az deploymentmanager service-topology show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az deploymentmanager service-topology show"')
