classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az sig update : Update a share image gallery.
            this.BaseCmd = 'az sig update ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az sig update"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az sig update"')
