classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az sig image-definition delete : Delete a gallery image.
            this.BaseCmd = 'az sig image-definition delete ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az sig image-definition delete"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az sig image-definition delete"')
