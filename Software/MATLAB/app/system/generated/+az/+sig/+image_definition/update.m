classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az sig image-definition update : Update a share image defintiion.
            this.BaseCmd = 'az sig image-definition update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '                                               debug logs.')
            fprintf('%s\n', 'Examples')
            fprintf('%s\n', '    update a share image defintiion. (autogenerated)')
            fprintf('%s\n', '        az sig image-definition update --gallery-image-definition MyImage --gallery-name MyGallery')
            fprintf('%s\n', '        --resource-group MyResourceGroup')
            fprintf('%s\n', 'For more specific examples, use: az find "az sig image-definition update"')
