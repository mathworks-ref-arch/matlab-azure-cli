classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az sig image-version delete : Delete a gallery Image Version.
            this.BaseCmd = 'az sig image-version delete ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az sig image-version delete"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '                                               debug logs.')
            fprintf('%s\n', 'For more specific examples, use: az find "az sig image-version delete"')
