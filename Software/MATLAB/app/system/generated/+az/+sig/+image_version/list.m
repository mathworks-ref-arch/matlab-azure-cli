classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az sig image-version list : List gallery Image Versions in a gallery Image Definition.
            this.BaseCmd = 'az sig image-version list ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az sig image-version list"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '                                               debug logs.')
            fprintf('%s\n', 'For more specific examples, use: az find "az sig image-version list"')
