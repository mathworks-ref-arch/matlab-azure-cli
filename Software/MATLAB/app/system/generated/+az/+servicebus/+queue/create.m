classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            % az servicebus queue create : Create the Service Bus Queue.
            this.BaseCmd = 'az servicebus queue create ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az servicebus queue create --resource-group myresourcegroup --namespace-name mynamespace')
            fprintf('%s\n', '        --name myqueue')
            fprintf('%s\n', 'For more specific examples, use: az find "az servicebus queue create"')
