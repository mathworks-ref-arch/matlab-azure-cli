classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az servicebus queue authorization-rule update : Update Authorization Rule for the given Service
            % Bus Queue.
            this.BaseCmd = 'az servicebus queue authorization-rule update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az servicebus queue authorization-rule update --resource-group myresourcegroup --namespace-')
            fprintf('%s\n', '        name mynamespace --queue-name myqueue --name myauthorule --rights Send')
            fprintf('%s\n', 'For more specific examples, use: az find "az servicebus queue authorization-rule update"')
