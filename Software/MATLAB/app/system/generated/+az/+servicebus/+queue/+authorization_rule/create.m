classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            % az servicebus queue authorization-rule create : Create Authorization Rule for the given Service
            % Bus Queue.
            this.BaseCmd = 'az servicebus queue authorization-rule create ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az servicebus queue authorization-rule create --resource-group myresourcegroup --namespace-')
            fprintf('%s\n', '        name mynamespace --queue-name myqueue --name myauthorule --rights Listen')
            fprintf('%s\n', 'For more specific examples, use: az find "az servicebus queue authorization-rule create"')
