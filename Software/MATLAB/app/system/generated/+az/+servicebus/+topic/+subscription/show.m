classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az servicebus topic subscription show : Shows Service Bus Subscription Details.
            this.BaseCmd = 'az servicebus topic subscription show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az servicebus topic subscription show --resource-group myresourcegroup --namespace-name')
            fprintf('%s\n', '        mynamespace --topic-name mytopic --name mysubscription')
            fprintf('%s\n', 'For more specific examples, use: az find "az servicebus topic subscription show"')
