classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az servicebus topic subscription delete : Deletes the Service Bus Subscription.
            this.BaseCmd = 'az servicebus topic subscription delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az servicebus topic subscription delete --resource-group myresourcegroup --namespace-name')
            fprintf('%s\n', '        mynamespace --topic-name mytopic --name mysubscription')
            fprintf('%s\n', 'For more specific examples, use: az find "az servicebus topic subscription delete"')
