classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            % az servicebus topic authorization-rule create : Create Authorization Rule for given Service Bus
            % Topic.
            this.BaseCmd = 'az servicebus topic authorization-rule create ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az servicebus topic authorization-rule create --resource-group myresourcegroup --namespace-')
            fprintf('%s\n', '        name mynamespace --topic-name mytopic --name myauthorule --rights Send Listen')
            fprintf('%s\n', 'For more specific examples, use: az find "az servicebus topic authorization-rule create"')
