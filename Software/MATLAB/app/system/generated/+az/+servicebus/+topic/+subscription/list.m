classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az servicebus topic subscription list : List the Subscription by Service Bus Topic.
            this.BaseCmd = 'az servicebus topic subscription list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az servicebus topic subscription list --resource-group myresourcegroup --namespace-name')
            fprintf('%s\n', '        mynamespace --topic-name mytopic')
            fprintf('%s\n', 'For more specific examples, use: az find "az servicebus topic subscription list"')
