classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az servicebus topic authorization-rule update : Create Authorization Rule for given Service Bus
            % Topic.
            this.BaseCmd = 'az servicebus topic authorization-rule update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --name -n           : Name of Topic Authorization Rule.')
            ...
            fprintf('%s\n', '        az servicebus topic authorization-rule update --resource-group myresourcegroup --namespace-')
            fprintf('%s\n', '        name mynamespace --topic-name mytopic --name myauthorule --rights Send')
            fprintf('%s\n', 'For more specific examples, use: az find "az servicebus topic authorization-rule update"')
