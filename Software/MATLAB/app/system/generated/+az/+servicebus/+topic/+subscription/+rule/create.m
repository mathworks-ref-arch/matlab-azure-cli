classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            % az servicebus topic subscription rule create : Create the ServiceBus Rule for Subscription.
            this.BaseCmd = 'az servicebus topic subscription rule create ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        --filter-sql-expression myproperty=myvalue')
            fprintf('%s\n', 'For more specific examples, use: az find "az servicebus topic subscription rule create"')
