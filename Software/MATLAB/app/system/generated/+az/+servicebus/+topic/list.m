classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az servicebus topic list : List the Topic by Service Bus Namepsace.
            this.BaseCmd = 'az servicebus topic list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az servicebus topic list"')
