classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az servicebus topic subscription rule list : List the ServiceBus Rule by Subscription.
            this.BaseCmd = 'az servicebus topic subscription rule list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --subscription-name [Required] : Name of Subscription.')
            ...
            fprintf('%s\n', '        az servicebus topic subscription rule list --resource-group myresourcegroup --namespace-name')
            fprintf('%s\n', '        mynamespace --topic-name mytopic --subscription-name mysubscription')
            fprintf('%s\n', 'For more specific examples, use: az find "az servicebus topic subscription rule list"')
