classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az servicebus topic subscription rule delete : Deletes the ServiceBus Rule.
            this.BaseCmd = 'az servicebus topic subscription rule delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az servicebus topic subscription rule delete --resource-group myresourcegroup --namespace-')
            fprintf('%s\n', '        name mynamespace --topic-name mytopic --subscription-name mysubscription --name myrule')
            fprintf('%s\n', 'For more specific examples, use: az find "az servicebus topic subscription rule delete"')
