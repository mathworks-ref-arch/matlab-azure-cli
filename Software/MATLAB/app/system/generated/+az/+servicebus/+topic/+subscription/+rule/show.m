classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az servicebus topic subscription rule show : Shows ServiceBus Rule Details.
            this.BaseCmd = 'az servicebus topic subscription rule show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az servicebus topic subscription rule show --resource-group myresourcegroup --namespace-name')
            fprintf('%s\n', '        mynamespace --topic-name mytopic --subscription-name mysubscription --name myrule')
            fprintf('%s\n', 'For more specific examples, use: az find "az servicebus topic subscription rule show"')
