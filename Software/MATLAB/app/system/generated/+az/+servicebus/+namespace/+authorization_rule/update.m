classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az servicebus namespace authorization-rule update : Updates Authorization Rule for the given
            % Service Bus Namespace.
            this.BaseCmd = 'az servicebus namespace authorization-rule update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --name -n           : Name of Namespace Authorization Rule.')
            ...
            fprintf('%s\n', 'Examples')
            fprintf('%s\n', '    Updates Authorization Rule ''myauthorule'' for the given Service Bus Namespace ''mynamepsace'' in')
            fprintf('%s\n', '    resourcegroup')
            fprintf('%s\n', '        az servicebus namespace authorization-rule update --resource-group myresourcegroup')
            fprintf('%s\n', '        --namespace-name mynamespace --name myauthorule --rights Send')
            fprintf('%s\n', 'For more specific examples, use: az find "az servicebus namespace authorization-rule update"')
