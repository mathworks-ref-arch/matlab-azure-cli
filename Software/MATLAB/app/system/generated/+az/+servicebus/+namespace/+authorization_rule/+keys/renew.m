classdef renew < azure.AzureBase
    ...
    methods
        function this = renew()
            % az servicebus namespace authorization-rule keys renew : Regenerate keys of Authorization Rule
            % for the Service Bus Namespace.
            this.BaseCmd = 'az servicebus namespace authorization-rule keys renew ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az servicebus namespace authorization-rule keys renew --resource-group myresourcegroup')
            ...
            fprintf('%s\n', '        az servicebus namespace authorization-rule keys renew --key PrimaryKey --name myauthorule')
            fprintf('%s\n', '        --namespace-name mynamespace --resource-group myresourcegroup --subscription MySubscription')
