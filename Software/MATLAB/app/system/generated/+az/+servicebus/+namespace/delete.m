classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az servicebus namespace delete : Deletes the Service Bus Namespace.
            this.BaseCmd = 'az servicebus namespace delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az servicebus namespace delete"')
