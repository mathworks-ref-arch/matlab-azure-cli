classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az maps account update : Update the properties of a maps account.
            this.BaseCmd = 'az maps account update ';
        end
        function this = sku(this, varargin)
            % The name of the SKU.  Allowed values: S0, S1.
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az maps account update"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    az maps account update : Update the properties of a maps account.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --sku -s            : The name of the SKU.  Allowed values: S0, S1.')
            ...
            fprintf('%s\n', '    --name -n           : The name of the maps account.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az maps account update"')
