classdef remove_expiry < azure.AzureBase

    % Copyright 2020, The MathWorks Inc.

    methods
        function this = remove_expiry()
            % az dls fs remove-expiry : Remove the expiration time for a file.
            % Command group 'dls' is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az dls fs remove-expiry ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az dls fs remove-expiry"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az dls fs remove-expiry"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class remove_expiry 
