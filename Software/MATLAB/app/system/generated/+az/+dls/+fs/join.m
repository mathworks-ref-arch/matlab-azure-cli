classdef join < azure.AzureBase

    % Copyright 2020, The MathWorks Inc.

    methods
        function this = join()
            % az dls fs join : Join files in a Data Lake Store account into one file.
            % Command group 'dls' is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az dls fs join ';
        end
        ...
        function this = source_paths(this, varargin)
            % The space-separated list of files in the Data Lake Store account to join.
            this.Options = [this.Options, '--source-paths', varargin{:}];
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az dls fs join"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --source-paths     [Required] : The space-separated list of files in the Data Lake Store account')
            fprintf('%s\n', '                                    to join.')
            fprintf('%s\n', '    --force                       : Indicates that, if the destination file already exists, it')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az dls fs join"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class join 
