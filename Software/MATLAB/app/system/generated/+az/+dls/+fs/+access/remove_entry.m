classdef remove_entry < azure.AzureBase

    % Copyright 2020, The MathWorks Inc.

    methods
        function this = remove_entry()
            % az dls fs access remove-entry : Remove entries for the access control list of a file or folder.
            % Command group 'dls' is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az dls fs access remove-entry ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az dls fs access remove-entry --account dpreptestfiles --acl-spec')
            fprintf('%s\n', '        user:00000000-0000-0000-0000-000000000000:-w- --path /')
            fprintf('%s\n', 'For more specific examples, use: az find "az dls fs access remove-entry"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class remove_entry 
