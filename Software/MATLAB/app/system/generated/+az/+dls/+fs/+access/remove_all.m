classdef remove_all < azure.AzureBase

    % Copyright 2020, The MathWorks Inc.

    methods
        function this = remove_all()
            % az dls fs access remove-all : Remove the access control list for a file or folder.
            % Command group 'dls' is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az dls fs access remove-all ';
        end
        ...
        function this = default_acl(this, varargin)
            ...
            this.Options = [this.Options, '--default-acl', varargin{:}];
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --default-acl      : A switch that, if specified, indicates that the remove ACL operation should')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az dls fs access remove-all"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class remove_all 
