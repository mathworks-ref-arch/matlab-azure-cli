classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az dls fs access show : Display the access control list (ACL).
            % Command group 'dls' is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az dls fs access show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az dls fs access show"')
