classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az dls fs delete : Delete a file or folder in a Data Lake Store account.
            % Command group 'dls' is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az dls fs delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az dls fs delete"')
