classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az dls account firewall list : Lists firewall rules in a Data Lake Store account.
            % Command group 'dls' is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az dls account firewall list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az dls account firewall list"')
