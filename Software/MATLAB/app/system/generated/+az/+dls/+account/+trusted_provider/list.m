classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az dls account trusted-provider list : Lists the Data Lake Store trusted identity providers
            % within the specified Data Lake Store account.
            % Command group 'dls' is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az dls account trusted-provider list ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az dls account trusted-provider list"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az dls account trusted-provider list"')
