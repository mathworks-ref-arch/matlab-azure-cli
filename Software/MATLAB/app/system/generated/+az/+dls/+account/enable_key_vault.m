classdef enable_key_vault < azure.AzureBase

    % Copyright 2020, The MathWorks Inc.

    methods
        function this = enable_key_vault()
            % az dls account enable-key-vault : Enable the use of Azure Key Vault for encryption of a Data
            % Lake Store account.
            % Command group 'dls' is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az dls account enable-key-vault ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az dls account enable-key-vault"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class enable_key_vault 
