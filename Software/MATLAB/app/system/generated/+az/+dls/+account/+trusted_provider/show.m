classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az dls account trusted-provider show : Gets the specified Data Lake Store trusted identity
            % provider.
            % Command group 'dls' is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az dls account trusted-provider show ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az dls account trusted-provider show"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        Command group ''dls'' is in preview. It may be changed/removed in a future release.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --trusted-id-provider-name [Required] : The name of the trusted identity provider to retrieve.')
            ...
            fprintf('%s\n', '                                            logs.')
            fprintf('%s\n', 'For more specific examples, use: az find "az dls account trusted-provider show"')
