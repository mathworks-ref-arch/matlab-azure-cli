classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az dls account trusted-provider delete : Deletes the specified trusted identity provider from
            % the specified Data Lake Store account.
            % Command group 'dls' is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az dls account trusted-provider delete ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az dls account trusted-provider delete"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        Command group ''dls'' is in preview. It may be changed/removed in a future release.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --trusted-id-provider-name [Required] : The name of the trusted identity provider to delete.')
            ...
            fprintf('%s\n', '                                            logs.')
            fprintf('%s\n', 'For more specific examples, use: az find "az dls account trusted-provider delete"')
