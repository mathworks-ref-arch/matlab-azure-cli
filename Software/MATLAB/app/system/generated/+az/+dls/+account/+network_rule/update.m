classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az dls account network-rule update : Updates a virtual network rule in a Data Lake Store
            % account.
            % Command group 'dls' is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az dls account network-rule update ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az dls account network-rule update"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --subnet       [Required] : Name or ID of the subnet that allows access to DLS. If subnet name')
            fprintf('%s\n', '                                is provided, --name must be provided.')
            fprintf('%s\n', '    --vnet-name               : The virtual network rule name.')
            ...
            fprintf('%s\n', '    --name -n                 : The virtual network rule name.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az dls account network-rule update"')
