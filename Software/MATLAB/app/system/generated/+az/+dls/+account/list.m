classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az dls account list : Lists available Data Lake Store accounts.
            % Command group 'dls' is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az dls account list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az dls account list"')
