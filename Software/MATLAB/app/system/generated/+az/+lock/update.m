classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az lock update : Update a lock.
            this.BaseCmd = 'az lock update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az lock update --name lockName --resource-group group --notes newNotesHere --lock-type')
            fprintf('%s\n', '        CanNotDelete')
            fprintf('%s\n', 'For more specific examples, use: az find "az lock update"')
