classdef renew < azure.AzureBase
    ...
    methods
        function this = renew()
            ...
            this.BaseCmd = 'az signalr key renew ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    az signalr key renew : Regenerate the access key for a SignalR Service.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --key-type          [Required] : The name of access key to regenerate.  Allowed values: primary,')
            fprintf('%s\n', '                                     secondary.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az signalr key renew"')
