classdef remove < azure.AzureBase
    ...
    methods
        function this = remove()
            ...
            this.BaseCmd = 'az signalr cors remove ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az signalr cors remove -n MySignalR -g MyResourceGroup --allowed-origins')
            fprintf('%s\n', '        "http://example1.com" "https://example2.com"')
            fprintf('%s\n', 'For more specific examples, use: az find "az signalr cors remove"')
