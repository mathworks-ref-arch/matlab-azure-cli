classdef add < azure.AzureBase
    ...
    methods
        function this = add()
            ...
            this.BaseCmd = 'az signalr cors add ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az signalr cors add -n MySignalR -g MyResourceGroup --allowed-origins "http://example1.com"')
            fprintf('%s\n', '        "https://example2.com"')
            fprintf('%s\n', 'For more specific examples, use: az find "az signalr cors add"')
