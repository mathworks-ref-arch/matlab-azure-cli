classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az iot central app show : Get the details of an IoT Central application.
            % Command group 'iot central app' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az iot central app show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az iot central app show"')
