classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az iot central app update : Update metadata for an IoT Central application.
            % Command group 'iot central app' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az iot central app update ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az iot central app update"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az iot central app update"')
