classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az iot central app list : List IoT Central applications.
            % Command group 'iot central app' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az iot central app list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az iot central app list"')
