classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az iot central app delete : Delete an IoT Central application.
            % Command group 'iot central app' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az iot central app delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az iot central app delete --name MyIoTCentralApplication --resource-group MyResourceGroup')
            fprintf('%s\n', 'For more specific examples, use: az find "az iot central app delete"')
