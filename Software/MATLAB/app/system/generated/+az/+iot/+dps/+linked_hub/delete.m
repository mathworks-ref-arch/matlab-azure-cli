classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az iot dps linked-hub delete : Update a linked IoT hub in an Azure IoT Hub device provisioning
            % service.
            this.BaseCmd = 'az iot dps linked-hub delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az iot dps linked-hub delete --dps-name MyDps --resource-group MyResourceGroup --linked-hub')
            fprintf('%s\n', '        MyLinkedHub')
            fprintf('%s\n', 'For more specific examples, use: az find "az iot dps linked-hub delete"')
