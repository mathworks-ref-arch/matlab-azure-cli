classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az iot dps certificate list : List all certificates contained within an Azure IoT Hub device
            % provisioning service.
            this.BaseCmd = 'az iot dps certificate list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az iot dps certificate list"')
