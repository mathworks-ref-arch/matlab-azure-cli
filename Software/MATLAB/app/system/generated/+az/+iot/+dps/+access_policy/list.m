classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az iot dps access-policy list : List all shared access policies in an Azure IoT Hub device
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az iot dps access-policy list"')
