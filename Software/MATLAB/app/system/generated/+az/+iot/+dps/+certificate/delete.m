classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            ...
            this.BaseCmd = 'az iot dps certificate delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az iot dps certificate delete --dps-name MyDps --resource-group MyResourceGroup --name')
            fprintf('%s\n', '        MyCertificate --etag AAAAAAAAAAA=')
            fprintf('%s\n', 'For more specific examples, use: az find "az iot dps certificate delete"')
