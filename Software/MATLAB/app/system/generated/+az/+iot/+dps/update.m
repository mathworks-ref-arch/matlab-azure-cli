classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            ...
            this.BaseCmd = 'az iot dps update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --name -n           : IoT Provisioning Service name.')
            ...
            fprintf('%s\n', '        az iot dps update --name MyDps --resource-group MyResourceGroup --set')
            fprintf('%s\n', '        properties.allocationPolicy="GeoLatency"')
            fprintf('%s\n', 'For more specific examples, use: az find "az iot dps update"')
