classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az iot dps access-policy update : Update a shared access policy in an Azure IoT Hub device
            % provisioning service.
            this.BaseCmd = 'az iot dps access-policy update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --rights -r                               : Access rights for the IoT provisioning service. Use')
            ...
            fprintf('%s\n', '                                                debug logs.')
            fprintf('%s\n', 'Examples')
            fprintf('%s\n', '    Update access policy ''MyPolicy'' in an Azure IoT Hub device provisioning service with')
            fprintf('%s\n', '    EnrollmentWrite right')
            fprintf('%s\n', '        az iot dps access-policy update --dps-name MyDps --resource-group MyResourceGroup --name')
            fprintf('%s\n', '        MyPolicy --rights EnrollmentWrite')
            fprintf('%s\n', 'For more specific examples, use: az find "az iot dps access-policy update"')
