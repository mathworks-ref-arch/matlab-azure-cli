classdef verify < azure.AzureBase
    ...
    methods
        function this = verify()
            ...
            % Verify a certificate by uploading a verification certificate containing the verification
            % code obtained by calling generate-verification-code. This is the last step in the proof of
            % possession process.
            this.BaseCmd = 'az iot dps certificate verify ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az iot dps certificate verify --dps-name MyDps --resource-group MyResourceGroup --name')
            fprintf('%s\n', '        MyCertificate --path /certificates/Verification.pem --etag AAAAAAAAAAA=')
            fprintf('%s\n', 'For more specific examples, use: az find "az iot dps certificate verify"')
