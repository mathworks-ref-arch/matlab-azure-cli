classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az iot dps certificate show : Show information about a particular Azure IoT Hub Device
            % Provisioning Service certificate.
            this.BaseCmd = 'az iot dps certificate show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az iot dps certificate show --dps-name MyDps --resource-group MyResourceGroup --name')
            fprintf('%s\n', '        MyCertificate')
            fprintf('%s\n', '    Show information about a particular Azure IoT Hub Device Provisioning Service certificate.')
            fprintf('%s\n', '    (autogenerated)')
            fprintf('%s\n', '        az iot dps certificate show --certificate-name MyCertificate --dps-name MyDps --resource-')
            fprintf('%s\n', '        group MyResourceGroup --subscription MySubscription')
            fprintf('%s\n', 'For more specific examples, use: az find "az iot dps certificate show"')
