classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az iot dps linked-hub list : List all linked IoT hubs in an Azure IoT Hub device provisioning
            % service.
            this.BaseCmd = 'az iot dps linked-hub list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az iot dps linked-hub list"')
