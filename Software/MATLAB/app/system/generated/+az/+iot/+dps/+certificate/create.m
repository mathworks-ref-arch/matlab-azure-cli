classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            % az iot dps certificate create : Create/upload an Azure IoT Hub Device Provisioning Service
            % certificate.
            this.BaseCmd = 'az iot dps certificate create ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az iot dps certificate create --dps-name MyDps --resource-group MyResourceGroup --name')
            fprintf('%s\n', '        MyCertificate --path /certificates/Certificate.pem')
            fprintf('%s\n', '    Upload a CA certificate CER file to an Azure IoT Hub device provisioning service.')
            fprintf('%s\n', '        az iot dps certificate create --dps-name MyDps --resource-group MyResourceGroup --name')
            fprintf('%s\n', '        MyCertificate --path /certificates/Certificate.cer')
            fprintf('%s\n', 'For more specific examples, use: az find "az iot dps certificate create"')
