classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az iot dps access-policy delete : Delete a shared access policies in an Azure IoT Hub device
            % provisioning service.
            this.BaseCmd = 'az iot dps access-policy delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az iot dps access-policy delete --dps-name MyDps --resource-group MyResourceGroup --name')
            fprintf('%s\n', '        MyPolicy')
            fprintf('%s\n', 'For more specific examples, use: az find "az iot dps access-policy delete"')
