classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            ...
            this.BaseCmd = 'az iot hub certificate show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az iot hub certificate show --hub-name MyIotHub --name MyCertificate --resource-group')
            fprintf('%s\n', '        MyResourceGroup --subscription MySubscription')
            fprintf('%s\n', 'For more specific examples, use: az find "az iot hub certificate show"')
