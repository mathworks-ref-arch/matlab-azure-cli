classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            ...
            % Get information on all endpoints in your IoT Hub. You can also specify which endpoint type
            % you want to get informaiton on.
            this.BaseCmd = 'az iot hub routing-endpoint list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        eventhub')
            fprintf('%s\n', 'For more specific examples, use: az find "az iot hub routing-endpoint list"')
