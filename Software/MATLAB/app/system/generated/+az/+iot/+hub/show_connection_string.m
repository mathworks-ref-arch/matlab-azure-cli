classdef show_connection_string < azure.AzureBase
    ...
    methods
        function this = show_connection_string()
            ...
            this.BaseCmd = 'az iot hub show-connection-string ';
        end
        ...
        function this = policy_name(this, varargin)
            % Shared access policy to use.  Default: iothubowner.
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --policy-name        : Shared access policy to use.  Default: iothubowner.')
            fprintf('%s\n', 'Resource Id Arguments')
            fprintf('%s\n', '    --hub-name --name -n : IoT Hub name.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az iot hub show-connection-string"')
