classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            ...
            this.BaseCmd = 'az iot hub consumer-group delete ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az iot hub consumer-group delete"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --name -n           : Event hub consumer group name.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az iot hub consumer-group delete"')
