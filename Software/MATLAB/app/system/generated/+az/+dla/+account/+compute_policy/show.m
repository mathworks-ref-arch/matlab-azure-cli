classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az dla account compute-policy show : Retrieve a compute policy in a Data Lake Analytics account.
            % Command group 'dla' is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az dla account compute-policy show ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az dla account compute-policy show"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        Command group ''dla'' is in preview. It may be changed/removed in a future release.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --compute-policy-name [Required] : The name of the compute policy to retrieve.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az dla account compute-policy show"')
