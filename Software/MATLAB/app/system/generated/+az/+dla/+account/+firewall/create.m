classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            % az dla account firewall create : Create a firewall rule in a Data Lake Analytics account.
            % Command group 'dla' is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az dla account firewall create ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az dla account firewall create"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --end-ip-address     [Required] : The end of the valid IP range for the firewall rule.')
            fprintf('%s\n', '    --firewall-rule-name [Required] : The name of the firewall rule.')
            fprintf('%s\n', '    --start-ip-address   [Required] : The start of the valid IP range for the firewall rule.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az dla account firewall create"')
