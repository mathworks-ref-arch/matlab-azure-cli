classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az dla account blob-storage show : Gets the specified Azure Storage account linked to the given
            % Data Lake Analytics account.
            % Command group 'dla' is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az dla account blob-storage show ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az dla account blob-storage show"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az dla account blob-storage show"')
