classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az dla account data-lake-store show : Gets the specified Data Lake Store account details in the
            % specified Data Lake Analytics account.
            % Command group 'dla' is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az dla account data-lake-store show ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az dla account data-lake-store show"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        Command group ''dla'' is in preview. It may be changed/removed in a future release.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --data-lake-store-account-name [Required] : The name of the Data Lake Store account to retrieve.')
            ...
            fprintf('%s\n', '                                                debug logs.')
            fprintf('%s\n', 'For more specific examples, use: az find "az dla account data-lake-store show"')
