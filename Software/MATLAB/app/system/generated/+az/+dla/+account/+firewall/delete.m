classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az dla account firewall delete : Delete a firewall rule in a Data Lake Analytics account.
            % Command group 'dla' is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az dla account firewall delete ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az dla account firewall delete"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        Command group ''dla'' is in preview. It may be changed/removed in a future release.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --firewall-rule-name [Required] : The name of the firewall rule to delete.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az dla account firewall delete"')
