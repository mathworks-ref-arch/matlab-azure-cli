classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az dla account data-lake-store delete : Updates the Data Lake Analytics account specified to
            % remove the specified Data Lake Store account.
            % Command group 'dla' is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az dla account data-lake-store delete ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az dla account data-lake-store delete"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        Command group ''dla'' is in preview. It may be changed/removed in a future release.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --data-lake-store-account-name [Required] : The name of the Data Lake Store account to remove.')
            ...
            fprintf('%s\n', '                                                debug logs.')
            fprintf('%s\n', 'For more specific examples, use: az find "az dla account data-lake-store delete"')
