classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az dla account blob-storage list : Gets the first page of Azure Storage accounts, if any, linked
            % to the specified Data Lake Analytics account.
            ...
            this.BaseCmd = 'az dla account blob-storage list ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az dla account blob-storage list"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az dla account blob-storage list"')
