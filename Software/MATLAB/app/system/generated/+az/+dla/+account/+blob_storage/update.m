classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az dla account blob-storage update : Updates an Azure Storage account linked to the specified
            % Data Lake Analytics account.
            % Command group 'dla' is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az dla account blob-storage update ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az dla account blob-storage update"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az dla account blob-storage update"')
