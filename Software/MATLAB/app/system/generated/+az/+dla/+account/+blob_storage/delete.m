classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az dla account blob-storage delete : Updates the specified Data Lake Analytics account to remove
            % an Azure Storage account.
            % Command group 'dla' is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az dla account blob-storage delete ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az dla account blob-storage delete"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az dla account blob-storage delete"')
