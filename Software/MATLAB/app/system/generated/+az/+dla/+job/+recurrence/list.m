classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            ...
            this.BaseCmd = 'az dla job recurrence list ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az dla job recurrence list"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        Command group ''dla'' is in preview. It may be changed/removed in a future release.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --end-date-time    : The end date for when to get the list of recurrences. The startDateTime and')
            fprintf('%s\n', '                         endDateTime can be no more than 30 days apart.')
            fprintf('%s\n', '    --start-date-time  : The start date for when to get the list of recurrences. The startDateTime')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az dla job recurrence list"')
