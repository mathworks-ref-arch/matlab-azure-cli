classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az dla catalog view list : List views in a database or schema.
            % Command group 'dla' is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az dla catalog view list ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az dla catalog view list"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --schema-name              : The name of the schema associated with the views to list.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az dla catalog view list"')
