classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az dla catalog assembly list : Retrieves the list of assemblies from the Data Lake Analytics
            % catalog.
            % Command group 'dla' is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az dla catalog assembly list ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az dla catalog assembly list"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az dla catalog assembly list"')
