classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az dla catalog package show : Retrieves the specified package from the Data Lake Analytics
            % catalog.
            % Command group 'dla' is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az dla catalog package show ';
        end
        ...
        function this = package_name(this, varargin)
            % The name of the package.
            this.Options = [this.Options, '--package-name', varargin{:}];
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az dla catalog package show"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        Command group ''dla'' is in preview. It may be changed/removed in a future release.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --database-name [Required] : The name of the database containing the package.')
            fprintf('%s\n', '    --package-name  [Required] : The name of the package.')
            fprintf('%s\n', '    --schema-name   [Required] : The name of the schema containing the package.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az dla catalog package show"')
