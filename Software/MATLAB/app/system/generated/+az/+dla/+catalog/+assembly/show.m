classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az dla catalog assembly show : Retrieves the specified assembly from the Data Lake Analytics
            % catalog.
            % Command group 'dla' is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az dla catalog assembly show ';
        end
        function this = assembly_name(this, varargin)
            % The name of the assembly.
            this.Options = [this.Options, '--assembly-name', varargin{:}];
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az dla catalog assembly show"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --database-name [Required] : The name of the database containing the assembly.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az dla catalog assembly show"')
