classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az dla catalog table-stats list : List table statistics in a database, table, or schema.
            % Command group 'dla' is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az dla catalog table-stats list ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az dla catalog table-stats list"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --schema-name              : The schema associated with the tables to list.')
            fprintf('%s\n', '    --table-name               : The table to list statistics for. `--schema-name` must also be')
            fprintf('%s\n', '                                 specified.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az dla catalog table-stats list"')
