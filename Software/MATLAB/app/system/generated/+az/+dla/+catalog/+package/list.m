classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az dla catalog package list : Retrieves the list of packages from the Data Lake Analytics
            % catalog.
            % Command group 'dla' is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az dla catalog package list ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az dla catalog package list"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        Command group ''dla'' is in preview. It may be changed/removed in a future release.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --database-name [Required] : The name of the database containing the packages.')
            fprintf('%s\n', '    --schema-name   [Required] : The name of the schema containing the packages.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az dla catalog package list"')
