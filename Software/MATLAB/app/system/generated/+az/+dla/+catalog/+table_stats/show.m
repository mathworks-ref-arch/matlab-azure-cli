classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az dla catalog table-stats show : Retrieves the specified table statistics from the Data Lake
            % Analytics catalog.
            % Command group 'dla' is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az dla catalog table-stats show ';
        end
        ...
        function this = statistics_name(this, varargin)
            % The name of the table statistics.
            this.Options = [this.Options, '--statistics-name', varargin{:}];
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az dla catalog table-stats show"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        Command group ''dla'' is in preview. It may be changed/removed in a future release.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --database-name   [Required] : The name of the database containing the statistics.')
            fprintf('%s\n', '    --schema-name     [Required] : The name of the schema containing the statistics.')
            fprintf('%s\n', '    --statistics-name [Required] : The name of the table statistics.')
            fprintf('%s\n', '    --table-name      [Required] : The name of the table containing the statistics.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az dla catalog table-stats show"')
