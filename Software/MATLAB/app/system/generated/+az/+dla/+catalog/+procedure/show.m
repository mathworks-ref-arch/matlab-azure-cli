classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az dla catalog procedure show : Retrieves the specified procedure from the Data Lake Analytics
            % catalog.
            % Command group 'dla' is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az dla catalog procedure show ';
        end
        ...
        function this = procedure_name(this, varargin)
            % The name of the procedure.
            this.Options = [this.Options, '--procedure-name', varargin{:}];
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az dla catalog procedure show"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        Command group ''dla'' is in preview. It may be changed/removed in a future release.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --database-name  [Required] : The name of the database containing the procedure.')
            fprintf('%s\n', '    --procedure-name [Required] : The name of the procedure.')
            fprintf('%s\n', '    --schema-name    [Required] : The name of the schema containing the procedure.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az dla catalog procedure show"')
