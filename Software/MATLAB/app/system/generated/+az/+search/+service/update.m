classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az search service update : Update partition and replica of the given search service.
            % Command group 'search' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az search service update ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az search service update"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        release.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --name -n           [Required] : The name of the search service.')
            fprintf('%s\n', '    --resource-group -g [Required] : Name of resource group. You can configure the default group')
            fprintf('%s\n', '                                     using `az configure --defaults group=<name>`.')
            fprintf('%s\n', '    --partition-count              : Number of partitions in the search service.')
            fprintf('%s\n', '    --replica-count                : Number of replicas in the search service.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az search service update"')
