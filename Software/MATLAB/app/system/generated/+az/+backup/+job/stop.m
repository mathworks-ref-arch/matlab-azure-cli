classdef stop < azure.AzureBase
    ...
    methods
        function this = stop()
            % az backup job stop : Suspend or terminate a currently running job.
            % Command group 'backup' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az backup job stop ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az backup job stop"')
