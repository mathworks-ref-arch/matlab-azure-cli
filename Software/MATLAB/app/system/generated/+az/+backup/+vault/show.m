classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az backup vault show : Show details of a particular Recovery service vault.
            % Command group 'backup' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az backup vault show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az backup vault show"')
