classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az backup vault delete : Delete an existing Recovery services vault.
            % Command group 'backup' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az backup vault delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az backup vault delete"')
