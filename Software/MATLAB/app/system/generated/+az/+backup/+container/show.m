classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az backup container show : Show details of a container registered to a Recovery services vault.
            % Command group 'backup' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az backup container show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        release.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --name -n     [Required] : Name of the container. You can use the backup container list command')
            fprintf('%s\n', '                               to get the name of a container.')
            ...
            fprintf('%s\n', '        az backup container show --name MyContainer --resource-group MyResourceGroup --vault-name')
            fprintf('%s\n', '        MyVault')
            fprintf('%s\n', 'For more specific examples, use: az find "az backup container show"')
