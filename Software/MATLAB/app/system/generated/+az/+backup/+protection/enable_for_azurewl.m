classdef enable_for_azurewl < azure.AzureBase

    % Copyright 2020, The MathWorks Inc.

    methods
        function this = enable_for_azurewl()
            % az backup protection enable-for-azurewl : Start protecting a previously unprotected workload
            % within an Azure VM as per the specified policy to a Recovery services vault. Provide the
            % workload details as a protectable item.
            % Command group 'backup' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az backup protection enable-for-azurewl ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '                                         logs.')
            fprintf('%s\n', 'Examples')
            fprintf('%s\n', '    Start protecting a previously unprotected workload within an Azure VM as per the specified')
            fprintf('%s\n', '    policy to a Recovery services vault. Provide the workload details as a protectable item.')
            fprintf('%s\n', '        az backup protection enable-for-azurewl --policy-name MyPolicy --resource-group')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az backup protection enable-for-azurewl"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class enable_for_azurewl 
