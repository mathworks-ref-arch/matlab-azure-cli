classdef disable < azure.AzureBase
    ...
    methods
        function this = disable()
            % az backup protection disable : Stop protecting a backed up item. Can retain the backed up data
            % forever or choose to delete it.
            % Command group 'backup' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az backup protection disable ';
        end
        ...
        function this = delete_backup_data(this, varargin)
            % Option to delete existing backed up data in the Recovery services vault.  Allowed values: false, true.
            this.Options = [this.Options, '--delete-backup-data', varargin{:}];
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --delete-backup-data           : Option to delete existing backed up data in the Recovery')
            fprintf('%s\n', '                                     services vault.  Allowed values: false, true.')
            ...
            fprintf('%s\n', '    (autogenerated)')
            fprintf('%s\n', '        az backup protection disable --container-name MyContainer --delete-backup-data false --item-')
            fprintf('%s\n', '        name MyItem --resource-group MyResourceGroup --vault-name MyVault --yes')
            fprintf('%s\n', 'For more specific examples, use: az find "az backup protection disable"')
