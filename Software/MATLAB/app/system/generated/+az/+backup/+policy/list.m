classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az backup policy list : List all policies for a Recovery services vault.
            % Command group 'backup' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az backup policy list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az backup policy list"')
