classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az backup policy show : Show details of a particular policy.
            % Command group 'backup' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az backup policy show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        MyVault')
            fprintf('%s\n', 'For more specific examples, use: az find "az backup policy show"')
