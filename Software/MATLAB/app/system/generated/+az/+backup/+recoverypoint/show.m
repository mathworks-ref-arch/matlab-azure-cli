classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az backup recoverypoint show : Shows details of a particular recovery point.
            % Command group 'backup' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az backup recoverypoint show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --name -n           [Required] : Name of the recovery point. You can use the backup recovery')
            fprintf('%s\n', '                                     point list command to get the name of a backed up item.')
            ...
            fprintf('%s\n', '        az backup recoverypoint show --container-name MyContainer --item-name MyItem --name')
            fprintf('%s\n', '        MyRecoveryPoint --resource-group MyResourceGroup --vault-name MyVault')
            fprintf('%s\n', 'For more specific examples, use: az find "az backup recoverypoint show"')
