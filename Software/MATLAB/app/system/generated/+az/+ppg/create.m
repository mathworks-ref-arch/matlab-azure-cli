classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            % az ppg create : Create a proximity placement group.
            this.BaseCmd = 'az ppg create ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '                                     clear existing tags.')
            fprintf('%s\n', '    --type -t                      : The type of the proximity placement group. Allowed values:')
            fprintf('%s\n', '                                     Standard.')
            fprintf('%s\n', 'Global Arguments')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az ppg create"')
