classdef show < azure.AzureBase
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --include-colocation-status    : Enable fetching the colocation status of all the resources in')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az ppg show"')
