classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az ppg update : Update a proximity placement group.
            this.BaseCmd = 'az ppg update ';
        end
        ...
        function this = include_colocation_status(this, varargin)
            % IncludeColocationStatus=true enables fetching the colocation status of all the resources in the proximity placement group.
            this.Options = [this.Options, '--include-colocation-status', varargin{:}];
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az ppg update"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az ppg update"')
