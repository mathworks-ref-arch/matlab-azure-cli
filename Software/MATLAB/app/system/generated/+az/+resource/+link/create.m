classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            ...
            this.BaseCmd = 'az resource link create ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --target [Required] : Fully-qualified resource ID of the resource link target.')
            ...
            fprintf('%s\n', '        az resource link create --link {SourceID} --target {ResourceID} --notes "SourceID depends on')
            fprintf('%s\n', '        ResourceID"')
            fprintf('%s\n', 'For more specific examples, use: az find "az resource link create"')
