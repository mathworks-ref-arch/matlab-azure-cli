classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            ...
            this.BaseCmd = 'az resource lock show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az resource lock show -n lockname -g MyResourceGroup --resource myvnet --resource-type')
            fprintf('%s\n', '        Microsoft.Network/virtualNetworks')
            fprintf('%s\n', 'For more specific examples, use: az find "az resource lock show"')
