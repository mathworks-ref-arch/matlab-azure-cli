classdef recover < azure.AzureBase
    ...
    methods
        function this = recover()
            ...
            this.BaseCmd = 'az keyvault recover ';
        end
        ...
        function this = resource_group(this, varargin)
            % Resource group of the deleted vault.
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --resource-group -g  : Resource group of the deleted vault.')
            fprintf('%s\n', 'Global Arguments')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az keyvault recover"')
