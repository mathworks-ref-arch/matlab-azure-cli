classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            ...
            this.BaseCmd = 'az keyvault certificate list ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az keyvault certificate list"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az keyvault certificate list"')
