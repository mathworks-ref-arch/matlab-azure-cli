classdef purge < azure.AzureBase
    ...
    methods
        function this = purge()
            ...
            % permission.
            this.BaseCmd = 'az keyvault certificate purge ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az keyvault certificate purge"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az keyvault certificate purge"')
