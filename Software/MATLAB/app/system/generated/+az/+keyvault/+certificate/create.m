classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            ...
            this.BaseCmd = 'az keyvault certificate create ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        Certificates can be used as a secrets for provisioned virtual machines.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --policy -p  [Required] : JSON encoded policy defintion. Use @{file} to load from a file(e.g.')
            fprintf('%s\n', '                              @my_policy.json).')
            ...
            fprintf('%s\n', '                              existing tags.')
            fprintf('%s\n', '    --validity              : Number of months the certificate is valid for. Overrides the value')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az keyvault certificate create"')
