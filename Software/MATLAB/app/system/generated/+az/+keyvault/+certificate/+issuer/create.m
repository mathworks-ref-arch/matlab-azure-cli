classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            ...
            this.BaseCmd = 'az keyvault certificate issuer create ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az keyvault certificate issuer create"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --provider-name [Required] : The certificate provider name. Must be registered with your tenant')
            fprintf('%s\n', '                                 ID and in your region.')
            fprintf('%s\n', '    --disabled                 : Set issuer to disabled state.  Allowed values: false, true.')
            fprintf('%s\n', 'Id Arguments')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az keyvault certificate issuer create"')
