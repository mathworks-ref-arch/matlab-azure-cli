classdef reject < azure.AzureBase
    ...
    methods
        function this = reject()
            % az keyvault private-endpoint-connection reject : Reject a private endpoint connection request
            % for a Key Vault.
            % Command group 'keyvault private-endpoint-connection' is in preview. It may be
            % changed/removed in a future release.
            this.BaseCmd = 'az keyvault private-endpoint-connection reject ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az keyvault private-endpoint-connection reject --id "/subscriptions/00000000-0000-0000-0000-')
            ...
            fprintf('%s\n', '    Reject a private endpoint connection request for a Key Vault using vault name and connection')
            fprintf('%s\n', '    name.')
            ...
            fprintf('%s\n', '        az keyvault private-endpoint-connection reject -g myrg --vault-name mystorageaccount --name')
            fprintf('%s\n', '        $name')
            fprintf('%s\n', 'For more specific examples, use: az find "az keyvault private-endpoint-connection reject"')
