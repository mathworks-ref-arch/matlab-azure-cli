classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az keyvault private-link-resource list : List the private link resources supported for a Key
            % Vault.
            % Command group 'keyvault private-link-resource' is in preview. It may be changed/removed
            % in a future release.
            this.BaseCmd = 'az keyvault private-link-resource list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az keyvault private-link-resource list"')
