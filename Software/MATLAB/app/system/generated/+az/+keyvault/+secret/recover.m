classdef recover < azure.AzureBase
    ...
    methods
        function this = recover()
            ...
            % Recovers the deleted secret in the specified vault. This operation can only be performed on
            % a soft-delete enabled vault. This operation requires the secrets/recover permission.
            this.BaseCmd = 'az keyvault secret recover ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az keyvault secret recover"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az keyvault secret recover"')
