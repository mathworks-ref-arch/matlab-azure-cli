classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            ...
            % The DELETE operation applies to any secret stored in Azure Key Vault. DELETE cannot be
            % applied to an individual version of a secret. This operation requires the secrets/delete
            % permission.
            this.BaseCmd = 'az keyvault secret delete ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az keyvault secret delete"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az keyvault secret delete"')
