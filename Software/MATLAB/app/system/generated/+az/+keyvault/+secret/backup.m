classdef backup < azure.AzureBase
    ...
    methods
        function this = backup()
            ...
            % Requests that a backup of the specified secret be downloaded to the client. All versions of
            % the secret will be downloaded. This operation requires the secrets/backup permission.
            this.BaseCmd = 'az keyvault secret backup ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az keyvault secret backup"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az keyvault secret backup"')
