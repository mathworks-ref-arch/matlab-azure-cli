classdef show_deleted < azure.AzureBase
    ...
    methods
        function this = show_deleted()
            ...
            % The Get Deleted Storage Account operation returns the specified deleted storage account
            % along with its attributes. This operation requires the storage/get permission.
            this.BaseCmd = 'az keyvault storage show-deleted ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az keyvault storage show-deleted"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az keyvault storage show-deleted"')
