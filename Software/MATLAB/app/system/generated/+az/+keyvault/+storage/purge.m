classdef purge < azure.AzureBase
    ...
    methods
        function this = purge()
            ...
            % possibility of recovery. This operation can only be performed on a soft-delete enabled
            % vault. This operation requires the storage/purge permission.
            this.BaseCmd = 'az keyvault storage purge ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az keyvault storage purge"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az keyvault storage purge"')
