classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az keyvault storage sas-definition list : List storage SAS definitions for the given storage
            % account.
            % This operation requires the storage/listsas permission.
            this.BaseCmd = 'az keyvault storage sas-definition list ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az keyvault storage sas-definition list"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az keyvault storage sas-definition list"')
