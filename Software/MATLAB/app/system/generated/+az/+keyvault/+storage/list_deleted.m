classdef list_deleted < azure.AzureBase
    ...
    methods
        function this = list_deleted()
            ...
            % The Get Deleted Storage Accounts operation returns the storage accounts that have been
            % deleted for a vault enabled for soft-delete. This operation requires the storage/list
            % permission.
            this.BaseCmd = 'az keyvault storage list-deleted ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az keyvault storage list-deleted"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az keyvault storage list-deleted"')
