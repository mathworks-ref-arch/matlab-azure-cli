classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az keyvault storage sas-definition show : Gets information about a SAS definition for the
            % specified storage account.
            % This operation requires the storage/getsas permission.
            this.BaseCmd = 'az keyvault storage sas-definition show ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az keyvault storage sas-definition show"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az keyvault storage sas-definition show"')
