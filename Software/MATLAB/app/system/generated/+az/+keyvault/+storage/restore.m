classdef restore < azure.AzureBase
    ...
    methods
        function this = restore()
            ...
            % permission.
            this.BaseCmd = 'az keyvault storage restore ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az keyvault storage restore"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        permission.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --file -f    [Required] : Local key backup from which to restore storage account.')
            fprintf('%s\n', 'Id Arguments')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az keyvault storage restore"')
