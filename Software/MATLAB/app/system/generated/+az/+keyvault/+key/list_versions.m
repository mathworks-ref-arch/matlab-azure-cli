classdef list_versions < azure.AzureBase
    ...
    methods
        function this = list_versions()
            % az keyvault key list-versions : Retrieves a list of individual key versions with the same key
            % name.
            % The full key identifier, attributes, and tags are provided in the response. This operation
            % requires the keys/list permission.
            this.BaseCmd = 'az keyvault key list-versions ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az keyvault key list-versions"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az keyvault key list-versions"')
