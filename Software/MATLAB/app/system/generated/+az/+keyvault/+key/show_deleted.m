classdef show_deleted < azure.AzureBase
    ...
    methods
        function this = show_deleted()
            ...
            % The Get Deleted Key operation is applicable for soft-delete enabled vaults. While the
            % operation can be invoked on any vault, it will return an error if invoked on a non soft-
            % delete enabled vault. This operation requires the keys/get permission. .
            this.BaseCmd = 'az keyvault key show-deleted ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az keyvault key show-deleted"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az keyvault key show-deleted"')
