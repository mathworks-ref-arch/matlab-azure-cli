classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az lab arm-template list : List azure resource manager templates in a given artifact source.
            % Command group 'lab' is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az lab arm-template list ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az lab arm-template list"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az lab arm-template list"')
