classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az lab formula show : Show formulae from an Azure DevTest Lab.
            % Command group 'lab' is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az lab formula show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'Examples')
            fprintf('%s\n', '    Show formulae from an Azure DevTest Lab. (autogenerated)')
            fprintf('%s\n', '        az lab formula show --lab-name MyLab --name MyFormula --resource-group MyResourceGroup')
            fprintf('%s\n', 'For more specific examples, use: az find "az lab formula show"')
