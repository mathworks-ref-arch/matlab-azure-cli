classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az lab environment show : Get the details for an environment of a lab.
            % Command group 'lab' is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az lab environment show ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az lab environment show"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --name -n           [Required] : The name of the environment.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az lab environment show"')
