classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az lab environment list : List environments in a lab.
            % Command group 'lab' is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az lab environment list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'Examples')
            fprintf('%s\n', '    List environments in a lab. (autogenerated)')
            fprintf('%s\n', '        az lab environment list --lab-name MyLab --resource-group MyResourceGroup')
            fprintf('%s\n', 'For more specific examples, use: az find "az lab environment list"')
