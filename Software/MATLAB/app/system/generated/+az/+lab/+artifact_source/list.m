classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az lab artifact-source list : List artifact sources in a given lab.
            % Command group 'lab' is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az lab artifact-source list ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az lab artifact-source list"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az lab artifact-source list"')
