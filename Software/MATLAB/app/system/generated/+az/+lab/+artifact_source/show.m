classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az lab artifact-source show : Get artifact source.
            % Command group 'lab' is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az lab artifact-source show ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az lab artifact-source show"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --name              [Required] : The name of the artifact source.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az lab artifact-source show"')
