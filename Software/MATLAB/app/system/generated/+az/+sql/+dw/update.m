classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az sql dw update : Update a data warehouse.
            this.BaseCmd = 'az sql dw update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    az sql dw update : Update a data warehouse.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --max-size          : The max storage size. If no unit is specified, defaults to bytes (B).')
            fprintf('%s\n', '    --no-wait           : Do not wait for the long-running operation to finish.')
            fprintf('%s\n', '    --service-objective : The service objective of the data warehouse. For example: DW100, DW1000c.')
            ...
            fprintf('%s\n', '    --name -n           : Name of the data warehouse.')
            ...
            fprintf('%s\n', '        az sql dw update --name MyDataWarehouse --resource-group MyResourceGroup --server myserver')
            fprintf('%s\n', '        --service-objective S1')
            fprintf('%s\n', 'For more specific examples, use: az find "az sql dw update"')
