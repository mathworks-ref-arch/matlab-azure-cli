classdef cancel < azure.AzureBase
    ...
    methods
        function this = cancel()
            % az sql mi op cancel : Cancels the asynchronous operation on the managed instance.
            this.BaseCmd = 'az sql mi op cancel ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'Examples')
            fprintf('%s\n', '    Cancel an operation.')
            fprintf('%s\n', '        az sql mi op cancel -g mygroup --mi myManagedInstance -n')
            fprintf('%s\n', '        d2896mydb-2ba8-4c84-bac1-387c430cce40')
            fprintf('%s\n', 'For more specific examples, use: az find "az sql mi op cancel"')
