classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            % az sql mi key create : Creates a SQL Instance key.
            this.BaseCmd = 'az sql mi key create ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az sql mi key create"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '                                         example key identifier is "https://YourVaultName.vault.azur')
            fprintf('%s\n', '                                         e.net/keys/YourKeyName/01234567890123456789012345678901".')
            ...
            fprintf('%s\n', '                                         logs.')
            fprintf('%s\n', 'For more specific examples, use: az find "az sql mi key create"')
