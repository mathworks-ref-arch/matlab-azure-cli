classdef failover < azure.AzureBase
    ...
    methods
        function this = failover()
            % az sql mi failover : Failover a managed instance.
            this.BaseCmd = 'az sql mi failover ';
        end
        ...
        function this = replica_type(this, varargin)
            % The type of replica to be failed over.
            this.Options = [this.Options, '--replica-type', varargin{:}];
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --replica-type      : The type of replica to be failed over.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az sql mi failover"')
