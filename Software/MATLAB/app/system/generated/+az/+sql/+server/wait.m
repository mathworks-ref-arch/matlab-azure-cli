classdef wait < azure.AzureBase
    ...
    methods
        function this = wait()
            % az sql server wait : Place the CLI in a waiting state until a condition of the SQL server is
            % met.
            this.BaseCmd = 'az sql server wait ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az sql server wait"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az sql server wait"')
