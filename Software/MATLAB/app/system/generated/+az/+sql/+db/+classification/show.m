classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az sql db classification show : Get the sensitivity classification of a given column.
            this.BaseCmd = 'az sql db classification show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az sql db classification show -g mygroup -s myserver -n mydb --schema dbo --table mytable')
            fprintf('%s\n', '        --column mycolumn')
            fprintf('%s\n', 'For more specific examples, use: az find "az sql db classification show"')
