classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az sql db classification list : Get the sensitivity classifications of a given database.
            this.BaseCmd = 'az sql db classification list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az sql db classification list"')
