classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az sql db classification update : Update a columns's sensitivity classification.
            this.BaseCmd = 'az sql db classification update ';
        end
        ...
        function this = information_type(this, varargin)
            % The information type.
            this.Options = [this.Options, '--information-type', varargin{:}];
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --information-type  : The information type.')
            ...
            fprintf('%s\n', '        az sql db classification update -g mygroup -s myserver -n mydb --schema dbo --table mytable')
            fprintf('%s\n', '        --column mycolumn --information-type Name --label "Confidential - GDPR"')
            fprintf('%s\n', 'For more specific examples, use: az find "az sql db classification update"')
