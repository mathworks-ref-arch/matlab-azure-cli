classdef list_links < azure.AzureBase

    % Copyright 2020, The MathWorks Inc.

    methods
        function this = list_links()
            % az sql db replica list-links : List the replicas of a database and their replication status.
            this.BaseCmd = 'az sql db replica list-links ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az sql db replica list-links --name MyAzureSQLDatabase --resource-group MyResourceGroup')
            fprintf('%s\n', '        --server myserver')
            fprintf('%s\n', 'For more specific examples, use: az find "az sql db replica list-links"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class list_links 
