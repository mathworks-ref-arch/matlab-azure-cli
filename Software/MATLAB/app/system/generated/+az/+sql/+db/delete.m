classdef delete < azure.AzureBase
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az sql db delete --name MyAzureSQLDatabase --resource-group MyResourceGroup --server')
            fprintf('%s\n', '        myserver')
            fprintf('%s\n', 'For more specific examples, use: az find "az sql db delete"')
