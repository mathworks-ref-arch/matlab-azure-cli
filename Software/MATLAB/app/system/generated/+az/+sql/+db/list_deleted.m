classdef list_deleted < azure.AzureBase
    ...
    methods
        function this = list_deleted()
            ...
            this.BaseCmd = 'az sql db list-deleted ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az sql db list-deleted"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az sql db list-deleted"')
