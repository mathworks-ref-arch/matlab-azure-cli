classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az sql db classification delete : Delete the sensitivity classification of a given column.
            this.BaseCmd = 'az sql db classification delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az sql db classification delete -g mygroup -s myserver -n mydb --schema dbo --table mytable')
            fprintf('%s\n', '        --column mycolumn')
            fprintf('%s\n', 'For more specific examples, use: az find "az sql db classification delete"')
