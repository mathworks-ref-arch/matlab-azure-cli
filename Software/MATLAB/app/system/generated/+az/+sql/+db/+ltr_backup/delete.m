classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az sql db ltr-backup delete : Delete a long term retention backup.
            % Command group 'sql db ltr-backup' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az sql db ltr-backup delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az sql db ltr-backup delete -l southeastasia -s myserver -d mydb -n "3214b3fb-')
            fprintf('%s\n', '        fba9-43e7-96a3-09e35ffcb336;132292152080000000"')
            fprintf('%s\n', 'For more specific examples, use: az find "az sql db ltr-backup delete"')
