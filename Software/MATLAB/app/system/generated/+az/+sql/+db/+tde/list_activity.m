classdef list_activity < azure.AzureBase

    % Copyright 2020, The MathWorks Inc.

    methods
        function this = list_activity()
            % az sql db tde list-activity : Returns a database's transparent data encryption operation result.
            this.BaseCmd = 'az sql db tde list-activity ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az sql db tde list-activity"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az sql db tde list-activity"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class list_activity 
