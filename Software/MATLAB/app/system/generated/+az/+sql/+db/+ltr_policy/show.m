classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az sql db ltr-policy show : Show the long term retention policy for a database.
            % Command group 'sql db ltr-policy' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az sql db ltr-policy show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az sql db ltr-policy show"')
