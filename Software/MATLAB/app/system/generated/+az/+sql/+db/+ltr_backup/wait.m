classdef wait < azure.AzureBase
    ...
    methods
        function this = wait()
            % az sql db ltr-backup wait : Place the CLI in a waiting state until a condition of the database
            % is met.
            % Command group 'sql db ltr-backup' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az sql db ltr-backup wait ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az sql db ltr-backup wait"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az sql db ltr-backup wait"')
