classdef list < azure.AzureBase
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    az sql db list : List databases a server or elastic pool.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --elastic-pool      : If specified, lists only the databases in this elastic pool.')
            ...
            fprintf('%s\n', 'Examples')
            fprintf('%s\n', '    List databases a server or elastic pool. (autogenerated)')
            fprintf('%s\n', '        az sql db list --resource-group MyResourceGroup --server myserver')
            fprintf('%s\n', 'For more specific examples, use: az find "az sql db list"')
