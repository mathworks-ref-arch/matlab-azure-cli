classdef list_deleted < azure.AzureBase
    ...
    methods
        function this = list_deleted()
            % az sql midb list-deleted : List restorable deleted managed databases.
            this.BaseCmd = 'az sql midb list-deleted ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az sql midb list-deleted"')
