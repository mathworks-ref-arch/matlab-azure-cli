classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az sql instance-pool show : Get the details for an instance pool.
            % Command group 'sql instance-pool' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az sql instance-pool show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az sql instance-pool show"')
