classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az sql instance-pool delete : Delete an instance pool.
            % Command group 'sql instance-pool' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az sql instance-pool delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az sql instance-pool delete"')
