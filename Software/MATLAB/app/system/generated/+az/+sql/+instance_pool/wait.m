classdef wait < azure.AzureBase
    ...
    methods
        function this = wait()
            % az sql instance-pool wait : Wait for an instance pool to reach a desired state.
            % Command group 'sql instance-pool' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az sql instance-pool wait ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az sql instance-pool wait"')
