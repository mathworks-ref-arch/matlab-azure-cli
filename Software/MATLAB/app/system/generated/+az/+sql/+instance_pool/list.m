classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az sql instance-pool list : List available instance pools.
            % Command group 'sql instance-pool' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az sql instance-pool list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az sql instance-pool list"')
