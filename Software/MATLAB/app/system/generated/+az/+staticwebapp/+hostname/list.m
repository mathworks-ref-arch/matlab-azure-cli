classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az staticwebapp hostname list : List custom hostnames of the static app.
            % Command group 'staticwebapp hostname' is in preview. It may be changed/removed in a
            % future release.
            this.BaseCmd = 'az staticwebapp hostname list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az staticwebapp hostname list"')
