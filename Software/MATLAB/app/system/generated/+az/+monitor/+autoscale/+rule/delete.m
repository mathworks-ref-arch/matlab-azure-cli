classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            ...
            this.BaseCmd = 'az monitor autoscale rule delete ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az monitor autoscale rule delete"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --index             [Required] : Space-separated list of rule indices to remove, or ''*'' to clear')
            fprintf('%s\n', '                                     all rules.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az monitor autoscale rule delete"')
