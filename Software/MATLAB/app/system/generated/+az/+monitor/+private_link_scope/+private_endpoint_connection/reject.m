classdef reject < azure.AzureBase
    ...
    methods
        function this = reject()
            % az monitor private-link-scope private-endpoint-connection reject : Reject a private endpoint
            ...
            this.BaseCmd = 'az monitor private-link-scope private-endpoint-connection reject ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az monitor private-link-scope private-endpoint-connection reject --name')
