classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az monitor private-link-scope private-endpoint-connection delete : Delete a private endpoint
            ...
            this.BaseCmd = 'az monitor private-link-scope private-endpoint-connection delete ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az monitor private-link-scope private-endpoint- connection delete"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --name -n           : The name of the private endpoint connection associated with the private')
            fprintf('%s\n', '                          link scope.')
