classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az monitor private-link-scope private-endpoint-connection list : List all private endpoint
            % connections of a private link scope resource.
            ...
            this.BaseCmd = 'az monitor private-link-scope private-endpoint-connection list ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az monitor private-link-scope private-endpoint- connection list"
