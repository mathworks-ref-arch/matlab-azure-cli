classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az monitor private-link-scope scoped-resource show : Show a scoped resource of a private link
            % scope resource.
            % Command group 'monitor private-link-scope scoped-resource' is in preview. It may be
            % changed/removed in a future release.
            this.BaseCmd = 'az monitor private-link-scope scoped-resource show ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az monitor private-link-scope scoped-resource show"
