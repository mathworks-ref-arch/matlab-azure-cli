classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            % az monitor log-analytics workspace linked-storage create : Create some linked storage accounts
            % for log analytics workspace.
            this.BaseCmd = 'az monitor log-analytics workspace linked-storage create ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --storage-accounts             : List of Name or ID of Azure Storage Account.')
            fprintf('%s\n', 'Global Arguments')
            ...
            fprintf('%s\n', 'Examples')
            fprintf('%s\n', '    Create two linked storage accounts for a log analytics workspace')
            fprintf('%s\n', '        az monitor log-analytics workspace linked-storage create --type AzureWatson -g')
