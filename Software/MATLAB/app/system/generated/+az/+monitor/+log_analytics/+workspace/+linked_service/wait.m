classdef wait < azure.AzureBase
    ...
    methods
        function this = wait()
            % az monitor log-analytics workspace linked-service wait : Place the CLI in a waiting state until
            % a condition of the linked service is met.
            this.BaseCmd = 'az monitor log-analytics workspace linked-service wait ';
        end
        ...
        function this = workspace_name(this, varargin)
            % Name of the Log Analytics Workspace. Wait Condition Arguments
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az monitor log-analytics workspace linked-service wait -n cluster -g MyResourceGroup')
            fprintf('%s\n', '        --workspace-name MyWorkspace --created')
