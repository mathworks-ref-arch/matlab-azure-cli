classdef wait < azure.AzureBase
    ...
    methods
        function this = wait()
            % az monitor log-analytics cluster wait : Place the CLI in a waiting state until a condition of
            % the cluster is met.
            this.BaseCmd = 'az monitor log-analytics cluster wait ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az monitor log-analytics cluster wait"')
