classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            ...
            this.BaseCmd = 'az monitor log-analytics workspace linked-service delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az monitor log-analytics workspace linked-service delete -g MyResourceGroup -n cluster')
