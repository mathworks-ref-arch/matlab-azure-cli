classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az monitor log-analytics workspace linked-storage show : List all linked storage accounts with
            % specific data source type for a log analytics workspace.
            this.BaseCmd = 'az monitor log-analytics workspace linked-storage show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az monitor log-analytics workspace linked-storage show --type AzureWatson -g MyResourceGroup')
