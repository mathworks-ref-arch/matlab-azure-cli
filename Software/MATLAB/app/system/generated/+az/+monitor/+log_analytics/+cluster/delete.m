classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az monitor log-analytics cluster delete : Delete a cluster instance.
            this.BaseCmd = 'az monitor log-analytics cluster delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az monitor log-analytics cluster delete"')
