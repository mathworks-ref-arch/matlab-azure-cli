classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az monitor log-analytics workspace linked-service show : Show the properties of a linked
            % service.
            this.BaseCmd = 'az monitor log-analytics workspace linked-service show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az monitor log-analytics workspace linked-service show -g MyResourceGroup -n cluster')
