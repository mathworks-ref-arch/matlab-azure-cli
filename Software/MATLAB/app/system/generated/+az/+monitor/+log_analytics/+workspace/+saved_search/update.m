classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az monitor log-analytics workspace saved-search update : Update a saved search for a given
            % workspace.
            this.BaseCmd = 'az monitor log-analytics workspace saved-search update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --category                     : The category of the saved search. This helps the user to find a')
            fprintf('%s\n', '                                     saved search faster.')
            fprintf('%s\n', '    --display-name                 : Display name of the saved search.')
            ...
            fprintf('%s\n', '    --saved-query -q               : The query expression for the saved search.')
            ...
            fprintf('%s\n', '        az monitor log-analytics workspace saved-search update -g MyRG --workspace-name MyWS -n')
