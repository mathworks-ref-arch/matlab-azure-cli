classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az monitor log-analytics workspace data-export delete : Delete a data export rule for a given
            % workspace.
            this.BaseCmd = 'az monitor log-analytics workspace data-export delete ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az monitor log-analytics workspace data-export delete"
