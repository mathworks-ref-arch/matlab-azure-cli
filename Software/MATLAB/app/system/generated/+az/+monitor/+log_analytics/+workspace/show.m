classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            ...
            this.BaseCmd = 'az monitor log-analytics workspace show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az monitor log-analytics workspace show --resource-group MyResourceGroup --workspace-name')
            fprintf('%s\n', '        MyWorkspace')
            fprintf('%s\n', 'For more specific examples, use: az find "az monitor log-analytics workspace show"')
