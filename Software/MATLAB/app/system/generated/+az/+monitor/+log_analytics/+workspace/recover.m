classdef recover < azure.AzureBase
    ...
    methods
        function this = recover()
            % az monitor log-analytics workspace recover : Recover a workspace in a soft-delete state within
            % 14 days.
            this.BaseCmd = 'az monitor log-analytics workspace recover ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az monitor log-analytics workspace recover"')
