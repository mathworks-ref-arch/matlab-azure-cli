classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            ...
            this.BaseCmd = 'az monitor log-analytics workspace table show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az monitor log-analytics workspace table show --resource-group MyResourceGroup --workspace-')
            fprintf('%s\n', '        name MyWorkspace -n MyTable')
            fprintf('%s\n', 'For more specific examples, use: az find "az monitor log-analytics workspace table show"')
