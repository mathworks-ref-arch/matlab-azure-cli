classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az monitor log-analytics workspace linked-service list : Gets all the linked services in a
            % workspace.
            this.BaseCmd = 'az monitor log-analytics workspace linked-service list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az monitor log-analytics workspace linked-service list -g MyResourceGroup --workspace-name')
            fprintf('%s\n', '        MyWorkspace')
