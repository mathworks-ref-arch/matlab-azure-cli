classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az monitor log-analytics workspace linked-storage list : List all linked storage accounts for a
            % log analytics workspace.
            this.BaseCmd = 'az monitor log-analytics workspace linked-storage list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az monitor log-analytics workspace linked-storage list -g MyResourceGroup --workspace-name')
            fprintf('%s\n', '        MyWorkspace')
