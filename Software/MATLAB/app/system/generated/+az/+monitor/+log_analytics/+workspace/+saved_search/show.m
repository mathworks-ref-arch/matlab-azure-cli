classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az monitor log-analytics workspace saved-search show : Show a saved search for a given
            % workspace.
            this.BaseCmd = 'az monitor log-analytics workspace saved-search show ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az monitor log-analytics workspace saved-search show"
