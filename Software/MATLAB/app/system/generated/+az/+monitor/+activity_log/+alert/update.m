classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            ...
            this.BaseCmd = 'az monitor activity-log alert update ';
        end
        function this = condition(this, varargin)
            % The conditional expression that will cause the alert to activate. The format is FIELD=VALUE[ and FIELD=VALUE...]. The possible values for the field are 'resourceId', 'category', 'caller', 'level', 'operationName', 'resourceGroup', 'resourceProvider', 'status', 'subStatus', 'resourceType', or anything beginning with 'properties.'.
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    az monitor activity-log alert update : Update the details of this activity log alert.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --condition -c      : The conditional expression that will cause the alert to activate. The')
            fprintf('%s\n', '                          format is FIELD=VALUE[ and FIELD=VALUE...].')
            ...
            fprintf('%s\n', '    --name -n           : The name of the activity log alert.')
            ...
            fprintf('%s\n', '        az monitor activity-log alert update --enabled true --name MyActivityLogAlerts --resource-')
            fprintf('%s\n', '        group MyResourceGroup --subscription MySubscription')
            fprintf('%s\n', 'For more specific examples, use: az find "az monitor activity-log alert update"')
