classdef remove < azure.AzureBase
    ...
    methods
        function this = remove()
            % az monitor activity-log alert action-group remove : Remove action groups from this activity log
            % alert.
            this.BaseCmd = 'az monitor activity-log alert action-group remove ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az monitor activity-log alert action-group remove"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az monitor activity-log alert action-group remove"')
