classdef list_definitions < azure.AzureBase

    % Copyright 2020, The MathWorks Inc.

    methods
        function this = list_definitions()
            % az monitor metrics list-definitions : Lists the metric definitions for the resource.
            this.BaseCmd = 'az monitor metrics list-definitions ';
        end
        function this = namespace(this, varargin)
            % Namespace to query metric definitions for. Target Resource Arguments
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az monitor metrics list-definitions --resource /subscriptions/{subscriptionID}/resourceGroup')
            fprintf('%s\n', '        s/Space1999/providers/Microsoft.Network/networkSecurityGroups/ADDS-NSG')
            fprintf('%s\n', 'For more specific examples, use: az find "az monitor metrics list-definitions"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class list_definitions 
