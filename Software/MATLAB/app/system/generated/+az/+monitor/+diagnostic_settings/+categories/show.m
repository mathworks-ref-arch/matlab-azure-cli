classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az monitor diagnostic-settings categories show : Gets the diagnostic settings category for the
            % specified resource.
            this.BaseCmd = 'az monitor diagnostic-settings categories show ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az monitor diagnostic-settings categories show"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az monitor diagnostic-settings categories show"')
