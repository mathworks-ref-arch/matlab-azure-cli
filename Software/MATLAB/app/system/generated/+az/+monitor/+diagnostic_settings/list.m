classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az monitor diagnostic-settings list : Gets the active diagnostic settings list for the specified
            % resource.
            this.BaseCmd = 'az monitor diagnostic-settings list ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az monitor diagnostic-settings list"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az monitor diagnostic-settings list"')
