classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az monitor diagnostic-settings categories list : List the diagnostic settings categories for the
            % specified resource.
            this.BaseCmd = 'az monitor diagnostic-settings categories list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az monitor diagnostic-settings categories list --resource /subscriptions/00000000-0000-0000-')
            fprintf('%s\n', '        0000-000000000000/resourcegroups/myRG/providers/microsoft.logic/workflows/myWorkflow')
            fprintf('%s\n', '    List diagnostic settings categories by using resource name')
            fprintf('%s\n', '        az monitor diagnostic-settings categories list -g myRG --resource-type')
            fprintf('%s\n', '        microsoft.logic/workflows --resource myWorkflow')
            fprintf('%s\n', 'For more specific examples, use: az find "az monitor diagnostic-settings categories list"')
