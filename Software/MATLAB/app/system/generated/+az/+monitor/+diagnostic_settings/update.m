classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            ...
            this.BaseCmd = 'az monitor diagnostic-settings update ';
        end
        ...
        function this = set(this, varargin)
            % Update an object by specifying a property path and value to set. Example: --set property1.property2=<value>. Target Resource Arguments
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'Examples')
            fprintf('%s\n', '    Update diagnostic settings. (autogenerated)')
            fprintf('%s\n', '        az monitor diagnostic-settings update --name MyDiagnosticSetting --resource myScaleSet --set')
            fprintf('%s\n', '        retentionPolicy.days=365')
            fprintf('%s\n', 'For more specific examples, use: az find "az monitor diagnostic-settings update"')
