classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az relay wcfrelay authorization-rule update : Update Authorization Rule for the given Relay
            % Service WCF Relay.
            this.BaseCmd = 'az relay wcfrelay authorization-rule update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az relay wcfrelay authorization-rule update --resource-group myresourcegroup --namespace-')
            fprintf('%s\n', '        name mynamespace --relay-name myrelay --name myauthorule --rights Send')
            fprintf('%s\n', 'For more specific examples, use: az find "az relay wcfrelay authorization-rule update"')
