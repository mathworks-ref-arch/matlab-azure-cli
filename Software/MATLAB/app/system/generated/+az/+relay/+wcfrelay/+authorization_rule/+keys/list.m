classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az relay wcfrelay authorization-rule keys list : List the keys and connection strings of
            % Authorization Rule for the given Relay Service WCF Relay.
            this.BaseCmd = 'az relay wcfrelay authorization-rule keys list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az relay wcfrelay authorization-rule keys list --resource-group myresourcegroup --namespace-')
            fprintf('%s\n', '        name mynamespace --relay-name myrelay --name myauthorule')
            fprintf('%s\n', 'For more specific examples, use: az find "az relay wcfrelay authorization-rule keys list"')
