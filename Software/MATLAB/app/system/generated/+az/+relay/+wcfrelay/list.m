classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az relay wcfrelay list : List the WCF Relay by Relay Service Namepsace.
            this.BaseCmd = 'az relay wcfrelay list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az relay wcfrelay list"')
