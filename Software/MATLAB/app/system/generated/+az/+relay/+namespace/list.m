classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az relay namespace list : List the Relay Service Namespaces.
            this.BaseCmd = 'az relay namespace list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az relay namespace list"')
