classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az relay namespace delete : Deletes the Relay Service Namespace.
            this.BaseCmd = 'az relay namespace delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az relay namespace delete"')
