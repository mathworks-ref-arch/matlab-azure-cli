classdef exists < azure.AzureBase
    ...
    methods
        function this = exists()
            % az relay namespace exists : Check for the availability of the given name for the Namespace.
            this.BaseCmd = 'az relay namespace exists ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az relay namespace exists"')
