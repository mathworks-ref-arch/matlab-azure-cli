classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az relay namespace authorization-rule update : Updates Authorization Rule for the given Relay
            % Service Namespace.
            this.BaseCmd = 'az relay namespace authorization-rule update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'Examples')
            fprintf('%s\n', '    Updates Authorization Rule ''myrule'' for the given Relay Service Namespace ''mynamespace'' in')
            fprintf('%s\n', '    resourcegroup')
            fprintf('%s\n', '        az relay namespace authorization-rule update --resource-group myresourcegroup --namespace-')
            fprintf('%s\n', '        name mynamespace --name myauthorule --rights Send')
            fprintf('%s\n', 'For more specific examples, use: az find "az relay namespace authorization-rule update"')
