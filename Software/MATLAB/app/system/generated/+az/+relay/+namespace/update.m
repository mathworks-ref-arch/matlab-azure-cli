classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az relay namespace update : Updates a Relay Service Namespace.
            this.BaseCmd = 'az relay namespace update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az relay namespace update --resource-group myresourcegroup --name mynamespace --tags')
            fprintf('%s\n', '        tag=value')
            fprintf('%s\n', 'For more specific examples, use: az find "az relay namespace update"')
