classdef renew < azure.AzureBase
    ...
    methods
        function this = renew()
            % az relay hyco authorization-rule keys renew : Regenerate keys of Authorization Rule for Relay
            % Service Hybrid Connection.
            this.BaseCmd = 'az relay hyco authorization-rule keys renew ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    Service Hybrid Connection.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --key         [Required] : Specifies Primary or Secondary key needs to be reset.  Allowed')
            fprintf('%s\n', '                               values: PrimaryKey, SecondaryKey.')
            fprintf('%s\n', '    --key-value              : Optional, if the key value provided, is set for KeyType or')
            ...
            fprintf('%s\n', '        az relay hyco authorization-rule keys renew --resource-group myresourcegroup --namespace-')
            fprintf('%s\n', '        name mynamespace --hybrid-connection-name myhyco --name myauthorule --key PrimaryKey')
            fprintf('%s\n', 'For more specific examples, use: az find "az relay hyco authorization-rule keys renew"')
