classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az relay hyco delete : Deletes the Relay Service Hybrid Connection.
            this.BaseCmd = 'az relay hyco delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az relay hyco delete --resource-group myresourcegroup --namespace-name mynamespace --name')
            fprintf('%s\n', '        myhyco')
            fprintf('%s\n', 'For more specific examples, use: az find "az relay hyco delete"')
