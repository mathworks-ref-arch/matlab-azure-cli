classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az relay hyco authorization-rule delete : Deletes the Authorization Rule of the given Relay
            % Service Hybrid Connection.
            this.BaseCmd = 'az relay hyco authorization-rule delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az relay hyco authorization-rule delete --resource-group myresourcegroup --namespace-name')
            fprintf('%s\n', '        mynamespace --hybrid-connection-name myhyco --name myauthorule')
            fprintf('%s\n', 'For more specific examples, use: az find "az relay hyco authorization-rule delete"')
