classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az relay hyco list : List the Hybrid Connection by Relay Service Namepsace.
            this.BaseCmd = 'az relay hyco list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az relay hyco list"')
