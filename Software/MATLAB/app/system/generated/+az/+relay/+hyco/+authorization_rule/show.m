classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az relay hyco authorization-rule show : Shows the details of Authorization Rule for given Relay
            % Service Hybrid Connection.
            this.BaseCmd = 'az relay hyco authorization-rule show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az relay hyco authorization-rule show --resource-group myresourcegroup --namespace-name')
            fprintf('%s\n', '        mynamespace --hybrid-connection-name myhyco --name myauthorule')
            fprintf('%s\n', 'For more specific examples, use: az find "az relay hyco authorization-rule show"')
