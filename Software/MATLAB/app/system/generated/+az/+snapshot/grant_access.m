classdef grant_access < azure.AzureBase
    ...
    methods
        function this = grant_access()
            ...
            this.BaseCmd = 'az snapshot grant-access ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az snapshot grant-access --duration-in-seconds 3600 --name MySnapshot --resource-group')
            fprintf('%s\n', '        MyResourceGroup')
            fprintf('%s\n', 'For more specific examples, use: az find "az snapshot grant-access"')
