classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            ...
            this.BaseCmd = 'az snapshot update ';
        end
        ...
        function this = sku(this, varargin)
            % Allowed values: Premium_LRS, Standard_LRS, Standard_ZRS.
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az snapshot update --name MySnapshot --resource-group MyResourceGroup --subscription')
            fprintf('%s\n', '        MySubscription')
            fprintf('%s\n', '    Update a snapshot and associate it with a disk access resource.')
            fprintf('%s\n', '        az snapshot update --name MySnapshot --resource-group MyResourceGroup --network-access-')
            fprintf('%s\n', '        policy AllowPrivate --disk-access MyDiskAccessID')
            fprintf('%s\n', 'For more specific examples, use: az find "az snapshot update"')
