classdef revoke_access < azure.AzureBase

    % Copyright 2020, The MathWorks Inc.

    methods
        function this = revoke_access()
            % az snapshot revoke-access : Revoke read access to a snapshot.
            this.BaseCmd = 'az snapshot revoke-access ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az snapshot revoke-access"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class revoke_access 
