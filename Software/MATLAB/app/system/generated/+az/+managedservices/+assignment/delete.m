classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            ...
            this.BaseCmd = 'az managedservices assignment delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az managedservices assignment delete --assignment /subscriptions/a62076fa-768a-403c-9d9d-6a9')
            fprintf('%s\n', '        919aae441/providers/Microsoft.ManagedServices/registrationAssignments/0c3e9687-b461-4615-b6e')
            fprintf('%s\n', '        4-74d54998d6e4')
            fprintf('%s\n', 'For more specific examples, use: az find "az managedservices assignment delete"')
