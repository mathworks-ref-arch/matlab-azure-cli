classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az security topology show : Shows the network topology in your subscription.
            % Command group 'security' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az security topology show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az security topology show"')
