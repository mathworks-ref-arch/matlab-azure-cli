classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az security adaptive-application-controls show : Adaptive Application Controls - Get.
            % Command group 'security' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az security adaptive-application-controls show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        release.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --group-name [Required] : Name of an application control VM/server group.')
            fprintf('%s\n', 'Global Arguments')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az security adaptive-application-controls show"')
