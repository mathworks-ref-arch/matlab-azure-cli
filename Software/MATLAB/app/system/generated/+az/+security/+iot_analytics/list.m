classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az security iot-analytics list : List all IoT security Analytics metrics.
            % Command group 'security' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az security iot-analytics list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'Examples')
            fprintf('%s\n', '    Get List of all IoT security Analytics metrics.')
            fprintf('%s\n', '        az security iot-analytics list --solution-name ''IoT-Hub1'' --resource-group ''rg1''')
            fprintf('%s\n', 'For more specific examples, use: az find "az security iot-analytics list"')
