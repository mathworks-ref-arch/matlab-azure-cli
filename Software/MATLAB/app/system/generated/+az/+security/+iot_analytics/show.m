classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az security iot-analytics show : Shows IoT Security Analytics metrics.
            % Command group 'security' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az security iot-analytics show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'Examples')
            fprintf('%s\n', '    Get an IoT Security Analytics metrics.')
            fprintf('%s\n', '        az security iot-analytics show --solution-name ''IoT-Hub1'' --resource-group ''rg1''')
            fprintf('%s\n', 'For more specific examples, use: az find "az security iot-analytics show"')
