classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az security iot-alerts list : List all yours IoT Security solution aggregated alerts.
            % Command group 'security' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az security iot-alerts list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az security iot-alerts list"')
