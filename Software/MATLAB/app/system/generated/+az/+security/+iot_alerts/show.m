classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az security iot-alerts show : Shows a single aggregated alert of yours IoT Security solution.
            % Command group 'security' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az security iot-alerts show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az security iot-alerts show --solution-name ''IoT-Hub1'' --resource-group ''rg1'' --name')
            fprintf('%s\n', '        ''IoT_CryptoMiner/2020-06-24''')
            fprintf('%s\n', 'For more specific examples, use: az find "az security iot-alerts show"')
