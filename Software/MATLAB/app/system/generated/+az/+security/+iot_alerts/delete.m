classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az security iot-alerts delete : Dismiss an aggregated IoT Security Alert.
            % Command group 'security' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az security iot-alerts delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az security iot-alerts delete --solution-name ''IoT-Hub1'' --resource-group ''rg1'' --name')
            fprintf('%s\n', '        ''IoT_CryptoMiner/2020-06-24''')
            fprintf('%s\n', 'For more specific examples, use: az find "az security iot-alerts delete"')
