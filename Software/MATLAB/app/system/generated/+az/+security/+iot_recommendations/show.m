classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az security iot-recommendations show : Shows a single aggregated recommendation of yours IoT
            % Security solution.
            % Command group 'security' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az security iot-recommendations show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az security iot-recommendations show --solution-name ''IoT-Hub1'' --resource-group ''rg1''')
            fprintf('%s\n', '        --name ''IoT_PermissiveFirewallPolicy''')
            fprintf('%s\n', 'For more specific examples, use: az find "az security iot-recommendations show"')
