classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az security iot-recommendations list : List all yours IoT Security solution aggregated
            % recommendations.
            % Command group 'security' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az security iot-recommendations list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az security iot-recommendations list"')
