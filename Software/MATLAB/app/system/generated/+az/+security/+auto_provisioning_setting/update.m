classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az security auto-provisioning-setting update : Updates your automatic provisioning settings on
            % the subscription.
            % Command group 'security' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az security auto-provisioning-setting update ';
        end
        function this = auto_provision(this, varargin)
            % Automatic provisioning toggle. possible values are "On" or "Off".
            this.Options = [this.Options, '--auto-provision', varargin{:}];
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        release.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --auto-provision [Required] : Automatic provisioning toggle. possible values are "On" or "Off".')
            ...
            fprintf('%s\n', '        az security auto-provisioning-setting update --auto-provision "Off" --name "default"')
            fprintf('%s\n', '        --subscription MySubscription')
            fprintf('%s\n', 'For more specific examples, use: az find "az security auto-provisioning-setting update"')
