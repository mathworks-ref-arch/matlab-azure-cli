classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az security contact delete : Deletes a security contact.
            % Command group 'security' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az security contact delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az security contact delete"')
