classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az security assessment-metadata show : Shows a security assessment.
            % Command group 'security' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az security assessment-metadata show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az security assessment-metadata show"')
