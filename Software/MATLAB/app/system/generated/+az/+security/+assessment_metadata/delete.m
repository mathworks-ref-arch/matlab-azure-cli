classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az security assessment-metadata delete : Deletes a security assessment type and all it's
            % assessment results.
            % Command group 'security' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az security assessment-metadata delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az security assessment-metadata delete"')
