classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az security task list : List security tasks (recommendations).
            % Command group 'security' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az security task list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az security task list"')
