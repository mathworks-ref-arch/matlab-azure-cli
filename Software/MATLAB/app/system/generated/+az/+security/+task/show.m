classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az security task show : Shows a security task (recommendation).
            % Command group 'security' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az security task show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az security task show"')
