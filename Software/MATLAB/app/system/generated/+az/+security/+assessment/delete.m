classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az security assessment delete : Deletes a security assessment.
            % Command group 'security' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az security assessment delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az security assessment delete"')
