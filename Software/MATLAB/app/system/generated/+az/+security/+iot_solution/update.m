classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az security iot-solution update : Update your IoT Security solution.
            % Command group 'security' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az security iot-solution update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az security iot-solution update --solution-name ''IoT-Hub1'' --resource-group ''rg1'' --iot-hubs')
            fprintf('%s\n', '        /subscriptions/subscriptionId/resourcegroups/rg1/providers/Microsoft.Devices/IotHubs/IoT-')
            fprintf('%s\n', '        Hub1 --display-name "Solution Default"')
            fprintf('%s\n', 'For more specific examples, use: az find "az security iot-solution update"')
