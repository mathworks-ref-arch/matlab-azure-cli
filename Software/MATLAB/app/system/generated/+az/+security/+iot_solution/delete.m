classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az security iot-solution delete : Delete your IoT Security solution.
            % Command group 'security' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az security iot-solution delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az security iot-solution delete"')
