classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az security iot-solution show : Shows a IoT Security solution.
            % Command group 'security' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az security iot-solution show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az security iot-solution show"')
