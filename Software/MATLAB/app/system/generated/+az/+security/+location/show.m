classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az security location show : Shows the Azure Security Center Home region location.
            % Command group 'security' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az security location show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az security location show"')
