classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az security alert update : Updates a security alert status.
            % Command group 'security' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az security alert update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --status      [Required] : Target status of the alert. possible values are "dismiss" and')
            fprintf('%s\n', '                               "activate".')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az security alert update"')
