classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az security sub-assessment list : List all security sub assessment results.
            % Command group 'security' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az security sub-assessment list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --assessment-name      : Name of the assessment resource.')
            fprintf('%s\n', 'Global Arguments')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az security sub-assessment list"')
