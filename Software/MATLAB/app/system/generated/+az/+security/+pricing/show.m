classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az security pricing show : Shows the Azure Security Center Pricing tier for the subscription.
            % Command group 'security' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az security pricing show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az security pricing show"')
