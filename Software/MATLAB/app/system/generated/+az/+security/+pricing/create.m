classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            % az security pricing create : Updates the Azure Security Center Pricing tier for the
            % subscription.
            % Command group 'security' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az security pricing create ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --tier    [Required] : Pricing tier type.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az security pricing create"')
