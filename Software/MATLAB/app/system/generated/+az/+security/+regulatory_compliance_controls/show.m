classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az security regulatory-compliance-controls show : Shows a regulatory compliance details state
            % for selected standard.
            % Command group 'security' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az security regulatory-compliance-controls show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az security regulatory-compliance-controls show"')
