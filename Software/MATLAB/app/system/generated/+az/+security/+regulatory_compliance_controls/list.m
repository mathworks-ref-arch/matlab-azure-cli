classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az security regulatory-compliance-controls list : List supported of regulatory compliance
            % controls details and state for selected standard.
            % Command group 'security' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az security regulatory-compliance-controls list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az security regulatory-compliance-controls list"')
