classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az security jit-policy list : List your Just in Time network access policies.
            % Command group 'security' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az security jit-policy list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az security jit-policy list"')
