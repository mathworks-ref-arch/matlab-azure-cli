classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az security jit-policy show : Shows a Just in Time network access policy.
            % Command group 'security' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az security jit-policy show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az security jit-policy show"')
