classdef show < azure.AzureBase
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az sf service show -g testRG -c testCluster --application-name testApp --service-name')
            fprintf('%s\n', '        testApp~testService')
            fprintf('%s\n', 'For more specific examples, use: az find "az sf service show"')
