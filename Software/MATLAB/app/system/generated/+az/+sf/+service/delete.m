classdef delete < azure.AzureBase
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --name --service-name [Required] : Specify the name of the service. The application name must be')
            fprintf('%s\n', '                                       a prefix of the service name, for example:')
            fprintf('%s\n', '                                       appName~serviceName.')
            ...
            fprintf('%s\n', 'Examples')
            fprintf('%s\n', '    Delete service.')
            fprintf('%s\n', '        az sf service delete -g testRG -c testCluster --application-name testApp --service-name')
            fprintf('%s\n', '        testApp~testService')
            fprintf('%s\n', 'For more specific examples, use: az find "az sf service delete"')
