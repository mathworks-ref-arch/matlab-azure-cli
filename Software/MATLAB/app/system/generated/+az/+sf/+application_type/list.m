classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az sf application-type list : List application types of a given cluster.
            % Command group 'sf' is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az sf application-type list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az sf application-type list"')
