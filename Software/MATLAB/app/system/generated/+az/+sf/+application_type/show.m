classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az sf application-type show : Show the properties of an application type on an Azure Service
            % Fabric cluster.
            % Command group 'sf' is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az sf application-type show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az sf application-type show"')
