classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az sf application-type version delete : Delete an application type version.
            % Command group 'sf' is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az sf application-type version delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az sf application-type version delete -g testRG -c testCluster --application-type-name')
            fprintf('%s\n', '        CalcServiceApp --version 1.0')
            fprintf('%s\n', 'For more specific examples, use: az find "az sf application-type version delete"')
