classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az sf application-type version list : List version of a given application type.
            % Command group 'sf' is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az sf application-type version list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az sf application-type version list -g testRG -c testCluster --application-type-name')
            fprintf('%s\n', '        CalcServiceApp')
            fprintf('%s\n', 'For more specific examples, use: az find "az sf application-type version list"')
