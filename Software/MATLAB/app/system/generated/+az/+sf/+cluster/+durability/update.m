classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az sf cluster durability update : Update the durability tier or VM SKU of a node type in the
            % cluster.
            % Command group 'sf' is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az sf cluster durability update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --durability-level  [Required] : Durability level.  Allowed values: Bronze, Gold, Silver.')
            ...
            fprintf('%s\n', '        az sf cluster durability update -g group-name -c cluster1 --durability-level Silver --node-')
            fprintf('%s\n', '        type nt1')
            fprintf('%s\n', 'For more specific examples, use: az find "az sf cluster durability update"')
