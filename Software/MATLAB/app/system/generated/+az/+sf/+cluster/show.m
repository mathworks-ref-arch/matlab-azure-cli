classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az sf cluster show : Gets a Service Fabric cluster resource.
            ...
            this.BaseCmd = 'az sf cluster show ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az sf cluster show"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az sf cluster show"')
