classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az sf application list : List applications of a given cluster.
            % Command group 'sf' is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az sf application list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az sf application list"')
