classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az appconfig credential list : List access keys of an App Configuration.
            this.BaseCmd = 'az appconfig credential list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az appconfig credential list"')
