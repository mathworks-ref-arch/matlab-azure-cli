classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az appconfig identity show : Display managed identities for an App Configuration.
            % Command group 'appconfig identity' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az appconfig identity show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az appconfig identity show"')
