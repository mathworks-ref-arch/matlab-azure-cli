classdef remove < azure.AzureBase
    ...
    methods
        function this = remove()
            % az appconfig identity remove : Remove managed identities for an App Configuration.
            % Command group 'appconfig identity' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az appconfig identity remove ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '                           ''[system]'' to refer system assigned identity, ''[all]'' for all identities')
            fprintf('%s\n', '                           or a resource id to refer user assigned identity. Remove system assigned')
            ...
            fprintf('%s\n', '        az appconfig identity remove -g MyResourceGroup -n MyAppConfiguration --identities')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az appconfig identity remove"')
