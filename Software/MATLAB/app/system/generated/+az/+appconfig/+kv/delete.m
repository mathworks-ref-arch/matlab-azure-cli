classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az appconfig kv delete : Delete key-values.
            this.BaseCmd = 'az appconfig kv delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    az appconfig kv delete : Delete key-values.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --key    [Required] : Support star sign as filters, for instance * means all key and abc* means')
            fprintf('%s\n', '                          keys with abc as prefix.')
            ...
            fprintf('%s\n', '    --label             : If no label specified, delete entry with null label. Support star sign as')
            fprintf('%s\n', '                          filters, for instance * means all label and abc* means labels with abc as')
            fprintf('%s\n', '                          prefix.')
            ...
            fprintf('%s\n', '        az appconfig kv delete --connection-string')
            fprintf('%s\n', '        Endpoint=https://contoso.azconfig.io;Id=xxx;Secret=xxx --key color --label MyLabel')
            fprintf('%s\n', 'For more specific examples, use: az find "az appconfig kv delete"')
