classdef enable < azure.AzureBase
    ...
    methods
        function this = enable()
            % az appconfig feature enable : Enable a feature flag to turn it ON for use.
            % Command group 'appconfig feature' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az appconfig feature enable ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        release.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --feature [Required] : Key of the feature to be enabled.')
            ...
            fprintf('%s\n', '    --label              : If no label specified, enable the feature flag with null label by')
            fprintf('%s\n', '                           default.')
            ...
            fprintf('%s\n', '        az appconfig feature enable --connection-string')
            fprintf('%s\n', '        Endpoint=https://contoso.azconfig.io;Id=xxx;Secret=xxx --feature color --label test --yes')
            fprintf('%s\n', 'For more specific examples, use: az find "az appconfig feature enable"')
