classdef disable < azure.AzureBase
    ...
    methods
        function this = disable()
            ...
            this.BaseCmd = 'az advisor recommendation disable ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az advisor recommendation disable"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    az advisor recommendation disable : Disable Azure Advisor recommendations.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --days -d           : Number of days to disable. If not specified, the recommendation is')
            fprintf('%s\n', '                          disabled forever.')
            fprintf('%s\n', 'Resource Id Arguments')
            fprintf('%s\n', '    --ids               : One or more resource IDs (space-delimited). If provided, no other')
            fprintf('%s\n', '                          "Resource Id" arguments should be specified.')
            fprintf('%s\n', '    --name -n           : The name of the recommendation as output by the list command.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az advisor recommendation disable"')
