classdef wait < azure.AzureBase
    ...
    methods
        function this = wait()
            % az image builder wait : Place the CLI in a waiting state until a condition of the template is
            % met.
            this.BaseCmd = 'az image builder wait ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az image builder wait"')
