classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az image builder delete : Delete image builder template.
            this.BaseCmd = 'az image builder delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az image builder delete"')
