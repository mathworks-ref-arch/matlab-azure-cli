classdef show_runs < azure.AzureBase

    % Copyright 2020, The MathWorks Inc.

    methods
        function this = show_runs()
            % az image builder show-runs : Show an image builder template's run outputs.
            this.BaseCmd = 'az image builder show-runs ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    az image builder show-runs : Show an image builder template''s run outputs.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --output-name       : Name of the image builder run output.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az image builder show-runs"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class show_runs 
