classdef cancel < azure.AzureBase
    ...
    methods
        function this = cancel()
            ...
            this.BaseCmd = 'az dms project task cancel ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az dms project task cancel"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az dms project task cancel"')
