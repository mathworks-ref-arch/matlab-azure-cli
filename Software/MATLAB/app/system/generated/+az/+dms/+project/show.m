classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            ...
            this.BaseCmd = 'az dms project show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az dms project show --name MyProject --resource-group MyResourceGroup --service-name')
            fprintf('%s\n', '        MyService')
            fprintf('%s\n', 'For more specific examples, use: az find "az dms project show"')
