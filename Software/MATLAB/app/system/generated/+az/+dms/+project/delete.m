classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            ...
            this.BaseCmd = 'az dms project delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --delete-running-tasks         : Cancel any running tasks before deleting the Project.')
            ...
            fprintf('%s\n', '        az dms project delete --name MyProject --resource-group MyResourceGroup --service-name')
            fprintf('%s\n', '        MyService')
            fprintf('%s\n', 'For more specific examples, use: az find "az dms project delete"')
