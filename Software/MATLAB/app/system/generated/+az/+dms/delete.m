classdef delete < azure.AzureBase
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --delete-running-tasks         : Cancel any running tasks before deleting the service.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az dms delete"')
