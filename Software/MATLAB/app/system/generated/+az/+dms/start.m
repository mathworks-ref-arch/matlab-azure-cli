classdef start < azure.AzureBase
    ...
    methods
        function this = start()
            % az dms start : Start an instance of the Data Migration Service. It can then be used to run data
            % migrations.
            this.BaseCmd = 'az dms start ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az dms start"')
