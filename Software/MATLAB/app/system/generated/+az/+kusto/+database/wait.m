classdef wait < azure.AzureBase
    ...
    methods
        function this = wait()
            % az kusto database wait : Wait for a managed Kusto database to reach a desired state.
            % If an operation on a database was interrupted or was started with `--no-wait`, use this
            % command to wait for it to complete.
            this.BaseCmd = 'az kusto database wait ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az kusto database wait"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az kusto database wait"')
