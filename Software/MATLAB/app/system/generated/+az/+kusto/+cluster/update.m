classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            ...
            this.BaseCmd = 'az kusto cluster update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --sku               : The name of the sku.  Allowed values: D11_v2, D12_v2, D13_v2, D14_v2, L16,')
            fprintf('%s\n', '                          L4, L8.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az kusto cluster update"')
