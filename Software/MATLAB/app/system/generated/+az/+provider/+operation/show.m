classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az provider operation show : Get an individual provider's operations.
            this.BaseCmd = 'az provider operation show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az provider operation show"')
