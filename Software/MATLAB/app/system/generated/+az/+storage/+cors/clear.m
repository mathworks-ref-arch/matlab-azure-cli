classdef clear < azure.AzureBase
    ...
    methods
        function this = clear()
            ...
            this.BaseCmd = 'az storage cors clear ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    az storage cors clear : Remove all CORS rules from a storage account.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --services [Required] : The storage service(s) to remove rules from. Allowed options are:')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage cors clear"')
