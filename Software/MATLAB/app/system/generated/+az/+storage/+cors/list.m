classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            ...
            this.BaseCmd = 'az storage cors list ';
        end
        function this = services(this, varargin)
            % The storage service(s) to list rules for. Allowed options are: (b)lob, (f)ile, (q)ueue, (t)able. Can be combined.  Default: bqft.
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    az storage cors list : List all CORS rules for a storage account.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --services          : The storage service(s) to list rules for. Allowed options are: (b)lob,')
            fprintf('%s\n', '                          (f)ile, (q)ueue, (t)able. Can be combined.  Default: bqft.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage cors list"')
