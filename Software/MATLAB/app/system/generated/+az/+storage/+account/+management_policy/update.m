classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az storage account management-policy update : Updates the data policy rules associated with the
            % specified storage account.
            this.BaseCmd = 'az storage account management-policy update ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az storage account management-policy update"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage account management-policy update"')
