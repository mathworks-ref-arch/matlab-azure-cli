classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az storage account encryption-scope show : Show properties for specified encryption scope within
            % storage account.
            % Command group 'storage account encryption-scope' is in preview. It may be
            % changed/removed in a future release.
            this.BaseCmd = 'az storage account encryption-scope show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az storage account encryption-scope show --name myencryption --account-name mystorageaccount')
            fprintf('%s\n', '        -g MyResourceGroup')
            fprintf('%s\n', 'For more specific examples, use: az find "az storage account encryption-scope show"')
