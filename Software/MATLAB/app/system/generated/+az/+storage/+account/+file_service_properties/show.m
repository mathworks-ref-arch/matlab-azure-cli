classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az storage account file-service-properties show : Show the properties of file service in storage
            % account.
            ...
            this.BaseCmd = 'az storage account file-service-properties show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage account file-service-properties show"')
