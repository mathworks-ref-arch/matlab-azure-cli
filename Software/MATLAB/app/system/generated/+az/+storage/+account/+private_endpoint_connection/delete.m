classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az storage account private-endpoint-connection delete : Delete a private endpoint connection
            ...
            this.BaseCmd = 'az storage account private-endpoint-connection delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az storage account private-endpoint-connection delete --id "/subscriptions/0000-0000-0000-00')
            fprintf('%s\n', '        00/resourceGroups/MyResourceGroup/providers/Microsoft.Storage/storageAccounts/mystorageaccou')
            fprintf('%s\n', '        nt/privateEndpointConnections/mystorageaccount.b56b5a95-0588-4f8b-b348-15db61590a6c"')
            fprintf('%s\n', '    Delete a private endpoint connection request for storage account by ID.')
            ...
            fprintf('%s\n', '    Delete a private endpoint connection request for storage account using account name and')
            fprintf('%s\n', '    connection name.')
            fprintf('%s\n', '        az storage account private-endpoint-connection delete -g myRg --account-name')
