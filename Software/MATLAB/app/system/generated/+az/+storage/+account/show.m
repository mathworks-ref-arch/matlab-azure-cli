classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            ...
            this.BaseCmd = 'az storage account show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    az storage account show : Show storage account properties.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --expand            : May be used to expand the properties within account''s properties. By')
            ...
            fprintf('%s\n', '        az storage account show --ids /subscriptions/{SubID}/resourceGroups/{ResourceGroup}/provider')
            fprintf('%s\n', '        s/Microsoft.Storage/storageAccounts/{StorageAccount}')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage account show"')
