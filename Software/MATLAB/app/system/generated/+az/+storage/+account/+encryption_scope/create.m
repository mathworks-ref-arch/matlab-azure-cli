classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            % az storage account encryption-scope create : Create an encryption scope within storage account.
            % Command group 'storage account encryption-scope' is in preview. It may be
            % changed/removed in a future release.
            this.BaseCmd = 'az storage account encryption-scope create ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '                                Microsoft.KeyVault, Microsoft.Storage.  Default: Microsoft.Storage.')
            ...
            fprintf('%s\n', '        az storage account encryption-scope create --name myencryption -s Microsoft.Storage')
            ...
            fprintf('%s\n', '        az storage account encryption-scope create --name myencryption -s Microsoft.KeyVault -u')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage account encryption-scope create"')
