classdef reject < azure.AzureBase
    ...
    methods
        function this = reject()
            % az storage account private-endpoint-connection reject : Reject a private endpoint connection
            ...
            this.BaseCmd = 'az storage account private-endpoint-connection reject ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az storage account private-endpoint-connection reject --id "/subscriptions/0000-0000-0000-00')
            ...
            fprintf('%s\n', '    Reject a private endpoint connection request for storage account using account name and')
            fprintf('%s\n', '    connection name.')
            fprintf('%s\n', '        az storage account private-endpoint-connection reject -g myRg --account-name')
