classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            ...
            this.BaseCmd = 'az storage account delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az storage account delete --ids /subscriptions/{SubID}/resourceGroups/{ResourceGroup}/provid')
            fprintf('%s\n', '        ers/Microsoft.Storage/storageAccounts/{StorageAccount}')
            fprintf('%s\n', '    Delete a storage account using an account name and resource group.')
            fprintf('%s\n', '        az storage account delete -n MyStorageAccount -g MyResourceGroup')
            fprintf('%s\n', 'For more specific examples, use: az find "az storage account delete"')
