classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az storage fs directory show : Show properties of a directory in ADLS Gen2 file system.
            this.BaseCmd = 'az storage fs directory show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az storage fs directory show -n dir -f myfilesystem --account-name myadlsaccount --account-')
            fprintf('%s\n', '        key 0000-0000')
            fprintf('%s\n', '    Show properties of a subdirectory in ADLS Gen2 file system.')
            fprintf('%s\n', '        az storage fs directory show -n dir/subdir -f myfilesystem --account-name myadlsaccount')
            fprintf('%s\n', '        --account-key 0000-0000')
            fprintf('%s\n', 'For more specific examples, use: az find "az storage fs directory show"')
