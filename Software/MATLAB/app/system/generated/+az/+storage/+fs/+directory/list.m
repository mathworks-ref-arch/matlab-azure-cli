classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az storage fs directory list : List directories in ADLS Gen2 file system.
            this.BaseCmd = 'az storage fs directory list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '                                  key, login.')
            fprintf('%s\n', '    --num-results               : Specify the maximum number of results to return.')
            ...
            fprintf('%s\n', '        az storage fs directory list -f myfilesystem --account-name myadlsaccount --account-key')
            fprintf('%s\n', '        0000-0000')
            fprintf('%s\n', '    List directories in "dir/" for ADLS Gen2 file system.')
            fprintf('%s\n', '        az storage fs directory list --path dir -f myfilesystem --account-name myadlsaccount')
            fprintf('%s\n', '        --account-key 0000-0000')
            fprintf('%s\n', 'For more specific examples, use: az find "az storage fs directory list"')
