classdef exists < azure.AzureBase
    ...
    methods
        function this = exists()
            % az storage fs directory exists : Check for the existence of a directory in ADLS Gen2 file
            % system.
            this.BaseCmd = 'az storage fs directory exists ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az storage fs directory exists -n dir -f myfilesystem --account-name myadlsaccount')
            fprintf('%s\n', '        --account-key 0000-0000')
            fprintf('%s\n', 'For more specific examples, use: az find "az storage fs directory exists"')
