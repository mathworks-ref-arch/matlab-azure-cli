classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az storage fs file show : Show properties of file in ADLS Gen2 file system.
            this.BaseCmd = 'az storage fs file show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az storage fs file show -p dir/a.txt -f fsname --account-name myadlsaccount --account-key')
            fprintf('%s\n', '        0000-0000')
            fprintf('%s\n', 'For more specific examples, use: az find "az storage fs file show"')
