classdef exists < azure.AzureBase
    ...
    methods
        function this = exists()
            % az storage fs exists : Check for the existence of a file system in ADLS Gen2 account.
            this.BaseCmd = 'az storage fs exists ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage fs exists"')
