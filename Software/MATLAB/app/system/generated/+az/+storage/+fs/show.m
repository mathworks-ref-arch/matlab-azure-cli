classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az storage fs show : Show properties of file system in ADLS Gen2 account.
            this.BaseCmd = 'az storage fs show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage fs show"')
