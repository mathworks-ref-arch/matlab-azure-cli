classdef append < azure.AzureBase
    ...
    methods
        function this = append()
            % az storage fs file append : Append content to a file in ADLS Gen2 file system.
            this.BaseCmd = 'az storage fs file append ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    az storage fs file append : Append content to a file in ADLS Gen2 file system.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --content        [Required] : Content to be appended to file.')
            ...
            fprintf('%s\n', '        az storage fs file append --content "test content test" -p dir/a.txt -f fsname --account-')
            fprintf('%s\n', '        name myadlsaccount --account-key 0000-0000')
            fprintf('%s\n', 'For more specific examples, use: az find "az storage fs file append"')
