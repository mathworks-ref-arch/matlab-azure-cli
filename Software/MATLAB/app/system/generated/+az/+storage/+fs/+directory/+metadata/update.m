classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az storage fs directory metadata update : Sets one or more user-defined name-value pairs for the
            ...
            this.BaseCmd = 'az storage fs directory metadata update ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az storage fs directory metadata update"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage fs directory metadata update"')
