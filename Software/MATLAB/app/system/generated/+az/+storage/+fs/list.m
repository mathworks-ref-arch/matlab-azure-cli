classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az storage fs list : List file systems in ADLS Gen2 account.
            this.BaseCmd = 'az storage fs list ';
        end
        ...
        function this = prefix(this, varargin)
            % Filter the results to return only file systems whose names begin with the specified prefix. Storage Account Arguments
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --include-metadata  : Specify that file system metadata be returned in the response. The default')
            fprintf('%s\n', '                          value is "False".  Allowed values: false, true.')
            fprintf('%s\n', '    --prefix            : Filter the results to return only file systems whose names begin with the')
            fprintf('%s\n', '                          specified prefix.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage fs list"')
