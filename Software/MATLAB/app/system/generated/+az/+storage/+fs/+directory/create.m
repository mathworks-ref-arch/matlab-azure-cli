classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            % az storage fs directory create : Create a directory in ADLS Gen2 file system.
            this.BaseCmd = 'az storage fs directory create ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az storage fs directory create -n dir -f myfilesystem --account-name myadlsaccount')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage fs directory create"')
