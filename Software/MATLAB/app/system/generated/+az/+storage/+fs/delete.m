classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az storage fs delete : Delete a file system in ADLS Gen2 account.
            this.BaseCmd = 'az storage fs delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage fs delete"')
