classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            % az storage fs create : Create file system for Azure Data Lake Storage Gen2 account.
            this.BaseCmd = 'az storage fs create ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '                           metadata.')
            fprintf('%s\n', '    --public-access      : Specify whether data in the file system may be accessed publicly and the')
            fprintf('%s\n', '                           level of access.  Allowed values: file, filesystem, off.')
            ...
            fprintf('%s\n', '        az storage fs create -n fsname --public-access file --account-name mystorageaccount')
            fprintf('%s\n', '        --account-key 0000-0000')
            fprintf('%s\n', 'For more specific examples, use: az find "az storage fs create"')
