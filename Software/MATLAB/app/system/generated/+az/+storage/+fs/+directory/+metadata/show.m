classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az storage fs directory metadata show : Return all user-defined metadata for the specified
            % directory.
            this.BaseCmd = 'az storage fs directory metadata show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az storage fs directory metadata show -n dir -f myfilesystem --account-name myadlsaccount')
            fprintf('%s\n', '        --account-key 0000-0000')
            fprintf('%s\n', 'For more specific examples, use: az find "az storage fs directory metadata show"')
