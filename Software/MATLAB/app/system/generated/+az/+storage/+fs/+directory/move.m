classdef move < azure.AzureBase
    ...
    methods
        function this = move()
            % az storage fs directory move : Move a directory in ADLS Gen2 file system.
            this.BaseCmd = 'az storage fs directory move ';
        end
        ...
        function this = new_directory(this, varargin)
            ...
            this.Options = [this.Options, '--new-directory', varargin{:}];
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --name -n          [Required] : The name of directory.')
            fprintf('%s\n', '    --new-directory -d [Required] : The new directory name the users want to move to. The value must')
            ...
            fprintf('%s\n', '        az storage fs directory move --new-directory newfs/dir -n dir -f myfilesystem --account-name')
            fprintf('%s\n', '        myadlsaccount --account-key 0000-0000')
            fprintf('%s\n', 'For more specific examples, use: az find "az storage fs directory move"')
