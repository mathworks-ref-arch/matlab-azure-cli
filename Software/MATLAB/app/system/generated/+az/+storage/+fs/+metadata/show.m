classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az storage fs metadata show : Return all user-defined metadata for the specified file system.
            this.BaseCmd = 'az storage fs metadata show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az storage fs metadata show -n myfilesystem --account-name myadlsaccount --account-key')
            fprintf('%s\n', '        0000-0000')
            fprintf('%s\n', 'For more specific examples, use: az find "az storage fs metadata show"')
