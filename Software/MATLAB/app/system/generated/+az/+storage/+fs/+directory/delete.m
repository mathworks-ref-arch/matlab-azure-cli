classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az storage fs directory delete : Delete a directory in ADLS Gen2 file system.
            this.BaseCmd = 'az storage fs directory delete ';
        end
        ...
        function this = yes(this, varargin)
            % Do not prompt for confirmation. Storage Account Arguments
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az storage fs directory delete -n dir -f myfilesystem --account-name myadlsaccount')
            fprintf('%s\n', '        --account-key 0000-0000')
            fprintf('%s\n', 'For more specific examples, use: az find "az storage fs directory delete"')
