classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            ...
            this.BaseCmd = 'az storage blob show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az storage blob show --account-name mystorageccount --account-key 00000000 --container-name')
            fprintf('%s\n', '        MyContainer --name MyBlob')
            fprintf('%s\n', 'For more specific examples, use: az find "az storage blob show"')
