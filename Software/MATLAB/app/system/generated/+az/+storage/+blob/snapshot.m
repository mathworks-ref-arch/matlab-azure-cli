classdef snapshot < azure.AzureBase
    ...
    methods
        function this = snapshot()
            ...
            this.BaseCmd = 'az storage blob snapshot ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az storage blob snapshot"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage blob snapshot"')
