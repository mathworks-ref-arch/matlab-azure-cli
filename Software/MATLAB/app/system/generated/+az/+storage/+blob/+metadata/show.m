classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az storage blob metadata show : Returns all user-defined metadata for the specified blob or
            % snapshot.
            this.BaseCmd = 'az storage blob metadata show ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az storage blob metadata show"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --snapshot                     : The snapshot parameter is an opaque value that, when present,')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage blob metadata show"')
