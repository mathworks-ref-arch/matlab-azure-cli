classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az storage blob service-properties show : Gets the properties of a storage account's Blob
            % service, including Azure Storage Analytics.
            this.BaseCmd = 'az storage blob service-properties show ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az storage blob service-properties show"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage blob service-properties show"')
