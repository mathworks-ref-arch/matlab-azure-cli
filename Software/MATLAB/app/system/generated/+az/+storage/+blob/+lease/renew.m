classdef renew < azure.AzureBase
    ...
    methods
        function this = renew()
            % az storage blob lease renew : Renew the lease.
            this.BaseCmd = 'az storage blob lease renew ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'Examples')
            fprintf('%s\n', '    Renew the lease.')
            fprintf('%s\n', '        az storage blob lease renew -b myblob -c mycontainer --lease-id')
            fprintf('%s\n', '        "32fe23cd-4779-4919-adb3-357e76c9b1bb" --account-name mystorageaccount --account-key')
            fprintf('%s\n', '        0000-0000')
            fprintf('%s\n', 'For more specific examples, use: az find "az storage blob lease renew"')
