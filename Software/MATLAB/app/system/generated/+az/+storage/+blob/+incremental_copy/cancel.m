classdef cancel < azure.AzureBase
    ...
    methods
        function this = cancel()
            % az storage blob incremental-copy cancel : Aborts a pending copy_blob operation, and leaves a
            % destination blob with zero length and full metadata.
            this.BaseCmd = 'az storage blob incremental-copy cancel ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az storage blob incremental-copy cancel"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '                                     key, login.')
            fprintf('%s\n', '    --lease-id                     : Required if the destination blob has an active infinite lease.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage blob incremental-copy cancel"')
