classdef break_ < azure.AzureBase

    % Copyright 2020, The MathWorks Inc.

    methods
        function this = break_()
            % az storage blob lease break : Break the lease, if the container or blob has an active lease.
            ...
            % and release can be performed on the container or blob. When a lease is successfully broken,
            % the response indicates the interval in seconds until a new lease can be acquired.
            this.BaseCmd = 'az storage blob lease break ';
        end
        ...
        function this = lease_break_period(this, varargin)
            ...
            this.Options = [this.Options, '--lease-break-period', varargin{:}];
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az storage blob lease break"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '                                     key, login.')
            fprintf('%s\n', '    --lease-break-period           : This is the proposed duration of seconds that the lease should')
            fprintf('%s\n', '                                     continue before it is broken, between 0 and 60 seconds. This')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage blob lease break"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class break_ 
