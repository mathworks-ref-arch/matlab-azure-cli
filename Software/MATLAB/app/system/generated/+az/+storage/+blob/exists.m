classdef exists < azure.AzureBase
    ...
    methods
        function this = exists()
            ...
            this.BaseCmd = 'az storage blob exists ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '                                     present, specifies the snapshot.')
            ...
            fprintf('%s\n', '        az storage blob exists --account-key 00000000 --account-name MyAccount --container-name')
            fprintf('%s\n', '        MyContainer --name MyBlob')
            fprintf('%s\n', 'For more specific examples, use: az find "az storage blob exists"')
