classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az storage blob metadata update : Sets user-defined metadata for the specified blob as one or
            % more name-value pairs.
            this.BaseCmd = 'az storage blob metadata update ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az storage blob metadata update"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage blob metadata update"')
