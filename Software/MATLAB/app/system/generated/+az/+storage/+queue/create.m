classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            ...
            this.BaseCmd = 'az storage queue create ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az storage queue create"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --fail-on-exist      : Specifies whether to throw an exception if the queue already exists.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage queue create"')
