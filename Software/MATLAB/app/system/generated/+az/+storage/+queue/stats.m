classdef stats < azure.AzureBase
    ...
    methods
        function this = stats()
            ...
            this.BaseCmd = 'az storage queue stats ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az storage queue stats"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage queue stats"')
