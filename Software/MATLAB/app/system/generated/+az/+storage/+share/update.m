classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            ...
            this.BaseCmd = 'az storage share update ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az storage share update"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --quota   [Required] : Specifies the maximum size of the share, in gigabytes. Must be greater')
            fprintf('%s\n', '                           than 0, and less than or equal to 5 TB (5120 GB).')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage share update"')
