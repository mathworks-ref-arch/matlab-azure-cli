classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            ...
            this.BaseCmd = 'az storage share list ';
        end
        ...
        function this = include_snapshots(this, varargin)
            % Specifies that share snapshots be returned in the response.
            this.Options = [this.Options, '--include-snapshots', varargin{:}];
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az storage share list"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    az storage share list : List the file shares in a storage account.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --include-metadata  : Specifies that share metadata be returned in the response.')
            fprintf('%s\n', '    --include-snapshots : Specifies that share snapshots be returned in the response.')
            ...
            fprintf('%s\n', '    --num-results       : Specifies the maximum number of results to return. Provide "*" to return')
            fprintf('%s\n', '                          all.  Default: 5000.')
            fprintf('%s\n', '    --prefix            : Filters the results to return only shares whose names begin with the')
            fprintf('%s\n', '                          specified prefix.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage share list"')
