classdef stats < azure.AzureBase
    ...
    methods
        function this = stats()
            % az storage share stats : Gets the approximate size of the data stored on the share, rounded up
            % to the nearest gigabyte.
            % Note that this value may not include all recently created or recently re-sized files.
            this.BaseCmd = 'az storage share stats ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az storage share stats"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage share stats"')
