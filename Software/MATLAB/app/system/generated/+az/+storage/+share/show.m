classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az storage share show : Returns all user-defined metadata and system properties for the
            % specified share.
            % The data returned does not include the shares's list of files or directories.
            this.BaseCmd = 'az storage share show ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az storage share show"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage share show"')
