classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            ...
            this.BaseCmd = 'az storage share policy update ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az storage share policy update"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --permissions              : Allowed values: (d)elete (l)ist (r)ead (w)rite. Can be combined.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage share policy update"')
