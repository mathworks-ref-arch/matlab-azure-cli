classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            ...
            this.BaseCmd = 'az storage share create ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --fail-on-exist      : Specify whether to throw an exception when the share exists. False by')
            fprintf('%s\n', '                           default.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage share create"')
