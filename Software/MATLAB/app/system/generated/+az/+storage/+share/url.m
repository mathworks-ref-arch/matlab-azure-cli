classdef url < azure.AzureBase
    ...
    methods
        function this = url()
            ...
            this.BaseCmd = 'az storage share url ';
        end
        ...
        function this = unc(this, varargin)
            % Output UNC network path. Storage Account Arguments
            this.Options = [this.Options, '--unc', varargin{:}];
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage share url"')
