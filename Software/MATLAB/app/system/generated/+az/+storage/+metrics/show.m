classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            ...
            this.BaseCmd = 'az storage metrics show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    az storage metrics show : Show metrics settings for a storage account.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --interval          : Filter the set of metrics to retrieve by time interval.  Allowed values:')
            fprintf('%s\n', '                          both, hour, minute.  Default: both.')
            fprintf('%s\n', '    --services          : The storage services from which to retrieve metrics info: (b)lob (q)ueue')
            fprintf('%s\n', '                          (t)able. Can be combined.  Default: bfqt.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage metrics show"')
