classdef resize < azure.AzureBase
    ...
    methods
        function this = resize()
            ...
            % If the specified byte value is less than the current size of the file, then all ranges above
            % the specified byte value are cleared.
            this.BaseCmd = 'az storage file resize ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az storage file resize"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --size          [Required] : The length to resize the file to.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage file resize"')
