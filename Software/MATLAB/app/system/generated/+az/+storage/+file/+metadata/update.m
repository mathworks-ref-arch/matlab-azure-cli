classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az storage file metadata update : Sets user-defined metadata for the specified file as one or
            % more name-value pairs.
            this.BaseCmd = 'az storage file metadata update ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az storage file metadata update"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage file metadata update"')
