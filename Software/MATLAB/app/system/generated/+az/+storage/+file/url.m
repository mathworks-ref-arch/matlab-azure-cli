classdef url < azure.AzureBase
    ...
    methods
        function this = url()
            ...
            this.BaseCmd = 'az storage file url ';
        end
        ...
        function this = protocol(this, varargin)
            % Protocol to use.  Allowed values: http, https.  Default: https. Storage Account Arguments
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage file url"')
