classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az storage file show : Returns all user-defined metadata, standard HTTP properties, and system
            % properties for the file.
            % Returns an instance of :class:`~azure.storage.file.models.File` with
            % :class:`~azure.storage.file.models.FileProperties` and a metadata dict.
            this.BaseCmd = 'az storage file show ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az storage file show"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage file show"')
