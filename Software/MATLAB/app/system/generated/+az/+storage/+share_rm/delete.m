classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az storage share-rm delete : Delete the specified Azure file share.
            % Command group 'storage share-rm' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az storage share-rm delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'Examples')
            fprintf('%s\n', '    Delete an Azure file share ''myfileshare'' under the storage account ''mystorageaccount'' (account')
            fprintf('%s\n', '    name) in resource group ''MyResourceGroup''.')
            fprintf('%s\n', '        az storage share-rm delete -g MyResourceGroup --storage-account mystorageaccount --name')
            fprintf('%s\n', '        myfileshare')
            fprintf('%s\n', '    Delete an Azure file share ''myfileshare'' under the storage account ''mystorageaccount'' (account')
            fprintf('%s\n', '    id).')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage share-rm delete"')
