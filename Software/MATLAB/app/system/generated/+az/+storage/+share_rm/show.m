classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az storage share-rm show : Show the properties for a specified Azure file share.
            % Command group 'storage share-rm' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az storage share-rm show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'Examples')
            fprintf('%s\n', '    Show the properties for an Azure file share ''myfileshare'' under the storage account')
            fprintf('%s\n', '    ''mystorageaccount'' (account name) in resource group ''MyResourceGroup''.')
            fprintf('%s\n', '        az storage share-rm show -g MyResourceGroup --storage-account mystorageaccount --name')
            fprintf('%s\n', '        myfileshare')
            fprintf('%s\n', '    Show the properties for an Azure file share ''myfileshare'' under the storage account')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage share-rm show"')
