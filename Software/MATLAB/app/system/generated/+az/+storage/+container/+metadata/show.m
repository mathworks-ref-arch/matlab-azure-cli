classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az storage container metadata show : Returns all user-defined metadata for the specified
            % container.
            this.BaseCmd = 'az storage container metadata show ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az storage container metadata show"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --lease-id           : If specified, get_container_metadata only succeeds if the container''s')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage container metadata show"')
