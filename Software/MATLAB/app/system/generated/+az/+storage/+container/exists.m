classdef exists < azure.AzureBase
    ...
    methods
        function this = exists()
            ...
            this.BaseCmd = 'az storage container exists ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az storage container exists --account-name mystorageccount --account-key 00000000 --name')
            fprintf('%s\n', '        mycontainer')
            fprintf('%s\n', 'For more specific examples, use: az find "az storage container exists"')
