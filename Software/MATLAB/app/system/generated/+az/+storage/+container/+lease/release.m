classdef release < azure.AzureBase
    ...
    methods
        function this = release()
            ...
            % The lease may be released if the lease_id specified matches that associated with the
            ...
            this.BaseCmd = 'az storage container lease release ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az storage container lease release"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage container lease release"')
