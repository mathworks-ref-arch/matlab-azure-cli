classdef break_ < azure.AzureBase
    ...
    methods
        function this = break_()
            ...
            this.BaseCmd = 'az storage container lease break ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az storage container lease break"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage container lease break"')
