classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            ...
            this.BaseCmd = 'az storage container list ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az storage container list"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '                          all.  Default: 5000.')
            fprintf('%s\n', '    --prefix            : Filters the results to return only containers whose names begin with the')
            fprintf('%s\n', '                          specified prefix.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage container list"')
