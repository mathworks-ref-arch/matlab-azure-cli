classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az storage container metadata update : Sets one or more user-defined name-value pairs for the
            % specified container.
            % Each call to this operation replaces all existing metadata attached to the container. To
            % remove all metadata from the container, call this operation with no metadata dict.
            this.BaseCmd = 'az storage container metadata update ';
        end
        ...
        function this = if_modified_since(this, varargin)
            % Commence only if modified since supplied UTC datetime (Y-m-d'T'H:M'Z'). Storage Account Arguments
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az storage container metadata update"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --lease-id           : If specified, set_container_metadata only succeeds if the container''s')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage container metadata update"')
