classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az storage container show : Returns all user-defined metadata and system properties for the
            % specified container.
            % The data returned does not include the container's list of blobs.
            this.BaseCmd = 'az storage container show ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az storage container show"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --lease-id           : If specified, get_container_properties only succeeds if the container''s')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage container show"')
