classdef clear < azure.AzureBase
    ...
    methods
        function this = clear()
            ...
            % Clearing the same or non-existent tag results in an idempotent operation. ClearLegalHold
            % clears out only the specified tags in the request.
            this.BaseCmd = 'az storage container legal-hold clear ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az storage container legal-hold clear"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage container legal-hold clear"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class clear 
