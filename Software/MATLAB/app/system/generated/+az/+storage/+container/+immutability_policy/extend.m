classdef extend < azure.AzureBase

    % Copyright 2020, The MathWorks Inc.

    methods
        function this = extend()
            % az storage container immutability-policy extend : Extends the
            % immutabilityPeriodSinceCreationInDays of a locked immutabilityPolicy.
            % The only action allowed on a Locked policy will be this action. ETag in If-Match is required
            % for this operation.
            this.BaseCmd = 'az storage container immutability-policy extend ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az storage container immutability-policy extend"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --if-match              [Required] : The entity state (ETag) version of the immutability policy')
            ...
            fprintf('%s\n', '                                         logs.')
            fprintf('%s\n', 'For more specific examples, use: az find "az storage container immutability-policy extend"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class extend 
