classdef show_permission < azure.AzureBase

    % Copyright 2020, The MathWorks Inc.

    methods
        function this = show_permission()
            % az storage container show-permission : Gets the permissions for the specified container.
            % The permissions indicate whether container data may be accessed publicly.
            this.BaseCmd = 'az storage container show-permission ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az storage container show-permission"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --lease-id           : If specified, get_container_acl only succeeds if the container''s lease is')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage container show-permission"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class show_permission 
