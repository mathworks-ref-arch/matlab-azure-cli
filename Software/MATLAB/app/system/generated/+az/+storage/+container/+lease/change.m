classdef change < azure.AzureBase
    ...
    methods
        function this = change()
            ...
            this.BaseCmd = 'az storage container lease change ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az storage container lease change"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage container lease change"')
