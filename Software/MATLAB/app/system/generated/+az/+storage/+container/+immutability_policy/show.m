classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az storage container immutability-policy show : Gets the existing immutability policy along with
            % the corresponding ETag in response headers and body.
            this.BaseCmd = 'az storage container immutability-policy show ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az storage container immutability-policy show"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --if-match                     : The entity state (ETag) version of the immutability policy to')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage container immutability-policy show"')
