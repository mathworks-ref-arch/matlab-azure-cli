classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            ...
            % The response of delete has immutabilityPeriodSinceCreationInDays set to 0. ETag in If-Match
            % is required for this operation. Deleting a locked immutability policy is not allowed, only
            % way is to delete the container after deleting all blobs inside the container.
            this.BaseCmd = 'az storage container immutability-policy delete ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az storage container immutability-policy delete"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage container immutability-policy delete"')
