classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            ...
            this.BaseCmd = 'az storage container legal-hold show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az storage container legal-hold show --account-name mystorageccount --container-name')
            fprintf('%s\n', '        MyContainer')
            fprintf('%s\n', 'For more specific examples, use: az find "az storage container legal-hold show"')
