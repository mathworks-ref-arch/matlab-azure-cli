classdef off < azure.AzureBase
    ...
    methods
        function this = off()
            % az storage logging off : Turn off logging for a storage account.
            % This command is in preview. It may be changed/removed in a future release.
            this.BaseCmd = 'az storage logging off ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage logging off"')
