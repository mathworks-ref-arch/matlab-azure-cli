classdef exists < azure.AzureBase
    ...
    methods
        function this = exists()
            ...
            this.BaseCmd = 'az storage table exists ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az storage table exists"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    az storage table exists : Returns a boolean indicating whether the table exists.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --name -n [Required] : The name of table to check for existence.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage table exists"')
