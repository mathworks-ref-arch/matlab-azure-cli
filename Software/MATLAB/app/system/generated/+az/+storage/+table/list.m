classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            ...
            this.BaseCmd = 'az storage table list ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az storage table list"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    az storage table list : List tables in a storage account.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --marker            : An opaque continuation object. This value can be retrieved from the')
            fprintf('%s\n', '                          next_marker field of a previous generator object if num_results was')
            fprintf('%s\n', '                          specified and that generator has finished enumerating results. If')
            fprintf('%s\n', '                          specified, this generator will begin returning results from the point')
            fprintf('%s\n', '                          where the previous generator stopped.')
            fprintf('%s\n', '    --num-results       : The maximum number of tables to return.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage table list"')
