classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            ...
            this.BaseCmd = 'az storage table create ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az storage table create"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    az storage table create : Creates a new table in the storage account.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --name -n [Required] : The name of the table to create. The table name may contain only')
            fprintf('%s\n', '                           alphanumeric characters and cannot begin with a numeric character. It is')
            fprintf('%s\n', '                           case-insensitive and must be from 3 to 63 characters long.')
            fprintf('%s\n', '    --fail-on-exist      : Throw an exception if the table already exists.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage table create"')
