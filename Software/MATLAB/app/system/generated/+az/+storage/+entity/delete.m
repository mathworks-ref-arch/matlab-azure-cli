classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            ...
            % Throws if the entity does not exist.  When an entity is successfully deleted, the entity is
            % immediately marked  for deletion and is no longer accessible to clients. The entity is later
            % removed from the Table service during garbage collection.
            this.BaseCmd = 'az storage entity delete ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az storage entity delete"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --table-name -t [Required] : The name of the table containing the entity to delete.')
            ...
            fprintf('%s\n', '                                 purpose of optimistic concurrency. The delete operation will be')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage entity delete"')
