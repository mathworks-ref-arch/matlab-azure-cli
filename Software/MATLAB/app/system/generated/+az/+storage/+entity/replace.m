classdef replace < azure.AzureBase
    ...
    methods
        function this = replace()
            ...
            % Throws if the entity does not exist.  The update_entity operation replaces the entire entity
            % and can be used to  remove properties.
            this.BaseCmd = 'az storage entity replace ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az storage entity replace"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        and can be used to  remove properties.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --entity -e     [Required] : The entity to update. Could be a dict or an entity object. Must')
            fprintf('%s\n', '                                 contain a PartitionKey and a RowKey.')
            fprintf('%s\n', '    --table-name -t [Required] : The name of the table containing the entity to update.')
            ...
            fprintf('%s\n', '                                 purpose of optimistic concurrency. The update operation will be')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage entity replace"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class replace 
