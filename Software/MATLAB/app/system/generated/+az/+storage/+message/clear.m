classdef clear < azure.AzureBase
    ...
    methods
        function this = clear()
            ...
            this.BaseCmd = 'az storage message clear ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az storage message clear"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage message clear"')
