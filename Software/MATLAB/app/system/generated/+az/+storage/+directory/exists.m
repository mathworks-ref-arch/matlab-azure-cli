classdef exists < azure.AzureBase
    ...
    methods
        function this = exists()
            ...
            this.BaseCmd = 'az storage directory exists ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az storage directory exists --account-key 00000000 --account-name MyAccount --name')
            fprintf('%s\n', '        MyDirectory --share-name MyShare')
            fprintf('%s\n', 'For more specific examples, use: az find "az storage directory exists"')
