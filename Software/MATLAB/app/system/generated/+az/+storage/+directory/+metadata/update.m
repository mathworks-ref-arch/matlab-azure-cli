classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az storage directory metadata update : Sets one or more user-defined name-value pairs for the
            % specified directory.
            % Each call to this operation replaces all existing metadata attached to the directory. To
            % remove all metadata from the directory, call this operation with no metadata dict.
            this.BaseCmd = 'az storage directory metadata update ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az storage directory metadata update"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage directory metadata update"')
