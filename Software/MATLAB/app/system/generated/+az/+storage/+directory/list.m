classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            ...
            this.BaseCmd = 'az storage directory list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az storage directory list --account-key 00000000 --account-name MyAccount --share-name')
            fprintf('%s\n', '        MyShare')
            fprintf('%s\n', 'For more specific examples, use: az find "az storage directory list"')
