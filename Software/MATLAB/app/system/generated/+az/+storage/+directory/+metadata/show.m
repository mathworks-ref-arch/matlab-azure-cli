classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az storage directory metadata show : Returns all user-defined metadata for the specified
            % directory.
            this.BaseCmd = 'az storage directory metadata show ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az storage directory metadata show"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage directory metadata show"')
