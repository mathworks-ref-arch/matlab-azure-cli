classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az storage directory show : Returns all user-defined metadata and system properties for the
            % specified directory.
            % The data returned does not include the directory's list of files.
            this.BaseCmd = 'az storage directory show ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az storage directory show"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az storage directory show"')
