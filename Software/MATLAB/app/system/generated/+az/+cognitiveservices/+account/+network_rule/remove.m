classdef remove < azure.AzureBase
    ...
    methods
        function this = remove()
            % az cognitiveservices account network-rule remove : Remove a network rule.
            this.BaseCmd = 'az cognitiveservices account network-rule remove ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az cognitiveservices account network-rule remove --name MyAccount --resource-group')
            fprintf('%s\n', '        MyResourceGroup --subnet mysubnet')
            fprintf('%s\n', '    Remove a network rule.')
            fprintf('%s\n', '        az cognitiveservices account network-rule remove --name MyAccount --ip-address 23.45.1.0/24')
            fprintf('%s\n', '        --resource-group MyResourceGroup')
            fprintf('%s\n', 'For more specific examples, use: az find "az cognitiveservices account network-rule remove"')
