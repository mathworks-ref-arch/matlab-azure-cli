classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az cognitiveservices account delete : Manage Azure Cognitive Services accounts.
            ...
            this.BaseCmd = 'az cognitiveservices account delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'Examples')
            fprintf('%s\n', '    Delete account.')
            fprintf('%s\n', '        az cognitiveservices account delete --name myresource-luis -g cognitive-services-resource-')
            fprintf('%s\n', '        group')
            fprintf('%s\n', 'For more specific examples, use: az find "az cognitiveservices account delete"')
