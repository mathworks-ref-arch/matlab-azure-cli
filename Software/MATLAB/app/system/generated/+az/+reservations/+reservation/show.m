classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az reservations reservation show : Get details of a reservation.
            % Command group 'reservations' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az reservations reservation show ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az reservations reservation show"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        release.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --reservation-id       [Required] : Reservation id of reservation to look up.')
            fprintf('%s\n', '    --reservation-order-id [Required] : Order id of reservation to look up.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az reservations reservation show"')
