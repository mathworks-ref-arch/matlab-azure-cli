classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            ...
            % release.
            this.BaseCmd = 'az netappfiles volume show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --name --volume-name -n -v : The name of the ANF pool.')
            ...
            fprintf('%s\n', '        az netappfiles volume show -g mygroup --account-name myaccname --pool-name mypoolname --name')
            fprintf('%s\n', '        myvolname')
            fprintf('%s\n', 'For more specific examples, use: az find "az netappfiles volume show"')
