classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            ...
            % release.
            this.BaseCmd = 'az netappfiles volume delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az netappfiles volume delete -g mygroup --account-name myaccname --pool-name mypoolname')
            fprintf('%s\n', '        --name myvolname')
            fprintf('%s\n', 'For more specific examples, use: az find "az netappfiles volume delete"')
