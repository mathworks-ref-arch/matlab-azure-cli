classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            ...
            % release.
            this.BaseCmd = 'az netappfiles volume export-policy list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az netappfiles volume export-policy list -g mygroup --account-name myaccname --pool-name')
            fprintf('%s\n', '        mypoolname --name myvolname')
            fprintf('%s\n', 'For more specific examples, use: az find "az netappfiles volume export-policy list"')
