classdef resume < azure.AzureBase
    ...
    methods
        function this = resume()
            % az netappfiles volume replication resume : Resync a volume replication for the specified
            % destination volume. The replication process is resumed from source to destination.
            % Command group 'netappfiles' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az netappfiles volume replication resume ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az netappfiles volume replication resume -g mygroup --account-name myaccname --pool-name')
            fprintf('%s\n', '        mypoolname --name mydestinationvolname')
            fprintf('%s\n', 'For more specific examples, use: az find "az netappfiles volume replication resume"')
