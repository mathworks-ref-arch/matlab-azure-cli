classdef remove < azure.AzureBase
    ...
    methods
        function this = remove()
            % az netappfiles volume replication remove : Delete a volume replication for the specified
            % destination volume. The data replication objects of source and destination volumes will be
            % removed.
            % Command group 'netappfiles' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az netappfiles volume replication remove ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az netappfiles volume replication remove -g mygroup --account-name myaccname --pool-name')
            fprintf('%s\n', '        mypoolname --name mydestinationvolname')
            fprintf('%s\n', 'For more specific examples, use: az find "az netappfiles volume replication remove"')
