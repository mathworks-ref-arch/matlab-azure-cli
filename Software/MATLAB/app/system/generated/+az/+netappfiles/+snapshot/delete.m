classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            ...
            % release.
            this.BaseCmd = 'az netappfiles snapshot delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az netappfiles snapshot delete -g mygroup --account-name myaccname --pool-name mypoolname')
            fprintf('%s\n', '        --volume-name myvolname --name mysnapname')
            fprintf('%s\n', 'For more specific examples, use: az find "az netappfiles snapshot delete"')
