classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            ...
            % release.
            this.BaseCmd = 'az netappfiles snapshot list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az netappfiles snapshot list -g mygroup --account-name myaccname --pool-name mypoolname')
            fprintf('%s\n', '        --volume-name myvolname')
            fprintf('%s\n', 'For more specific examples, use: az find "az netappfiles snapshot list"')
