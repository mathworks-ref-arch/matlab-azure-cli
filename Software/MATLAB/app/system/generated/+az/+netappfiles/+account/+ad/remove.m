classdef remove < azure.AzureBase
    ...
    methods
        function this = remove()
            ...
            % release.
            this.BaseCmd = 'az netappfiles account ad remove ';
        end
        function this = active_directory(this, varargin)
            % The id of the active directory.
            this.Options = [this.Options, '--active-directory', varargin{:}];
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        release.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --active-directory [Required] : The id of the active directory.')
            ...
            fprintf('%s\n', '        az netappfiles account ad remove -g mygroup --name myname --active-directory')
            fprintf('%s\n', '        13641da9-c0e9-4b97-84fc-4f8014a93848')
            fprintf('%s\n', 'For more specific examples, use: az find "az netappfiles account ad remove"')
