classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az ad group delete : Delete a group from the directory.
            this.BaseCmd = 'az ad group delete ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az ad group delete"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az ad group delete"')
