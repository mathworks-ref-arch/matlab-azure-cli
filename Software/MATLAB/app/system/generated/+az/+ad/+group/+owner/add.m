classdef add < azure.AzureBase
    ...
    methods
        function this = add()
            % az ad group owner add : Add a group owner.
            this.BaseCmd = 'az ad group owner add ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az ad group owner add --group MyGroupDisplayName --owner-object-id xxxxxxxx-xxxx-xxxx-xxxx-')
            fprintf('%s\n', '        xxxxxxxxxxxx')
            fprintf('%s\n', 'For more specific examples, use: az find "az ad group owner add"')
