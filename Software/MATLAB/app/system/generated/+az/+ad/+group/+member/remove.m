classdef remove < azure.AzureBase
    ...
    methods
        function this = remove()
            ...
            this.BaseCmd = 'az ad group member remove ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az ad group member remove"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az ad group member remove"')
