classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            ...
            this.BaseCmd = 'az ad sp credential delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az ad sp credential delete --id 00000000-0000-0000-0000-000000000000 --key-id xxxxxxxx-xxxx-')
            fprintf('%s\n', '        xxxx-xxxx-xxxxxxxxxxxx')
            fprintf('%s\n', 'For more specific examples, use: az find "az ad sp credential delete"')
