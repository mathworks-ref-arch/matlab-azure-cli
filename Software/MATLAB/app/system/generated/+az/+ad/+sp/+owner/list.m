classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            ...
            this.BaseCmd = 'az ad sp owner list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    az ad sp owner list : List service principal owners.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --id    [Required] : Service principal name, or object id or the service principal.')
            fprintf('%s\n', 'Global Arguments')
            ...
            fprintf('%s\n', 'Examples')
            fprintf('%s\n', '    List service principal owners. (autogenerated)')
            fprintf('%s\n', '        az ad sp owner list --id 00000000-0000-0000-0000-000000000000')
            fprintf('%s\n', 'For more specific examples, use: az find "az ad sp owner list"')
