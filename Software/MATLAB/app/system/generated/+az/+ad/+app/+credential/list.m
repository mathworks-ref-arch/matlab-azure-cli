classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az ad app credential list : List an application's password or certificate credentials.
            this.BaseCmd = 'az ad app credential list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az ad app credential list"')
