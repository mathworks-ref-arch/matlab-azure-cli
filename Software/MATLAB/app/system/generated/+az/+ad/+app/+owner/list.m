classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az ad app owner list : List application owners.
            this.BaseCmd = 'az ad app owner list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    az ad app owner list : List application owners.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --id    [Required] : Identifier uri, application id, or object id of the application.')
            fprintf('%s\n', 'Global Arguments')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az ad app owner list"')
