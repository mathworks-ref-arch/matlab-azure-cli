classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az ad app permission delete : Remove an API permission.
            this.BaseCmd = 'az ad app permission delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az ad app permission delete --id eeba0b46-78e5-4a1a-a1aa-cafe6c123456 --api')
            fprintf('%s\n', '        00000002-0000-0000-c000-000000000000')
            fprintf('%s\n', 'For more specific examples, use: az find "az ad app permission delete"')
