classdef add < azure.AzureBase
    ...
    methods
        function this = add()
            % az ad app owner add : Add an application owner.
            this.BaseCmd = 'az ad app owner add ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az ad app owner add --id 00000000-0000-0000-0000-000000000000 --owner-object-id xxxxxxxx-')
            fprintf('%s\n', '        xxxx-xxxx-xxxx-xxxxxxxxxxxx')
            fprintf('%s\n', 'For more specific examples, use: az find "az ad app owner add"')
