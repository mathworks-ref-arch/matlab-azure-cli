classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az cloud update : Update the configuration of a cloud.
            this.BaseCmd = 'az cloud update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '                                                                 machine images.')
            fprintf('%s\n', '    --name -n                                                  : Name of a registered cloud.')
            fprintf('%s\n', '                                                                 Default: AzureCloud.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az cloud update"')
