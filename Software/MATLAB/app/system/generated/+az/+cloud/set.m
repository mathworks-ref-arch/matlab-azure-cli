classdef set < azure.AzureBase
    ...
    methods
        function this = set()
            % az cloud set : Set the active cloud.
            this.BaseCmd = 'az cloud set ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --profile            : Profile to use for this cloud.  Allowed values: 2017-03-09-profile,')
            fprintf('%s\n', '                           2018-03-01-hybrid, 2019-03-01-hybrid, latest.')
            fprintf('%s\n', 'Global Arguments')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az cloud set"')
