classdef update < azure.AzureBase
    ...
    methods
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az redis update"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        Scale or update settings of a Redis cache.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --sku               : Type of Redis cache.  Allowed values: Basic, Premium, Standard.')
            fprintf('%s\n', '    --vm-size           : Size of Redis cache to deploy. Basic and Standard Cache sizes start with')
            fprintf('%s\n', '                          C. Premium Cache sizes start with P.  Allowed values: c0, c1, c2, c3, c4,')
            fprintf('%s\n', '                          c5, c6, p1, p2, p3, p4, p5.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az redis update"')
