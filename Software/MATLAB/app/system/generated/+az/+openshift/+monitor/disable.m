classdef disable < azure.AzureBase
    ...
    methods
        function this = disable()
            % az openshift monitor disable : Disable Log Analytics monitoring.
            this.BaseCmd = 'az openshift monitor disable ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az openshift monitor disable"')
