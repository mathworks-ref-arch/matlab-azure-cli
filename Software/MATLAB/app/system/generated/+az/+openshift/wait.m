classdef wait < azure.AzureBase
    ...
    methods
        function this = wait()
            ...
            this.BaseCmd = 'az openshift wait ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az openshift wait -g MyResourceGroup -n MyManagedCluster --updated --interval 60 --timeout')
            fprintf('%s\n', '        1800')
            fprintf('%s\n', 'For more specific examples, use: az find "az openshift wait"')
