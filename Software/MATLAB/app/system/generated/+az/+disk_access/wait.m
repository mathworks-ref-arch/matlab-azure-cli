classdef wait < azure.AzureBase
    ...
    methods
        function this = wait()
            % az disk-access wait : Place the CLI in a waiting state until a condition of a disk access is
            % met.
            this.BaseCmd = 'az disk-access wait ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --name -n           : Name of the disk access resource.')
            ...
            fprintf('%s\n', 'Examples')
            fprintf('%s\n', '    Place the CLI in a waiting state until the disk access is created with ''provisioningState'' at')
            fprintf('%s\n', '    ''Succeeded''.')
            fprintf('%s\n', '        az disk-access wait --created -g MyResourceGroup -n MyDiskAccess')
            fprintf('%s\n', 'For more specific examples, use: az find "az disk-access wait"')
