classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az cosmosdb table throughput update : Update the throughput of the Table under an Azure Cosmos
            % DB account.
            this.BaseCmd = 'az cosmosdb table throughput update ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az cosmosdb table throughput update"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az cosmosdb table throughput update"')
