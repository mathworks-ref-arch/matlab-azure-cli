classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az cosmosdb private-endpoint-connection show : Show details of a private endpoint connection
            % associated with Azure Comsos DB.
            this.BaseCmd = 'az cosmosdb private-endpoint-connection show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az cosmosdb private-endpoint-connection show --account-name MyAccount --name')
            fprintf('%s\n', '        MyPrivateEndpoint --resource-group MyResourceGroup')
            fprintf('%s\n', 'For more specific examples, use: az find "az cosmosdb private-endpoint-connection show"')
