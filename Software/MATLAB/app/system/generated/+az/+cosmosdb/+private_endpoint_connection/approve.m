classdef approve < azure.AzureBase
    ...
    methods
        function this = approve()
            % az cosmosdb private-endpoint-connection approve : Approve the specified private endpoint
            % connection associated with Azure Comsos DB.
            this.BaseCmd = 'az cosmosdb private-endpoint-connection approve ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az cosmosdb private-endpoint-connection approve --account-name MyAccount --name')
            fprintf('%s\n', '        MyPrivateEndpoint --resource-group MyResourceGroup --description "Approved"')
            fprintf('%s\n', 'For more specific examples, use: az find "az cosmosdb private-endpoint-connection approve"')
