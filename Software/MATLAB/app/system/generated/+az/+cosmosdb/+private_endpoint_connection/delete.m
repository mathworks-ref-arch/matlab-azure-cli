classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az cosmosdb private-endpoint-connection delete : Delete the specified private endpoint
            % connection associated with Azure Comsos DB.
            this.BaseCmd = 'az cosmosdb private-endpoint-connection delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az cosmosdb private-endpoint-connection delete --account-name MyAccount --name')
            fprintf('%s\n', '        MyPrivateEndpoint --resource-group MyResourceGroup')
            fprintf('%s\n', 'For more specific examples, use: az find "az cosmosdb private-endpoint-connection delete"')
