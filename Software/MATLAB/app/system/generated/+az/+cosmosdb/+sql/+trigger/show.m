classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az cosmosdb sql trigger show : Show the details of a SQL trigger under an Azure Cosmos DB SQL
            % container.
            this.BaseCmd = 'az cosmosdb sql trigger show ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az cosmosdb sql trigger show"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az cosmosdb sql trigger show"')
