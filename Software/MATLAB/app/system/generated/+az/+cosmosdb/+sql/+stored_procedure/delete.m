classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az cosmosdb sql stored-procedure delete : Delete the SQL stored procedure under an Azure Cosmos
            % DB SQL container.
            this.BaseCmd = 'az cosmosdb sql stored-procedure delete ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az cosmosdb sql stored-procedure delete"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az cosmosdb sql stored-procedure delete"')
