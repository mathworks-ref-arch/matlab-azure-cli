classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            % az cosmosdb sql trigger create : Create an SQL trigger under an Azure Cosmos DB SQL container.
            this.BaseCmd = 'az cosmosdb sql trigger create ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --body -b           [Required] : Trigger body, you can enter it as a string or as a file, e.g.,')
            fprintf('%s\n', '                                     --body @triggerbody-file.json.')
            ...
            fprintf('%s\n', '    --operation                    : The operation of the trigger.  Allowed values: All, Create,')
            fprintf('%s\n', '                                     Delete, Replace, Update.')
            fprintf('%s\n', '    --type -t                      : Trigger type.  Allowed values: Post, Pre.')
            fprintf('%s\n', 'Global Arguments')
            ...
            fprintf('%s\n', '        az cosmosdb sql trigger create -g MyResourceGroup -a MyAccount -d MyDatabase -c MyContainer')
            fprintf('%s\n', '        -n MyTrigger -b TriggerBody')
            fprintf('%s\n', 'For more specific examples, use: az find "az cosmosdb sql trigger create"')
