classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az cosmosdb sql database throughput update : Update the throughput of the SQL database under an
            % Azure Cosmos DB account.
            this.BaseCmd = 'az cosmosdb sql database throughput update ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az cosmosdb sql database throughput update"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az cosmosdb sql database throughput update"')
