classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            ...
            % database.
            this.BaseCmd = 'az cosmosdb sql container create ';
        end
        ...
        function this = partition_key_version(this, varargin)
            % The version of partition key.
            this.Options = [this.Options, '--partition-key-version', varargin{:}];
        end
        ...
        function this = unique_key_policy(this, varargin)
            ...
            this.Options = [this.Options, '--unique-key-policy', varargin{:}];
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        "700"')
            fprintf('%s\n', 'For more specific examples, use: az find "az cosmosdb sql container create"')
