classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az cosmosdb sql container update : Update an SQL container under an Azure Cosmos DB SQL
            % database.
            this.BaseCmd = 'az cosmosdb sql container update ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az cosmosdb sql container update"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az cosmosdb sql container update"')
