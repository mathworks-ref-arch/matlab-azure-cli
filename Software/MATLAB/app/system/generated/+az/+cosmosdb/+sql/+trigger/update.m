classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az cosmosdb sql trigger update : Updates an Azure Cosmos DB SQL trigger.
            this.BaseCmd = 'az cosmosdb sql trigger update ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az cosmosdb sql trigger update"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --body -b                      : Trigger body, you can enter it as a string or as a file, e.g.,')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az cosmosdb sql trigger update"')
