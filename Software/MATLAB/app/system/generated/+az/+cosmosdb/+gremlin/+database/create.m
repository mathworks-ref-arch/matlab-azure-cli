classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            % az cosmosdb gremlin database create : Create an Gremlin database under an Azure Cosmos DB
            % account.
            this.BaseCmd = 'az cosmosdb gremlin database create ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az cosmosdb gremlin database create"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az cosmosdb gremlin database create"')
