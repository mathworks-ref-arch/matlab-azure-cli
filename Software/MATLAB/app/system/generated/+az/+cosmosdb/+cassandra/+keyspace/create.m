classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            % az cosmosdb cassandra keyspace create : Create an Cassandra keyspace under an Azure Cosmos DB
            % account.
            this.BaseCmd = 'az cosmosdb cassandra keyspace create ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az cosmosdb cassandra keyspace create"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '                                     be 4000 (RU/s).')
            fprintf('%s\n', '    --throughput                   : The throughput of Cassandra keyspace (RU/s). Default value is')
            fprintf('%s\n', '                                     400.')
            fprintf('%s\n', 'Global Arguments')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az cosmosdb cassandra keyspace create"')
