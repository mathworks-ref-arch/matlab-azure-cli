classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az cosmosdb cassandra keyspace throughput update : Update the throughput of the Cassandra
            % keyspace under an Azure Cosmos DB account.
            this.BaseCmd = 'az cosmosdb cassandra keyspace throughput update ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az cosmosdb cassandra keyspace throughput update"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az cosmosdb cassandra keyspace throughput update"')
