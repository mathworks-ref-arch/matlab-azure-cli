classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az cosmosdb cassandra table throughput update : Update the throughput of the Cassandra table
            % under an Azure Cosmos DB Cassandra keyspace.
            this.BaseCmd = 'az cosmosdb cassandra table throughput update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    (autogenerated)')
            fprintf('%s\n', '        az cosmosdb cassandra table throughput update --account-name MyAccount --keyspace-name')
            fprintf('%s\n', '        MyKeyspace --name MyTable --resource-group MyResourceGroup --throughput "500"')
            fprintf('%s\n', 'For more specific examples, use: az find "az cosmosdb cassandra table throughput update"')
