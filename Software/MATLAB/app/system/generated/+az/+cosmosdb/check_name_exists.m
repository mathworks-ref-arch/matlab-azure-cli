classdef check_name_exists < azure.AzureBase

    % Copyright 2020, The MathWorks Inc.

    methods
        function this = check_name_exists()
            % az cosmosdb check-name-exists : Checks if an Azure Cosmos DB account name exists.
            this.BaseCmd = 'az cosmosdb check-name-exists ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az cosmosdb check-name-exists"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class check_name_exists 
