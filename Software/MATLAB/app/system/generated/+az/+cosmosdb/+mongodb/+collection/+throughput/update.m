classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az cosmosdb mongodb collection throughput update : Update the throughput of the MongoDB
            % collection under an Azure Cosmos DB MongoDB database.
            this.BaseCmd = 'az cosmosdb mongodb collection throughput update ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az cosmosdb mongodb collection throughput update"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az cosmosdb mongodb collection throughput update"')
