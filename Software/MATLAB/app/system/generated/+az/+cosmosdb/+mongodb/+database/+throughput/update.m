classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az cosmosdb mongodb database throughput update : Update the throughput of the MongoDB database
            % under an Azure Cosmos DB account.
            this.BaseCmd = 'az cosmosdb mongodb database throughput update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'Examples')
            fprintf('%s\n', '    Update the throughput of the MongoDB database under an Azure Cosmos DB account. (autogenerated)')
            fprintf('%s\n', '        az cosmosdb mongodb database throughput update --account-name MyAccount --name MyDatabase')
            fprintf('%s\n', '        --resource-group MyResourceGroup --throughput "500"')
            fprintf('%s\n', 'For more specific examples, use: az find "az cosmosdb mongodb database throughput update"')
