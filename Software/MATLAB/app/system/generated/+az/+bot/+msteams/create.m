classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            ...
            % release.
            this.BaseCmd = 'az bot msteams create ';
        end
        ...
        function this = enable_calling(this, varargin)
            % Enable calling on Microsoft Teams.  Allowed values: false, true.
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '                                     true.')
            fprintf('%s\n', '    --calling-web-hook             : The calling web hook to use on Microsoft Teams.')
            fprintf('%s\n', '    --enable-calling               : Enable calling on Microsoft Teams.  Allowed values: false,')
            fprintf('%s\n', '                                     true.')
            fprintf('%s\n', 'Global Arguments')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az bot msteams create"')
