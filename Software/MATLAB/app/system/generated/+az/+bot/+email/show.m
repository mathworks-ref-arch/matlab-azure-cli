classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            ...
            % Command group 'bot email' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az bot email show ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az bot email show"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az bot email show"')
