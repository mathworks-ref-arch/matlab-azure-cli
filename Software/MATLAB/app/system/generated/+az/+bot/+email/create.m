classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            ...
            % release.
            this.BaseCmd = 'az bot email create ';
        end
        function this = email_address(this, varargin)
            % The email address for the bot.
            this.Options = [this.Options, '--email-address', varargin{:}];
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        release.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --email-address -a  [Required] : The email address for the bot.')
            ...
            fprintf('%s\n', '    --password -p       [Required] : The email password for the bot.')
            ...
            fprintf('%s\n', '        -p password')
            fprintf('%s\n', 'For more specific examples, use: az find "az bot email create"')
