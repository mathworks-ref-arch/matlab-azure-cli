classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            ...
            % release.
            this.BaseCmd = 'az bot slack delete ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az bot slack delete"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az bot slack delete"')
