classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az bot directline update : Update the DirectLine Channel on a bot with only v3 protocol enabled.
            % Command group 'bot directline' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az bot directline update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az bot directline update"')
