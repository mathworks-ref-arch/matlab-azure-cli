classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            ...
            % Command group 'bot telegram' is in preview. It may be changed/removed in a future
            % release.
            this.BaseCmd = 'az bot telegram create ';
        end
        ...
        function this = is_validated(this, varargin)
            % Whether or not the Telegram account has been validated for use with the bot.  Allowed values: false, true.
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        release.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --access-token      [Required] : The access token for the Telegram account.')
            ...
            fprintf('%s\n', '                                     true.')
            fprintf('%s\n', '    --is-validated                 : Whether or not the Telegram account has been validated for use')
            ...
            fprintf('%s\n', '        --is-validated')
            fprintf('%s\n', 'For more specific examples, use: az find "az bot telegram create"')
