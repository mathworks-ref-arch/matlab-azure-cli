classdef show < azure.AzureBase
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        Please use with discretion.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --name -n          : Space-separated list of local context parameter names.')
            fprintf('%s\n', 'Global Arguments')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az local-context show"')
