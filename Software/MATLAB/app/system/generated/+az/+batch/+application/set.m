classdef set < azure.AzureBase
    ...
    methods
        function this = set()
            ...
            this.BaseCmd = 'az batch application set ';
        end
        ...
        function this = allow_updates(this, varargin)
            ...
            this.Options = [this.Options, '--allow-updates', varargin{:}];
        end

        function this = default_version(this, varargin)
            % The package to use if a client requests the application but does not specify a version. This property can only be set to the name of an existing package.
            this.Options = [this.Options, '--default-version', varargin{:}];
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az batch application set"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '                                     does not specify a version. This property can only be set to')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az batch application set"')
