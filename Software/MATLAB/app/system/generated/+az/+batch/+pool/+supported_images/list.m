classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az batch pool supported-images list : Lists all Virtual Machine Images supported by the Azure
            % Batch service.
            this.BaseCmd = 'az batch pool supported-images list ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az batch pool supported-images list"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az batch pool supported-images list"')
