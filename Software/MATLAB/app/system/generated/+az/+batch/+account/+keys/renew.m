classdef renew < azure.AzureBase
    ...
    methods
        function this = renew()
            ...
            this.BaseCmd = 'az batch account keys renew ';
        end
        function this = key_name(this, varargin)
            % The type of account key to regenerate.  Allowed values: Primary, Secondary.
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az batch account keys renew"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az batch account keys renew"')
