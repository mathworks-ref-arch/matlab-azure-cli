classdef download < azure.AzureBase
    ...
    methods
        function this = download()
            ...
            this.BaseCmd = 'az batch task file download ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az batch task file download"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az batch task file download"')
