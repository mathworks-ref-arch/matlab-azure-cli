classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            ...
            % create a user Account on the Compute Node. This API can be invoked only on Pools created
            % with the virtual machine configuration property. For Pools created with a cloud service
            % configuration, see the GetRemoteDesktop API.
            this.BaseCmd = 'az batch node remote-login-settings show ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az batch node remote-login-settings show"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az batch node remote-login-settings show"')
