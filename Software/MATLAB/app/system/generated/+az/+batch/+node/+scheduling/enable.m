classdef enable < azure.AzureBase
    ...
    methods
        function this = enable()
            ...
            % disabled.
            this.BaseCmd = 'az batch node scheduling enable ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az batch node scheduling enable"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az batch node scheduling enable"')
