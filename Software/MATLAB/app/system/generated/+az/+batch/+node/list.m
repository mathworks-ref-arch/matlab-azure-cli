classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            ...
            this.BaseCmd = 'az batch node list ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az batch node list"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    az batch node list : Lists the Compute Nodes in the specified Pool.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --pool-id [Required] : The ID of the Pool from which you want to list Compute Nodes.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az batch node list"')
