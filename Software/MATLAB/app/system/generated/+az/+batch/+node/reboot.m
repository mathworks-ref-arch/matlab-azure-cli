classdef reboot < azure.AzureBase
    ...
    methods
        function this = reboot()
            ...
            this.BaseCmd = 'az batch node reboot ';
        end
        ...
        function this = node_reboot_option(this, varargin)
            % When to reboot the Compute Node and what to do with currently running Tasks. The default value is requeue.  Allowed values: requeue, retaineddata, taskcompletion, terminate.
            this.Options = [this.Options, '--node-reboot-option', varargin{:}];
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az batch node reboot"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az batch node reboot"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class reboot 
