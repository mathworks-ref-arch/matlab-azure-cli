classdef enable < azure.AzureBase
    ...
    methods
        function this = enable()
            ...
            this.BaseCmd = 'az batch job-schedule enable ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az batch job-schedule enable"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az batch job-schedule enable"')
