classdef reset < azure.AzureBase
    ...
    methods
        function this = reset()
            ...
            this.BaseCmd = 'az batch job-schedule reset ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az batch job-schedule reset"
        ...
        function this = metadata(this, varargin)
            % A list of name-value pairs associated with the Job Schedule as metadata. If you do not specify this element, it takes the default value of an empty list; in effect, any existing metadata is deleted. Space- separated values in 'key=value' format. Job Schedule: Job Specification Arguments
        ...
        function this = uses_task_dependencies(this, varargin)
            % Whether Tasks in the Job can define dependencies on each other. The default is false. True if flag present. Job Schedule: Job Specification: Job Manager Task Arguments
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '                                                        full debug logs.')
            fprintf('%s\n', 'For more specific examples, use: az find "az batch job-schedule reset"')
