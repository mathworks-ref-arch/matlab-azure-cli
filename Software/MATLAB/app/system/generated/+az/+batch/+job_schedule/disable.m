classdef disable < azure.AzureBase
    ...
    methods
        function this = disable()
            ...
            this.BaseCmd = 'az batch job-schedule disable ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az batch job-schedule disable"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az batch job-schedule disable"')
