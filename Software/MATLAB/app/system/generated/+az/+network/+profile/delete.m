classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az network profile delete : Delete a network profile.
            this.BaseCmd = 'az network profile delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network profile delete"')
