classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az network profile show : Get the details of a network profile.
            this.BaseCmd = 'az network profile show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --name -n           : The network profile name.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network profile show"')
