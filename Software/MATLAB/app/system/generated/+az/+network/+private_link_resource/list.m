classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az network private-link-resource list : List all private link resources.
            this.BaseCmd = 'az network private-link-resource list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network private-link-resource list -g MyResourceGroup -n MySA --type')
            fprintf('%s\n', '        Microsoft.Storage/storageAccounts')
            fprintf('%s\n', '    List all private link resources for a keyvault.')
            fprintf('%s\n', '        az network private-link-resource list -g MyResourceGroup -n MyKV --type')
            fprintf('%s\n', '        Microsoft.Keyvault/vaults')
            fprintf('%s\n', '    List all private link resources for an ACR.')
            fprintf('%s\n', '        az network private-link-resource list --id /subscriptions/00000000-0000-0000-0000-0000000000')
            fprintf('%s\n', '        00/resourceGroups/clitest.rg000001/providers/Microsoft.ContainerRegistry/registries/testreg0')
            fprintf('%s\n', '        00002')
            fprintf('%s\n', 'For more specific examples, use: az find "az network private-link-resource list"')
