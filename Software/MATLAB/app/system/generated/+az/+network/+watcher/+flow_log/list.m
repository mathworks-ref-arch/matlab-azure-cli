classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az network watcher flow-log list : List all flow log resources for the specified Network
            % Watcher.
            this.BaseCmd = 'az network watcher flow-log list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network watcher flow-log list"')
