classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            ...
            this.BaseCmd = 'az network watcher packet-capture show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '                               location=<location>`.')
            fprintf('%s\n', '    --name -n     [Required] : The name of the packet capture session.')
            fprintf('%s\n', 'Global Arguments')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network watcher packet-capture show"')
