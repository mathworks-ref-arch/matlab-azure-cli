classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az network watcher connection-monitor test-group show : Show a test group of a connection
            % monitor.
            % Command group 'network watcher connection-monitor test-group' is in preview. It may be
            % changed/removed in a future release.
            this.BaseCmd = 'az network watcher connection-monitor test-group show ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az network watcher connection-monitor test-group show"
