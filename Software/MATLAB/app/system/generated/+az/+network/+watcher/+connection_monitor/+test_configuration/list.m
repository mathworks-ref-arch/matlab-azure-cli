classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az network watcher connection-monitor test-configuration list : List all test configurations of
            ...
            this.BaseCmd = 'az network watcher connection-monitor test-configuration list ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az network watcher connection-monitor test- configuration list"
