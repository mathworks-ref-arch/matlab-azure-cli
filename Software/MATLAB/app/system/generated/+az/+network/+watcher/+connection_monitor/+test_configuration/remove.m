classdef remove < azure.AzureBase
    ...
    methods
        function this = remove()
            % az network watcher connection-monitor test-configuration remove : Remove a test configuration
            % from a connection monitor.
            ...
            this.BaseCmd = 'az network watcher connection-monitor test-configuration remove ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        MyConnectionMonitor --location westus --name MyTCPTestConfiguration')
            ...
            fprintf('%s\n', '        HTTPTestGroup DefaultTestGroup')
