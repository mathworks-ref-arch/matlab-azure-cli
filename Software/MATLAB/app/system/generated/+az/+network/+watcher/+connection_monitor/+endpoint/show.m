classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az network watcher connection-monitor endpoint show : Show an endpoint from a connection
            % monitor.
            % Command group 'network watcher connection-monitor endpoint' is in preview. It may be
            % changed/removed in a future release.
            this.BaseCmd = 'az network watcher connection-monitor endpoint show ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az network watcher connection-monitor endpoint show"
