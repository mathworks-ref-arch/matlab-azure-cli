classdef query < azure.AzureBase
    ...
    methods
        function this = query()
            % az network watcher connection-monitor query : Query a snapshot of the most recent connection
            % state of a connection monitor.
            this.BaseCmd = 'az network watcher connection-monitor query ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network watcher connection-monitor query"')
