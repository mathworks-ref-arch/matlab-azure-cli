classdef remove < azure.AzureBase
    ...
    methods
        function this = remove()
            % az network watcher connection-monitor output remove : Remove all outputs from a connection
            % monitor.
            % Command group 'network watcher connection-monitor output' is in preview. It may be
            % changed/removed in a future release.
            this.BaseCmd = 'az network watcher connection-monitor output remove ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az network watcher connection-monitor output remove"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network watcher connection-monitor output')
            fprintf('%s\n', 'remove"')
