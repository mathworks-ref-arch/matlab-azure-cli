classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az network nat gateway update : Update a NAT gateway.
            this.BaseCmd = 'az network nat gateway update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network nat gateway update"')
