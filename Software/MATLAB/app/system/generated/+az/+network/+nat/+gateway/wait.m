classdef wait < azure.AzureBase
    ...
    methods
        function this = wait()
            % az network nat gateway wait : Place the CLI in a waiting state until a condition of the NAT
            % gateway is met.
            this.BaseCmd = 'az network nat gateway wait ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az network nat gateway wait"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --name -n           : Name of the NAT gateway.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network nat gateway wait"')
