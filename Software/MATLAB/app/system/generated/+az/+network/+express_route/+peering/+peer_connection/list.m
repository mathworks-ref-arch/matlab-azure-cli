classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az network express-route peering peer-connection list : Gets all global reach peer connections
            % associated with a private peering in an express route circuit.
            % Command group 'network express-route peering peer-connection' is in preview. It may be
            % changed/removed in a future release.
            this.BaseCmd = 'az network express-route peering peer-connection list ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az network express-route peering peer-connection list"
