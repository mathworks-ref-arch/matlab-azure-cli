classdef list_arp_tables < azure.AzureBase

    % Copyright 2020, The MathWorks Inc.

    methods
        function this = list_arp_tables()
            % az network express-route list-arp-tables : Show the current Address Resolution Protocol (ARP)
            % table of an ExpressRoute circuit.
            this.BaseCmd = 'az network express-route list-arp-tables ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network express-route list-arp-tables"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class list_arp_tables 
