classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            ...
            this.BaseCmd = 'az network express-route peering connection delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network express-route peering connection delete --circuit-name MyCircuit --name')
            fprintf('%s\n', '        MyPeeringConnection --peering-name MyPeering --resource-group MyResourceGroup')
