classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az network express-route port update : Update settings of an ExpressRoute port.
            this.BaseCmd = 'az network express-route port update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network express-route port update --name MyExpressRoutePort --resource-group')
            fprintf('%s\n', '        MyResourceGroup')
            fprintf('%s\n', 'For more specific examples, use: az find "az network express-route port update"')
