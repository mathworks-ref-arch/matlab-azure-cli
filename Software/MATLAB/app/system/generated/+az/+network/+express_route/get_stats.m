classdef get_stats < azure.AzureBase

    % Copyright 2020, The MathWorks Inc.

    methods
        function this = get_stats()
            % az network express-route get-stats : Get the statistics of an ExpressRoute circuit.
            this.BaseCmd = 'az network express-route get-stats ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network express-route get-stats"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class get_stats 
