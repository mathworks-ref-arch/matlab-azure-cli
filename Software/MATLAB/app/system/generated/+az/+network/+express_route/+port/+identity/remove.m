classdef remove < azure.AzureBase
    ...
    methods
        function this = remove()
            % az network express-route port identity remove : Remove the managed service identity of an
            % ExpressRoute Port.
            this.BaseCmd = 'az network express-route port identity remove ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network express-route port identity remove"')
