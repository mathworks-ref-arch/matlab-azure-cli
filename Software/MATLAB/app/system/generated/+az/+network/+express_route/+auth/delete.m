classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            ...
            this.BaseCmd = 'az network express-route auth delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network express-route auth delete --circuit-name MyCircuit -g MyResourceGroup -n')
            fprintf('%s\n', '        MyAuthorization')
            fprintf('%s\n', 'For more specific examples, use: az find "az network express-route auth delete"')
