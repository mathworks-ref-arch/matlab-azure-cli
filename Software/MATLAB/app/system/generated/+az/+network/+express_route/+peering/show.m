classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            ...
            this.BaseCmd = 'az network express-route peering show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network express-route peering show -g MyResourceGroup --circuit-name MyCircuit -n')
            fprintf('%s\n', '        AzurePrivatePeering')
            fprintf('%s\n', 'For more specific examples, use: az find "az network express-route peering show"')
