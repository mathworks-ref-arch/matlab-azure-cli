classdef wait < azure.AzureBase
    ...
    methods
        function this = wait()
            % az network nic wait : Place the CLI in a waiting state until a condition of the network
            % interface is met.
            this.BaseCmd = 'az network nic wait ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network nic wait"')
