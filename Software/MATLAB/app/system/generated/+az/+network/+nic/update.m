classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            ...
            this.BaseCmd = 'az network nic update ';
        end
        ...
        function this = no_wait(this, varargin)
            % Do not wait for the long-running operation to finish. DNS Arguments
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'DNS Arguments')
            fprintf('%s\n', '    --dns-servers            : Space-separated list of DNS server IP addresses. Use "" to revert to')
            ...
            fprintf('%s\n', '        az network nic update --accelerated-networking true --name MyNic --resource-group')
            fprintf('%s\n', '        MyResourceGroup')
            fprintf('%s\n', 'For more specific examples, use: az find "az network nic update"')
