classdef remove < azure.AzureBase
    ...
    methods
        function this = remove()
            % az network nic ip-config inbound-nat-rule remove : Remove an inbound NAT rule of an IP
            % configuration.
            this.BaseCmd = 'az network nic ip-config inbound-nat-rule remove ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network nic ip-config inbound-nat-rule remove --inbound-nat-rule MyNatRule --ip-config-')
            fprintf('%s\n', '        name MyIpConfig --lb-name MyLb --nic-name MyNic --resource-group MyResourceGroup')
            fprintf('%s\n', 'For more specific examples, use: az find "az network nic ip-config inbound-nat-rule remove"')
