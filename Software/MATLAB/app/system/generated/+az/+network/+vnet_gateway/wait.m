classdef wait < azure.AzureBase
    ...
    methods
        function this = wait()
            % az network vnet-gateway wait : Place the CLI in a waiting state until a condition of the virtual
            % network gateway is met.
            this.BaseCmd = 'az network vnet-gateway wait ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network vnet-gateway wait"')
