classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az network vnet-gateway ipsec-policy list : List IPSec policies associated with a virtual
            % network gateway.
            this.BaseCmd = 'az network vnet-gateway ipsec-policy list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network vnet-gateway ipsec-policy list"')
