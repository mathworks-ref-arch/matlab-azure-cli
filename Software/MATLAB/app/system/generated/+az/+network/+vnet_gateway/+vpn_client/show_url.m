classdef show_url < azure.AzureBase

    % Copyright 2020, The MathWorks Inc.

    methods
        function this = show_url()
            ...
            this.BaseCmd = 'az network vnet-gateway vpn-client show-url ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network vnet-gateway vpn-client show-url"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class show_url 
