classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            ...
            this.BaseCmd = 'az network vnet-gateway root-cert create ';
        end
        ...
        function this = public_cert_data(this, varargin)
            % Base64 contents of the root certificate file or file path.
            this.Options = [this.Options, '--public-cert-data', varargin{:}];
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --public-cert-data  [Required] : Base64 contents of the root certificate file or file path.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network vnet-gateway root-cert create"')
