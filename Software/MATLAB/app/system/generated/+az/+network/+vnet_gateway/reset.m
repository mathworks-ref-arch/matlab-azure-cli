classdef reset < azure.AzureBase
    ...
    methods
        function this = reset()
            ...
            this.BaseCmd = 'az network vnet-gateway reset ';
        end
        function this = gateway_vip(this, varargin)
            % Virtual network gateway vip address supplied to the begin reset of the active-active feature enabled gateway.
            this.Options = [this.Options, '--gateway-vip', varargin{:}];
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    az network vnet-gateway reset : Reset a virtual network gateway.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --gateway-vip       : Virtual network gateway vip address supplied to the begin reset of the')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network vnet-gateway reset"')
