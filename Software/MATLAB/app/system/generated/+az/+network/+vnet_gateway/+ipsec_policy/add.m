classdef add < azure.AzureBase
    ...
    methods
        function this = add()
            ...
            % Set all IPsec policies of a virtual network gateway. If you want to set any IPsec policy,
            % you must set them all.
            this.BaseCmd = 'az network vnet-gateway ipsec-policy add ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        102400000')
            fprintf('%s\n', 'For more specific examples, use: az find "az network vnet-gateway ipsec-policy add"')
