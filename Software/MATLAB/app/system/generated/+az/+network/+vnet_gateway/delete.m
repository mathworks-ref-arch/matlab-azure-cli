classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            ...
            % In order to delete a Virtual Network Gateway, you must first delete ALL Connection objects
            % in Azure that are
            % connected to the Gateway. After deleting the Gateway, proceed to delete other resources now
            % not in use.
            ...
            this.BaseCmd = 'az network vnet-gateway delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network vnet-gateway delete"')
