classdef clear < azure.AzureBase
    ...
    methods
        function this = clear()
            % az network vnet-gateway ipsec-policy clear : Delete all IPsec policies on a virtual network
            % gateway.
            this.BaseCmd = 'az network vnet-gateway ipsec-policy clear ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network vnet-gateway ipsec-policy clear"')
