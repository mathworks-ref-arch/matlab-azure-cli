classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az network private-link-service connection delete : Delete a private link service endpoint
            % connection.
            this.BaseCmd = 'az network private-link-service connection delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network private-link-service connection delete --name MyPrivateEndpointConnection')
            fprintf('%s\n', '        --resource-group MyResourceGroup --service-name MyService')
            fprintf('%s\n', 'For more specific examples, use: az find "az network private-link-service connection delete"')
