classdef list_service_tags < azure.AzureBase

    % Copyright 2020, The MathWorks Inc.

    methods
        function this = list_service_tags()
            ...
            % security rule creation. To learn more about list-service-tags, visit
            % https://docs.microsoft.com/en-us/azure/virtual-network/security-overview#service-tags.
            this.BaseCmd = 'az network list-service-tags ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network list-service-tags"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class list_service_tags 
