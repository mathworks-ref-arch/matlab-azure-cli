classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az network route-table update : Update a route table.
            this.BaseCmd = 'az network route-table update ';
        end
        function this = disable_bgp_route_propagation(this, varargin)
            % Disable routes learned by BGP.  Allowed values: false, true.
            this.Options = [this.Options, '--disable-bgp-route-propagation', varargin{:}];
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    az network route-table update : Update a route table.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --disable-bgp-route-propagation : Disable routes learned by BGP.  Allowed values: false, true.')
            ...
            fprintf('%s\n', '                                      ''Resource Id'' arguments.')
            fprintf('%s\n', '    --name -n                       : Name of the route table.')
            ...
            fprintf('%s\n', '        az network route-table update -g MyResourceGroup -n MyRouteTable --disable-bgp-route-')
            fprintf('%s\n', '        propagation true')
            fprintf('%s\n', 'For more specific examples, use: az find "az network route-table update"')
