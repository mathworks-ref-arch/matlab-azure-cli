classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            ...
            this.BaseCmd = 'az network route-table route show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network route-table route show -g MyResourceGroup --route-table-name MyRouteTable -n')
            fprintf('%s\n', '        MyRoute -o table')
            fprintf('%s\n', 'For more specific examples, use: az find "az network route-table route show"')
