classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            ...
            this.BaseCmd = 'az network route-table route update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --next-hop-type       : The type of Azure hop the packet should be sent to.  Allowed values:')
            ...
            fprintf('%s\n', '        az network route-table route update -g MyResourceGroup --route-table-name MyRouteTable \ -n')
            fprintf('%s\n', '        MyRoute --next-hop-ip-address 10.0.100.5')
            fprintf('%s\n', '    Update a route in a route table. (autogenerated)')
            fprintf('%s\n', '        az network route-table route update --address-prefix 10.0.0.0/16 --name MyRoute --next-hop-')
            fprintf('%s\n', '        ip-address 10.0.100.5 --next-hop-type VirtualNetworkGateway --route-table-name MyRouteTable')
            fprintf('%s\n', 'For more specific examples, use: az find "az network route-table route update"')
