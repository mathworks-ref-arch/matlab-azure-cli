classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            ...
            this.BaseCmd = 'az network route-table route delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network route-table route delete -g MyResourceGroup --route-table-name MyRouteTable -n')
            fprintf('%s\n', '        MyRoute')
            fprintf('%s\n', 'For more specific examples, use: az find "az network route-table route delete"')
