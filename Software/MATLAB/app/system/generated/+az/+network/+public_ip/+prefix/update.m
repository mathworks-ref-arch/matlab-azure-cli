classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az network public-ip prefix update : Update a public IP prefix resource.
            this.BaseCmd = 'az network public-ip prefix update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --name -n           : The name of the public IP prefix.')
            ...
            fprintf('%s\n', '        az network public-ip prefix update --name MyPublicIPPrefix --resource-group MyResourceGroup')
            fprintf('%s\n', '        --set useRemoteGateways=true')
            fprintf('%s\n', 'For more specific examples, use: az find "az network public-ip prefix update"')
