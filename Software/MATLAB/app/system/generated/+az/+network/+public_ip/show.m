classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            ...
            this.BaseCmd = 'az network public-ip show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network public-ip show -g MyResourceGroup -n MyIp --query "{fqdn: dnsSettings.fqdn,')
            fprintf('%s\n', '        address: ipAddress}"')
            fprintf('%s\n', 'For more specific examples, use: az find "az network public-ip show"')
