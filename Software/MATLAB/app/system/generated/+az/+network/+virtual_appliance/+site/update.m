classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az network virtual-appliance site update : Update an Azure network virtual appliance site.
            % Command group 'network virtual-appliance site' is in preview. It may be changed/removed
            % in a future release.
            this.BaseCmd = 'az network virtual-appliance site update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network virtual-appliance site update -n MyName -g MyRG --appliance-name MyAppliance')
            fprintf('%s\n', '        --address-prefix 10.0.0.0/24 --allow false --default false --optimize false')
            fprintf('%s\n', 'For more specific examples, use: az find "az network virtual-appliance site update"')
