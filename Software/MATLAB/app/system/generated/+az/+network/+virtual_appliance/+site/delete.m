classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az network virtual-appliance site delete : Delete an Azure network virtual appliance site.
            % Command group 'network virtual-appliance site' is in preview. It may be changed/removed
            % in a future release.
            this.BaseCmd = 'az network virtual-appliance site delete ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az network virtual-appliance site delete"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network virtual-appliance site delete"')
