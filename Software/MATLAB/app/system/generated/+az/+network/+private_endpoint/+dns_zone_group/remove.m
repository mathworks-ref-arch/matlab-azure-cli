classdef remove < azure.AzureBase
    ...
    methods
        function this = remove()
            % az network private-endpoint dns-zone-group remove : Remove a private endpoint dns zone into a
            % dns zone group.
            this.BaseCmd = 'az network private-endpoint dns-zone-group remove ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network private-endpoint dns-zone-group remove --endpoint-name MyPE -g MyRG -n')
            fprintf('%s\n', '        MyZoneGroup --zone-name Zone1')
            fprintf('%s\n', 'For more specific examples, use: az find "az network private-endpoint dns-zone-group remove"')
