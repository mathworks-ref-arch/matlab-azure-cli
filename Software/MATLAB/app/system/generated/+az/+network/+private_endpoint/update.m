classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az network private-endpoint update : Update a private endpoint.
            this.BaseCmd = 'az network private-endpoint update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    az network private-endpoint update : Update a private endpoint.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --request-message   : A message passed to the owner of the remote resource with this connection')
            ...
            fprintf('%s\n', '        az network private-endpoint update -g MyResourceGroup -n MyPE --request-message "test"')
            fprintf('%s\n', '        --tags mytag=hello')
            fprintf('%s\n', '    Update a private endpoint. (autogenerated)')
            fprintf('%s\n', '        az network private-endpoint update --name MyPE --resource-group MyResourceGroup --set')
            fprintf('%s\n', '        useRemoteGateways=true')
            fprintf('%s\n', 'For more specific examples, use: az find "az network private-endpoint update"')
