classdef add < azure.AzureBase
    ...
    methods
        function this = add()
            % az network private-endpoint dns-zone-group add : Add a private endpoint dns zone into a dns zone
            % group.
            this.BaseCmd = 'az network private-endpoint dns-zone-group add ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network private-endpoint dns-zone-group add --endpoint-name MyPE -g MyRG -n MyZoneGroup')
            fprintf('%s\n', '        --zone-name Zone1 --private-dns-zone PrivateDNSZone1')
            fprintf('%s\n', 'For more specific examples, use: az find "az network private-endpoint dns-zone-group add"')
