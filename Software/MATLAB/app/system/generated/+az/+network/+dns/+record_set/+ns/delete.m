classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az network dns record-set ns delete : Delete an NS record set and all associated records.
            this.BaseCmd = 'az network dns record-set ns delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network dns record-set ns delete --name MyRecordSet --resource-group MyResourceGroup')
            fprintf('%s\n', '        --subscription MySubscription --yes --zone-name www.mysite.com')
            fprintf('%s\n', 'For more specific examples, use: az find "az network dns record-set ns delete"')
