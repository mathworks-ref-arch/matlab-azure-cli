classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            % az network dns record-set mx create : Create an empty MX record set.
            this.BaseCmd = 'az network dns record-set mx create ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network dns record-set mx create --name MyRecordSet --resource-group MyResourceGroup')
            fprintf('%s\n', '        --ttl 30 --zone-name www.mysite.com')
            fprintf('%s\n', 'For more specific examples, use: az find "az network dns record-set mx create"')
