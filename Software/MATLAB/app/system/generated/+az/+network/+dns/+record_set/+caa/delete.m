classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az network dns record-set caa delete : Delete a CAA record set and all associated records.
            this.BaseCmd = 'az network dns record-set caa delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    Delete a CAA record set and all associated records. (autogenerated)')
            fprintf('%s\n', '        az network dns record-set caa delete --name MyRecordSet --resource-group MyResourceGroup')
            fprintf('%s\n', '        --subscription MySubscription --zone-name www.mysite.com')
            fprintf('%s\n', 'For more specific examples, use: az find "az network dns record-set caa delete"')
