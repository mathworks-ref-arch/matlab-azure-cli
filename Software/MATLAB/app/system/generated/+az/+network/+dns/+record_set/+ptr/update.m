classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az network dns record-set ptr update : Update a PTR record set.
            this.BaseCmd = 'az network dns record-set ptr update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network dns record-set ptr update"')
