classdef import < azure.AzureBase
    ...
    methods
        function this = import()
            ...
            this.BaseCmd = 'az network dns zone import ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    az network dns zone import : Create a DNS zone using a DNS zone file.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --file-name -f      [Required] : Path to the DNS zone file to import.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network dns zone import"')
