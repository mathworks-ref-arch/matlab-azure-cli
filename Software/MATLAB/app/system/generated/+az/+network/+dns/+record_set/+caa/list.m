classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az network dns record-set caa list : List all CAA record sets in a zone.
            this.BaseCmd = 'az network dns record-set caa list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network dns record-set caa list"')
