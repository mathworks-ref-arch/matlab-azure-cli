classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            % az network dns record-set srv create : Create an empty SRV record set.
            this.BaseCmd = 'az network dns record-set srv create ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network dns record-set srv create --metadata owner=WebTeam --name MyRecordSet --resource-')
            fprintf('%s\n', '        group MyResourceGroup --ttl 30 --zone-name www.mysite.com')
            fprintf('%s\n', 'For more specific examples, use: az find "az network dns record-set srv create"')
