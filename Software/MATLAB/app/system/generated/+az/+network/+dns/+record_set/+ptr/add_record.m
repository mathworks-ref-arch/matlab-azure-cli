classdef add_record < azure.AzureBase
    ...
    methods
        function this = add_record()
            % az network dns record-set ptr add-record : Add a PTR record.
            this.BaseCmd = 'az network dns record-set ptr add-record ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network dns record-set ptr add-record"')
