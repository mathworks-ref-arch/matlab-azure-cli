classdef set_record < azure.AzureBase
    ...
    methods
        function this = set_record()
            ...
            this.BaseCmd = 'az network dns record-set cname set-record ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    az network dns record-set cname set-record : Set the value of a CNAME record.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --cname -c           [Required] : Value of the cname record-set. It should be Canonical name.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network dns record-set cname set-record"')
