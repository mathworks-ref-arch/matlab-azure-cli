classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az network dns record-set ptr delete : Delete a PTR record set and all associated records.
            this.BaseCmd = 'az network dns record-set ptr delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network dns record-set ptr delete"')
