classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            ...
            this.BaseCmd = 'az network dns record-set a delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network dns record-set a delete -g MyResourceGroup -z www.mysite.com -n MyRecordSet')
            fprintf('%s\n', 'For more specific examples, use: az find "az network dns record-set a delete"')
