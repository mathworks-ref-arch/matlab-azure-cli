classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az network dns record-set srv update : Update an SRV record set.
            this.BaseCmd = 'az network dns record-set srv update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network dns record-set srv update"')
