classdef remove_record < azure.AzureBase
    ...
    methods
        function this = remove_record()
            % az network dns record-set ns remove-record : Remove an NS record from its record set.
            ...
            this.BaseCmd = 'az network dns record-set ns remove-record ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network dns record-set ns remove-record --keep-empty-record-set --nsdname ns.mysite.com')
            fprintf('%s\n', '        --record-set-name MyRecordSet --resource-group MyResourceGroup --subscription MySubscription')
            fprintf('%s\n', '        --zone-name www.mysite.com')
            fprintf('%s\n', 'For more specific examples, use: az find "az network dns record-set ns remove-record"')
