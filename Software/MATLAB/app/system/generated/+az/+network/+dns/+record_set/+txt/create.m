classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            % az network dns record-set txt create : Create an empty TXT record set.
            this.BaseCmd = 'az network dns record-set txt create ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network dns record-set txt create -g MyResourceGroup -z www.mysite.com -n MyRecordSet')
            fprintf('%s\n', '    Create an empty TXT record set. (autogenerated)')
            fprintf('%s\n', '        az network dns record-set txt create --name MyRecordSet --resource-group MyResourceGroup')
            fprintf('%s\n', '        --ttl 30 --zone-name www.mysite.com')
            fprintf('%s\n', 'For more specific examples, use: az find "az network dns record-set txt create"')
