classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az network dns record-set a show : Get the details of an A record set.
            this.BaseCmd = 'az network dns record-set a show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network dns record-set a show"')
