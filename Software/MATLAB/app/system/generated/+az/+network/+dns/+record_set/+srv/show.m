classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az network dns record-set srv show : Get the details of an SRV record set.
            this.BaseCmd = 'az network dns record-set srv show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network dns record-set srv show"')
