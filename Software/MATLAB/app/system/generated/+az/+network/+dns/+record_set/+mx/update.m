classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az network dns record-set mx update : Update an MX record set.
            this.BaseCmd = 'az network dns record-set mx update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network dns record-set mx update --name MyRecordSet --resource-group MyResourceGroup')
            fprintf('%s\n', '        --set tags.CostCenter=MyBusinessGroup --zone-name www.mysite.com')
            fprintf('%s\n', 'For more specific examples, use: az find "az network dns record-set mx update"')
