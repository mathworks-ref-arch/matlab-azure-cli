classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            % az network dns record-set ptr create : Create an empty PTR record set.
            this.BaseCmd = 'az network dns record-set ptr create ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network dns record-set ptr create"')
