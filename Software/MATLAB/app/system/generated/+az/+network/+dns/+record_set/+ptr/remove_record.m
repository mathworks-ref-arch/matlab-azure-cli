classdef remove_record < azure.AzureBase
    ...
    methods
        function this = remove_record()
            % az network dns record-set ptr remove-record : Remove a PTR record from its record set.
            ...
            this.BaseCmd = 'az network dns record-set ptr remove-record ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network dns record-set ptr remove-record"')
