classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            % az network dns record-set caa create : Create an empty CAA record set.
            this.BaseCmd = 'az network dns record-set caa create ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    Create an empty CAA record set. (autogenerated)')
            fprintf('%s\n', '        az network dns record-set caa create --name MyRecordSet --resource-group MyResourceGroup')
            fprintf('%s\n', '        --subscription MySubscription --zone-name www.mysite.com')
            fprintf('%s\n', 'For more specific examples, use: az find "az network dns record-set caa create"')
