classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            % az network dns record-set aaaa create : Create an empty AAAA record set.
            this.BaseCmd = 'az network dns record-set aaaa create ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network dns record-set aaaa create -g MyResourceGroup -z www.mysite.com -n MyRecordSet')
            fprintf('%s\n', 'For more specific examples, use: az find "az network dns record-set aaaa create"')
