classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az network dns record-set soa update : Update properties of an SOA record.
            this.BaseCmd = 'az network dns record-set soa update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --minimum-ttl -m               : Minimum TTL (time-to-live, seconds).  Default: 3600.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network dns record-set soa update"')
