classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az network dns record-set list : List all record sets within a DNS zone.
            this.BaseCmd = 'az network dns record-set list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network dns record-set list"')
