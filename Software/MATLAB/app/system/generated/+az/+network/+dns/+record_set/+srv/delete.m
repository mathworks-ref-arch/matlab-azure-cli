classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az network dns record-set srv delete : Delete an SRV record set and all associated records.
            this.BaseCmd = 'az network dns record-set srv delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network dns record-set srv delete"')
