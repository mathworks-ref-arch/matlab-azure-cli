classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az network private-endpoint-connection delete : Delete a private endpoint connection.
            this.BaseCmd = 'az network private-endpoint-connection delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network private-endpoint-connection delete -g MyResourceGroup -n MyPrivateEndpoint')
            ...
            fprintf('%s\n', '        az network private-endpoint-connection delete --id /subscriptions/00000000-0000-0000-0000-00')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network private-endpoint-connection delete"')
