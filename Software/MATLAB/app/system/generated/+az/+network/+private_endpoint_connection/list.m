classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az network private-endpoint-connection list : List all private endpoint connections.
            this.BaseCmd = 'az network private-endpoint-connection list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network private-endpoint-connection list -g MyResourceGroup -n MySA --type')
            fprintf('%s\n', '        Microsoft.Storage/storageAccounts')
            fprintf('%s\n', '    List all private endpoint connections for a keyvault.')
            fprintf('%s\n', '        az network private-endpoint-connection list -g MyResourceGroup -n MyKV --type')
            fprintf('%s\n', '        Microsoft.Keyvault/vaults')
            fprintf('%s\n', '    List all private endpoint connections for an ACR.')
            fprintf('%s\n', '        az network private-endpoint-connection list --id /subscriptions/00000000-0000-0000-0000-0000')
            fprintf('%s\n', '        00000000/resourceGroups/clitest.rg000001/providers/Microsoft.ContainerRegistry/registries/te')
            fprintf('%s\n', '        streg000002')
            fprintf('%s\n', 'For more specific examples, use: az find "az network private-endpoint-connection list"')
