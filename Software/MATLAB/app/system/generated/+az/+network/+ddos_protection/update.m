classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az network ddos-protection update : Update a DDoS protection plan.
            this.BaseCmd = 'az network ddos-protection update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network ddos-protection update --name MyDdosPlan --remove tags.no_80 --resource-group')
            fprintf('%s\n', '        MyResourceGroup')
            fprintf('%s\n', 'For more specific examples, use: az find "az network ddos-protection update"')
