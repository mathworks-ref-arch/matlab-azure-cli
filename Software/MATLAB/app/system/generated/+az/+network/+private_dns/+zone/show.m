classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az network private-dns zone show : Get a Private DNS zone.
            this.BaseCmd = 'az network private-dns zone show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network private-dns zone show"')
