classdef remove_record < azure.AzureBase
    ...
    methods
        function this = remove_record()
            % az network private-dns record-set ptr remove-record : Remove a PTR record from its record set.
            ...
            this.BaseCmd = 'az network private-dns record-set ptr remove-record ';
        end
        function this = ptrdname(this, varargin)
            % PTR target domain name.
            this.Options = [this.Options, '--ptrdname', varargin{:}];
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        empty record set, include --keep-empty-record-set.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --ptrdname -d        [Required] : PTR target domain name.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network private-dns record-set ptr remove-')
            fprintf('%s\n', 'record"')
