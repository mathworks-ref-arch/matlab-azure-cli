classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az network private-dns record-set cname update : Update a CNAME record set.
            this.BaseCmd = 'az network private-dns record-set cname update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network private-dns record-set cname update"')
