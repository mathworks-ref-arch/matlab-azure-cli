classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az network private-dns link vnet show : Get a virtual network link to the specified Private DNS
            % zone.
            this.BaseCmd = 'az network private-dns link vnet show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network private-dns link vnet show"')
