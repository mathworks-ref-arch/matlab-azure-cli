classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az network private-dns record-set soa show : Get the details of an SOA record.
            this.BaseCmd = 'az network private-dns record-set soa show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network private-dns record-set soa show"')
