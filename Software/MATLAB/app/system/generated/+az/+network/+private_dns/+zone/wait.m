classdef wait < azure.AzureBase
    ...
    methods
        function this = wait()
            % az network private-dns zone wait : Place the CLI in a waiting state until a condition of the
            % Private DNS zone is met.
            this.BaseCmd = 'az network private-dns zone wait ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network private-dns zone wait"')
