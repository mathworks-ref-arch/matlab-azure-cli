classdef wait < azure.AzureBase
    ...
    methods
        function this = wait()
            % az network private-dns link vnet wait : Place the CLI in a waiting state until a condition of
            % the virtual network link to the specified Private DNS zone is met.
            this.BaseCmd = 'az network private-dns link vnet wait ';
        end
        ...
        function this = zone_name(this, varargin)
            % The name of the Private DNS zone. Wait Condition Arguments
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'Examples')
            fprintf('%s\n', '    Pause executing next line of CLI script until the virtual network link to the specified Private')
            fprintf('%s\n', '    DNS zone is successfully provisioned.')
            fprintf('%s\n', '        az network private-dns link vnet wait -g MyResourceGroup -n MyLinkName -z www.mysite.com')
            fprintf('%s\n', '        --created')
            fprintf('%s\n', 'For more specific examples, use: az find "az network private-dns link vnet wait"')
