classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az network private-dns record-set list : List all record sets within a Private DNS zone.
            this.BaseCmd = 'az network private-dns record-set list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '            --query "[?name==''@'']"')
            fprintf('%s\n', 'For more specific examples, use: az find "az network private-dns record-set list"')
