classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az network private-dns zone update : Update a Private DNS zone's properties. Does not modify
            % Private DNS records or virtual network links within the zone.
            this.BaseCmd = 'az network private-dns zone update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --tags                         : Resource tags for the Private DNS zone.')
            ...
            fprintf('%s\n', '        az network private-dns zone update -g MyResourceGroup -n www.mysite.com --tags')
            fprintf('%s\n', '        CostCenter=Marketing')
            fprintf('%s\n', 'For more specific examples, use: az find "az network private-dns zone update"')
