classdef add_record < azure.AzureBase
    ...
    methods
        function this = add_record()
            % az network private-dns record-set mx add-record : Add an MX record.
            this.BaseCmd = 'az network private-dns record-set mx add-record ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network private-dns record-set mx add-record"')
