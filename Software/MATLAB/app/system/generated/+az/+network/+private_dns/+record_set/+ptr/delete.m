classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az network private-dns record-set ptr delete : Delete a PTR record set and all associated
            % records.
            this.BaseCmd = 'az network private-dns record-set ptr delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network private-dns record-set ptr delete -g MyResourceGroup -z www.mysite.com -n')
            fprintf('%s\n', '        MyRecordSet')
            fprintf('%s\n', 'For more specific examples, use: az find "az network private-dns record-set ptr delete"')
