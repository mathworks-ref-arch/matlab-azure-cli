classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            % az network private-dns record-set srv create : Create an empty SRV record set.
            this.BaseCmd = 'az network private-dns record-set srv create ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network private-dns record-set srv create --name MyRecordSet --resource-group')
            fprintf('%s\n', '        MyResourceGroup --ttl 300 --zone-name www.mysite.com')
            fprintf('%s\n', 'For more specific examples, use: az find "az network private-dns record-set srv create"')
