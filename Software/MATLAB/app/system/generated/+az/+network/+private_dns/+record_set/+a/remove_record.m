classdef remove_record < azure.AzureBase
    ...
    methods
        function this = remove_record()
            % az network private-dns record-set a remove-record : Remove an A record from its record set.
            ...
            this.BaseCmd = 'az network private-dns record-set a remove-record ';
        end
        function this = ipv4_address(this, varargin)
            % IPV4 address in string notation.
            this.Options = [this.Options, '--ipv4-address', varargin{:}];
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        empty record set, include --keep-empty-record-set.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --ipv4-address -a    [Required] : IPV4 address in string notation.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network private-dns record-set a remove-record"')
