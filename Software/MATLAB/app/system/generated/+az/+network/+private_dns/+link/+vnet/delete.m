classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az network private-dns link vnet delete : Delete a virtual network link to the specified Private
            % DNS zone.
            % In case of a registration virtual network, all auto-registered DNS records in the zone for
            % the virtual network will also be deleted. This operation cannot be undone.
            this.BaseCmd = 'az network private-dns link vnet delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '                                     Omit this value to always delete the current zone. Specify the')
            fprintf('%s\n', '                                     last-seen ETag value to prevent accidentally deleting any')
            fprintf('%s\n', '                                     concurrent changes.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network private-dns link vnet delete"')
