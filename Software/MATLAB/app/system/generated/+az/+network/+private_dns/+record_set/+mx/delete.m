classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az network private-dns record-set mx delete : Delete an MX record set and all associated
            % records.
            this.BaseCmd = 'az network private-dns record-set mx delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network private-dns record-set mx delete -g MyResourceGroup -z www.mysite.com -n')
            fprintf('%s\n', '        MyRecordSet')
            fprintf('%s\n', 'For more specific examples, use: az find "az network private-dns record-set mx delete"')
