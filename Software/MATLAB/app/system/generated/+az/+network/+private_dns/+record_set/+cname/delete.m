classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az network private-dns record-set cname delete : Delete a CNAME record set and its associated
            % record.
            this.BaseCmd = 'az network private-dns record-set cname delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network private-dns record-set cname delete -g MyResourceGroup -z www.mysite.com -n')
            fprintf('%s\n', '        MyRecordSet')
            fprintf('%s\n', '    Delete a CNAME record set and its associated record. (autogenerated)')
            fprintf('%s\n', '        az network private-dns record-set cname delete --name MyRecordSet --resource-group')
            fprintf('%s\n', '        MyResourceGroup --subscription MySubscription --yes --zone-name www.mysite.com')
            fprintf('%s\n', 'For more specific examples, use: az find "az network private-dns record-set cname delete"')
