classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az network private-dns record-set txt list : List all TXT record sets in a zone.
            this.BaseCmd = 'az network private-dns record-set txt list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network private-dns record-set txt list"')
