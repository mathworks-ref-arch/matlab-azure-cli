classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az network private-dns record-set a update : Update an A record set.
            this.BaseCmd = 'az network private-dns record-set a update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network private-dns record-set a update --name MyRecordSet --resource-group')
            fprintf('%s\n', '        MyResourceGroup --set useRemoteGateways=true --subscription MySubscription --zone-name')
            fprintf('%s\n', '        www.mysite.com')
            fprintf('%s\n', 'For more specific examples, use: az find "az network private-dns record-set a update"')
