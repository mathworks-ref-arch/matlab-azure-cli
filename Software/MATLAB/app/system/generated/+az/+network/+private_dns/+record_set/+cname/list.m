classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az network private-dns record-set cname list : List the CNAME record set in a zone.
            this.BaseCmd = 'az network private-dns record-set cname list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network private-dns record-set cname list"')
