classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az network private-dns record-set srv show : Get the details of an SRV record set.
            this.BaseCmd = 'az network private-dns record-set srv show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network private-dns record-set srv show -g MyResourceGroup -z www.mysite.com -n')
            fprintf('%s\n', '        MyRecordSet')
            fprintf('%s\n', 'For more specific examples, use: az find "az network private-dns record-set srv show"')
