classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            % az network private-dns record-set a create : Create an empty A record set.
            this.BaseCmd = 'az network private-dns record-set a create ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network private-dns record-set a create -g MyResourceGroup -z www.mysite.com -n')
            fprintf('%s\n', '        MyRecordSet')
            fprintf('%s\n', 'For more specific examples, use: az find "az network private-dns record-set a create"')
