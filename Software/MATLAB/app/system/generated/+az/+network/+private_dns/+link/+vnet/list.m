classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az network private-dns link vnet list : List the virtual network links to the specified Private
            % DNS zone.
            this.BaseCmd = 'az network private-dns link vnet list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --top                          : The maximum number of virtual network links to return. If not')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network private-dns link vnet list"')
