classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            ...
            this.BaseCmd = 'az network lb address-pool delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --name -n           [Required] : The name of the backend address pool. If only one exists, omit')
            fprintf('%s\n', '                                     to use as default.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network lb address-pool delete"')
