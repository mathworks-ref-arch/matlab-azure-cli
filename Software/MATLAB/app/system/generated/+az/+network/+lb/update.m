classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            ...
            % This command can only be used to update the tags for a load balancer. Name and resource
            % group are immutable and cannot be updated.
            this.BaseCmd = 'az network lb update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network lb update"')
