classdef remove < azure.AzureBase
    ...
    methods
        function this = remove()
            % az network lb address-pool address remove : Remove one backend address from the load balance
            % backend address pool.
            % Command group 'network lb address-pool address' is in preview. It may be
            % changed/removed in a future release.
            this.BaseCmd = 'az network lb address-pool address remove ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network lb address-pool address remove -g MyResourceGroup --lb-name MyLb --pool-name')
            fprintf('%s\n', '        MyAddressPool -n MyAddress')
            fprintf('%s\n', 'For more specific examples, use: az find "az network lb address-pool address remove"')
