classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az network application-gateway waf-policy custom-rule list : List application gateway WAF policy
            % custom rules.
            this.BaseCmd = 'az network application-gateway waf-policy custom-rule list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network application-gateway waf-policy custom-rule list --policy-name MyPolicy')
