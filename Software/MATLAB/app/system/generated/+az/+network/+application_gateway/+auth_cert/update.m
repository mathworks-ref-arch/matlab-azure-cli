classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            ...
            this.BaseCmd = 'az network application-gateway auth-cert update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --name -n              : The name of the authentication certificate.')
            ...
            fprintf('%s\n', '        az network application-gateway auth-cert update -g MyResourceGroup --gateway-name')
            fprintf('%s\n', '        MyAppGateway \ -n MyAuthCert --cert-file /path/to/new/cert/file')
            fprintf('%s\n', 'For more specific examples, use: az find "az network application-gateway auth-cert update"')
