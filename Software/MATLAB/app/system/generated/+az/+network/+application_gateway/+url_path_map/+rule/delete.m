classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            ...
            this.BaseCmd = 'az network application-gateway url-path-map rule delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --name -n           : The name of the url-path-map rule.')
            fprintf('%s\n', '    --path-map-name     : The name of the URL path map.')
            ...
            fprintf('%s\n', '        az network application-gateway url-path-map rule delete -g MyResourceGroup --gateway-name')
            fprintf('%s\n', '        MyAppGateway \')
