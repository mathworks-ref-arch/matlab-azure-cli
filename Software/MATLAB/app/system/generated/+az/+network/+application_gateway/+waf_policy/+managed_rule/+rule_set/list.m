classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az network application-gateway waf-policy managed-rule rule-set list : List all managed rule
            % set.
            this.BaseCmd = 'az network application-gateway waf-policy managed-rule rule-set list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network application-gateway waf-policy managed-rule rule-set list --policy-name MyPolicy')
