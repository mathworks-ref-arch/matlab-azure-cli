classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az network application-gateway rewrite-rule list : List rewrite rules.
            this.BaseCmd = 'az network application-gateway rewrite-rule list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network application-gateway rewrite-rule list --gateway-name MyGateway --resource-group')
            fprintf('%s\n', '        MyResourceGroup --rule-set-name MyRuleSet')
