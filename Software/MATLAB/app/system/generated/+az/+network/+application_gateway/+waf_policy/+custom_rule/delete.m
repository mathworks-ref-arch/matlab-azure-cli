classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            ...
            % policy custom rule.
            this.BaseCmd = 'az network application-gateway waf-policy custom-rule delete ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az network application-gateway waf-policy custom-rule delete"
