classdef wait < azure.AzureBase
    ...
    methods
        function this = wait()
            % az network application-gateway waf-policy wait : Place the CLI in a waiting state until a
            % condition of the application gateway WAF policy is met.
            this.BaseCmd = 'az network application-gateway waf-policy wait ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az network application-gateway waf-policy wait"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network application-gateway waf-policy wait"')
