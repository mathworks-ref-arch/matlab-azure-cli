classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            ...
            this.BaseCmd = 'az network application-gateway frontend-ip list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network application-gateway frontend-ip list -g MyResourceGroup --gateway-name')
            fprintf('%s\n', '        MyAppGateway')
            fprintf('%s\n', 'For more specific examples, use: az find "az network application-gateway frontend-ip list"')
