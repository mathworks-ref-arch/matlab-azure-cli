classdef remove < azure.AzureBase
    ...
    methods
        function this = remove()
            % az network application-gateway private-link remove : Remove a Private Link and clear association
            % with Frontend IP. The subnet associate with a Private Link might need to clear manually.
            % Command group 'network application-gateway private-link' is in preview. It may be
            % changed/removed in a future release.
            this.BaseCmd = 'az network application-gateway private-link remove ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az network application-gateway private-link remove"
