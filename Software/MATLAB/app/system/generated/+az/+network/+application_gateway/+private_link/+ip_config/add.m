classdef add < azure.AzureBase
    ...
    methods
        function this = add()
            % az network application-gateway private-link ip-config add : Add an IP configuration to a Private
            % Link to scale up its capability.
            ...
            this.BaseCmd = 'az network application-gateway private-link ip-config add ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az network application-gateway private-link ip-config add"
