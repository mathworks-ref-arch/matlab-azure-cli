classdef wait < azure.AzureBase
    ...
    methods
        function this = wait()
            % az network application-gateway private-link wait : Place the CLI in a waiting state until the
            % condition of corresponding application gateway is met.
            % Command group 'network application-gateway private-link' is in preview. It may be
            % changed/removed in a future release.
            this.BaseCmd = 'az network application-gateway private-link wait ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az network application-gateway private-link wait"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network application-gateway private-link wait"')
