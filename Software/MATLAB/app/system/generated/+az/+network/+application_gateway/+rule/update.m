classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            ...
            this.BaseCmd = 'az network application-gateway rule update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    az network application-gateway rule update : Update a rule.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --address-pool      : The name or ID of the backend address pool.')
            fprintf('%s\n', '    --http-listener     : The name or ID of the HTTP listener.')
            fprintf('%s\n', '    --http-settings     : The name or ID of the backend HTTP settings.')
            fprintf('%s\n', '    --no-wait           : Do not wait for the long-running operation to finish.')
            fprintf('%s\n', '    --redirect-config   : The name or ID of the redirect configuration to use with the created rule.')
            fprintf('%s\n', '    --rewrite-rule-set  : The name or ID of the rewrite rule set.')
            fprintf('%s\n', '    --rule-type         : The rule type (Basic, PathBasedRouting).')
            ...
            fprintf('%s\n', '    --name -n           : The name of the request routing rule.')
            ...
            fprintf('%s\n', '        az network application-gateway rule update --address-pool MyAddressPool --gateway-name')
            fprintf('%s\n', '        MyAppGateway --name MyRule --resource-group MyResourceGroup')
            fprintf('%s\n', 'For more specific examples, use: az find "az network application-gateway rule update"')
