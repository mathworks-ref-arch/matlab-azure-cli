classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az network application-gateway waf-policy custom-rule show : Get the details of an application
            % gateway WAF policy custom rule.
            this.BaseCmd = 'az network application-gateway waf-policy custom-rule show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network application-gateway waf-policy custom-rule show --name MyWAFPolicyRule --policy-')
