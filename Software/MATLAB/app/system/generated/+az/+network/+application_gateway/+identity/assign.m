classdef assign < azure.AzureBase
    ...
    methods
        function this = assign()
            % az network application-gateway identity assign : Assign a managed service identity to an
            % application-gateway.
            this.BaseCmd = 'az network application-gateway identity assign ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network application-gateway identity assign -g MyResourceGroup --gateway-name ag1 \')
            fprintf('%s\n', '        --identity /subscriptions/*-000000000000/resourceGroups/myResourceGroup/providers/Microsoft.')
            fprintf('%s\n', '        ManagedIdentity/userAssignedIdentities/id1')
            fprintf('%s\n', 'For more specific examples, use: az find "az network application-gateway identity assign"')
