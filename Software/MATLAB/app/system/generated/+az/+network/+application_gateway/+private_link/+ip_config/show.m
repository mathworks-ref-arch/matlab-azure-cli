classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az network application-gateway private-link ip-config show : Show an IP configuration of a
            % Private Link.
            ...
            this.BaseCmd = 'az network application-gateway private-link ip-config show ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az network application-gateway private-link ip-config show"
