classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az network application-gateway rewrite-rule delete : Delete a rewrite rule.
            this.BaseCmd = 'az network application-gateway rewrite-rule delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network application-gateway rewrite-rule delete --gateway-name MyGateway --name')
