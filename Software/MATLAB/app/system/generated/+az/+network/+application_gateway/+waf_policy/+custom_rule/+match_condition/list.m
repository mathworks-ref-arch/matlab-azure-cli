classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az network application-gateway waf-policy custom-rule match-condition list : List application
            % gateway WAF policy custom rule match conditions.
            this.BaseCmd = 'az network application-gateway waf-policy custom-rule match-condition list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        MyWAFPolicyRule --policy-name MyPolicy --resource-group MyResourceGroup --subscription')
            fprintf('%s\n', '        MySubscription')
