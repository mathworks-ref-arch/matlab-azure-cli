classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            ...
            this.BaseCmd = 'az network application-gateway root-cert update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --name -n           : The name of the trusted root certificate.')
            ...
            fprintf('%s\n', '        az network application-gateway root-cert update --cert-file /path/to/cert/file --gateway-')
            fprintf('%s\n', '        name MyGateway --name MyTrustedRootCertificate --resource-group MyResourceGroup')
            fprintf('%s\n', 'For more specific examples, use: az find "az network application-gateway root-cert update"')
