classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            ...
            this.BaseCmd = 'az network application-gateway frontend-ip update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network application-gateway frontend-ip update --gateway-name MyAppGateway --name')
            fprintf('%s\n', '        MyFrontendIp --private-ip-address 10.10.10.50 --resource-group MyResourceGroup')
            fprintf('%s\n', 'For more specific examples, use: az find "az network application-gateway frontend-ip update"')
