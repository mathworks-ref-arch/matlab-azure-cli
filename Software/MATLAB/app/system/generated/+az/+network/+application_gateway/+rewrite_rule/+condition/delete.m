classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az network application-gateway rewrite-rule condition delete : Delete a rewrite rule condition.
            this.BaseCmd = 'az network application-gateway rewrite-rule condition delete ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az network application-gateway rewrite-rule condition delete"
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    az network application-gateway rewrite-rule condition delete : Delete a rewrite rule condition.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --variable [Required] : The variable whose value is being evaluated.')
