classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            ...
            this.BaseCmd = 'az network application-gateway url-path-map show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network application-gateway url-path-map show -g MyResourceGroup --gateway-name')
            fprintf('%s\n', '        MyAppGateway -n MyUrlPathMap')
            fprintf('%s\n', 'For more specific examples, use: az find "az network application-gateway url-path-map show"')
