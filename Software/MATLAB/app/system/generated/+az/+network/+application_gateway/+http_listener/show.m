classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            ...
            this.BaseCmd = 'az network application-gateway http-listener show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network application-gateway http-listener show -g MyResourceGroup --gateway-name')
            fprintf('%s\n', '        MyAppGateway -n MyHttpListener')
            fprintf('%s\n', 'For more specific examples, use: az find "az network application-gateway http-listener show"')
