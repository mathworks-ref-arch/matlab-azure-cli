classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az network application-gateway waf-config show : Get the firewall configuration of a web
            % application.
            ...
            this.BaseCmd = 'az network application-gateway waf-config show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network application-gateway waf-config show -g MyResourceGroup --gateway-name')
            fprintf('%s\n', '        MyAppGateway')
            fprintf('%s\n', 'For more specific examples, use: az find "az network application-gateway waf-config show"')
