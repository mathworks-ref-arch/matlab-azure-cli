classdef remove < azure.AzureBase
    ...
    methods
        function this = remove()
            % az network application-gateway identity remove : Remove the managed service identity of an
            % application-gateway.
            this.BaseCmd = 'az network application-gateway identity remove ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network application-gateway identity remove"')
