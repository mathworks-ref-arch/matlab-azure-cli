classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az network application-gateway rewrite-rule condition list : List rewrite rule conditions.
            this.BaseCmd = 'az network application-gateway rewrite-rule condition list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network application-gateway rewrite-rule condition list --gateway-name MyGateway')
            fprintf('%s\n', '        --resource-group MyResourceGroup --rule-name MyRule --rule-set-name MyRuleSet')
