classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            ...
            this.BaseCmd = 'az network application-gateway frontend-port delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network application-gateway frontend-port delete -g MyResourceGroup --gateway-name')
            fprintf('%s\n', '        MyAppGateway -n MyFrontendPort')
            fprintf('%s\n', 'For more specific examples, use: az find "az network application-gateway frontend-port')
            fprintf('%s\n', 'delete"')
