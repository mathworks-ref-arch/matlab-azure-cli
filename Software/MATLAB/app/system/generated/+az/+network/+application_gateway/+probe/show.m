classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            ...
            this.BaseCmd = 'az network application-gateway probe show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network application-gateway probe show -g MyResourceGroup --gateway-name MyAppGateway -n')
            fprintf('%s\n', '        MyProbe')
            fprintf('%s\n', 'For more specific examples, use: az find "az network application-gateway probe show"')
