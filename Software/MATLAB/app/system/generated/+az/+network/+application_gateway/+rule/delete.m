classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            ...
            this.BaseCmd = 'az network application-gateway rule delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'Examples')
            fprintf('%s\n', '    Delete a rule.')
            fprintf('%s\n', '        az network application-gateway rule delete -g MyResourceGroup --gateway-name MyAppGateway -n')
            fprintf('%s\n', '        MyRule')
            fprintf('%s\n', 'For more specific examples, use: az find "az network application-gateway rule delete"')
