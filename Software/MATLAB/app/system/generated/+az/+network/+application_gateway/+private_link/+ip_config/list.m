classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az network application-gateway private-link ip-config list : List all the IP configuration of a
            % Private Link.
            ...
            this.BaseCmd = 'az network application-gateway private-link ip-config list ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az network application-gateway private-link ip-config list"
