classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az network application-gateway waf-policy policy-setting list : List properties of a web
            % application firewall global configuration.
            this.BaseCmd = 'az network application-gateway waf-policy policy-setting list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network application-gateway waf-policy policy-setting list --policy-name MyPolicy')
