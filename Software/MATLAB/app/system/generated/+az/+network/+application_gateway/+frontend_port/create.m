classdef create < azure.AzureBase
    ...
    methods
        function this = create()
            ...
            this.BaseCmd = 'az network application-gateway frontend-port create ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --name -n           [Required] : The name of the frontend port.')
            ...
            fprintf('%s\n', '        az network application-gateway frontend-port create -g MyResourceGroup --gateway-name')
            fprintf('%s\n', '        MyAppGateway \')
