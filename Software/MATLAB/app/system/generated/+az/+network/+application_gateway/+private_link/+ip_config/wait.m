classdef wait < azure.AzureBase
    ...
    methods
        function this = wait()
            % az network application-gateway private-link ip-config wait : Place the CLI in a waiting state
            % until the condition of corresponding application gateway is met.
            ...
            this.BaseCmd = 'az network application-gateway private-link ip-config wait ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az network application-gateway private-link ip-config wait"
