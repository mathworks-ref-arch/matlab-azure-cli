classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az network application-gateway rewrite-rule show : Get the details of a rewrite rule.
            this.BaseCmd = 'az network application-gateway rewrite-rule show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network application-gateway rewrite-rule show --gateway-name MyGateway --name')
            fprintf('%s\n', '        MyRewriteRule --resource-group MyResourceGroup --rule-set-name MyRuleSet')
            fprintf('%s\n', 'For more specific examples, use: az find "az network application-gateway rewrite-rule show"')
