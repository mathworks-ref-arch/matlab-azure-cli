classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az network application-gateway rewrite-rule set update : Update a rewrite rule set.
            this.BaseCmd = 'az network application-gateway rewrite-rule set update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'Examples')
            fprintf('%s\n', '    Update a rewrite rule set. (autogenerated)')
            fprintf('%s\n', '        az network application-gateway rewrite-rule set update --gateway-name MyGateway --name')
            fprintf('%s\n', '        MyRewriteRuleSet --resource-group MyResourceGroup')
