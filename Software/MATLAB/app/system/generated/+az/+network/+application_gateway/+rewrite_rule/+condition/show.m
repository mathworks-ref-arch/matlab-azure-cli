classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az network application-gateway rewrite-rule condition show : Get the details of a rewrite rule
            % condition.
            this.BaseCmd = 'az network application-gateway rewrite-rule condition show ';
        end
        ...
        function this = verbose(this, varargin)
            % Increase logging verbosity. Use --debug for full debug logs. For more specific examples, use: az find "az network application-gateway rewrite-rule condition show"
