classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az network application-gateway identity show : Show the managed service identity of an
            % application-gateway.
            this.BaseCmd = 'az network application-gateway identity show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network application-gateway identity show"')
