classdef wait < azure.AzureBase
    ...
    methods
        function this = wait()
            % az network application-gateway wait : Place the CLI in a waiting state until a condition of the
            % application gateway is met.
            this.BaseCmd = 'az network application-gateway wait ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network application-gateway wait"')
