classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az network route-filter update : Update a route filter.
            % This command can only be used to update the tags for a route filter. Name and resource group
            % are immutable and cannot be updated.
            % Command group 'network route-filter' is in preview. It may be changed/removed in a
            % future release.
            this.BaseCmd = 'az network route-filter update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        future release.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --name -n           [Required] : Name of the route filter.')
            ...
            fprintf('%s\n', '        az network route-filter update -g MyResourceGroup -n MyRouteFilter --set')
            fprintf('%s\n', '        tags.CostCenter=MyBusinessGroup')
            fprintf('%s\n', 'For more specific examples, use: az find "az network route-filter update"')
