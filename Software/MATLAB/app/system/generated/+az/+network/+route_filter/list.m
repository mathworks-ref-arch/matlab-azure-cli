classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az network route-filter list : List route filters.
            % Command group 'network route-filter' is in preview. It may be changed/removed in a
            % future release.
            this.BaseCmd = 'az network route-filter list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network route-filter list"')
