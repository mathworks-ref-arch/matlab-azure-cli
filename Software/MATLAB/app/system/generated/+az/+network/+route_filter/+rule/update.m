classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az network route-filter rule update : Update a rule in a route filter.
            % Command group 'network route-filter' is in preview. It may be changed/removed in a
            % future release.
            this.BaseCmd = 'az network route-filter rule update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network route-filter rule update"')
