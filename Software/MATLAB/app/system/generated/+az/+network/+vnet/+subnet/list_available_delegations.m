classdef list_available_delegations < azure.AzureBase

    % Copyright 2020, The MathWorks Inc.

    methods
        function this = list_available_delegations()
            % az network vnet subnet list-available-delegations : List the services available for subnet
            % delegation.
            this.BaseCmd = 'az network vnet subnet list-available-delegations ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network vnet subnet list-available-delegations"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class list_available_delegations 
