classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            ...
            this.BaseCmd = 'az network vnet subnet delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network vnet subnet delete --name MySubnet --resource-group MyResourceGroup --vnet-name')
            fprintf('%s\n', '        MyVnet')
            fprintf('%s\n', 'For more specific examples, use: az find "az network vnet subnet delete"')
