classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az network service-endpoint policy-definition list : List service endpoint policy definitions.
            this.BaseCmd = 'az network service-endpoint policy-definition list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network service-endpoint policy-definition list --policy-name MyPolicy --resource-group')
