classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            % az network service-endpoint policy-definition update : Update a service endpoint policy
            % definition.
            this.BaseCmd = 'az network service-endpoint policy-definition update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --service-resources : Space-separated list of service resources the definition applies to.')
            ...
            fprintf('%s\n', '    --name -n           : Name of the service endpoint policy definition.')
            fprintf('%s\n', '    --policy-name       : Name of the service endpoint policy.')
            ...
            fprintf('%s\n', '        az network service-endpoint policy-definition update --add communities=''12076:5010'' --name')
            fprintf('%s\n', '        MyServiceEndpointPolicyDefinition --policy-name MyPolicy --resource-group MyResourceGroup')
