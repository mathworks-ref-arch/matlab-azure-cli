classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            % az network traffic-manager endpoint show : Get the details of a traffic manager endpoint.
            this.BaseCmd = 'az network traffic-manager endpoint show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network traffic-manager endpoint show"')
