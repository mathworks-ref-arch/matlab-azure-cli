classdef list < azure.AzureBase
    ...
    methods
        function this = list()
            % az network traffic-manager endpoint list : List traffic manager endpoints.
            this.BaseCmd = 'az network traffic-manager endpoint list ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --type -t                      : Endpoint type.  Allowed values: azureEndpoints,')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network traffic-manager endpoint list"')
