classdef delete < azure.AzureBase
    ...
    methods
        function this = delete()
            % az network traffic-manager endpoint delete : Delete a traffic manager endpoint.
            this.BaseCmd = 'az network traffic-manager endpoint delete ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        -n MyEndpoint --type azureEndpoints')
            fprintf('%s\n', '    Delete a traffic manager endpoint. (autogenerated)')
            fprintf('%s\n', '        az network traffic-manager endpoint delete --name MyEndpoint --profile-name MyTmProfile')
            fprintf('%s\n', '        --resource-group MyResourceGroup --subscription MySubscription --type azureEndpoints')
            fprintf('%s\n', 'For more specific examples, use: az find "az network traffic-manager endpoint delete"')
