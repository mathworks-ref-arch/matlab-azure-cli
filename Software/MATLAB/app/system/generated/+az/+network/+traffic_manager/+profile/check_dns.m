classdef check_dns < azure.AzureBase

    % Copyright 2020, The MathWorks Inc.

    methods
        function this = check_dns()
            ...
            this.BaseCmd = 'az network traffic-manager profile check-dns ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network traffic-manager profile check-dns"')
            fprintf('%s\n', 'Please let us know how we are doing: https://aka.ms/azureclihats')
        end
    end
end % End of class check_dns 
