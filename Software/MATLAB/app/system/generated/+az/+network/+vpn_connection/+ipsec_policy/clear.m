classdef clear < azure.AzureBase
    ...
    methods
        function this = clear()
            ...
            this.BaseCmd = 'az network vpn-connection ipsec-policy clear ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '        az network vpn-connection ipsec-policy clear -g MyResourceGroup --connection-name')
            fprintf('%s\n', '        MyConnection')
            fprintf('%s\n', 'For more specific examples, use: az find "az network vpn-connection ipsec-policy clear"')
