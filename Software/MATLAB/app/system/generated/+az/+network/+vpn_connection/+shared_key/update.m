classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            ...
            this.BaseCmd = 'az network vpn-connection shared-key update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    az network vpn-connection shared-key update : Update a VPN connection shared key.')
            fprintf('%s\n', 'Arguments')
            fprintf('%s\n', '    --value  [Required] : The virtual network connection shared key value.')
            fprintf('%s\n', '    --id                : Resource ID.')
            ...
            fprintf('%s\n', '        az network vpn-connection shared-key update -g MyResourceGroup --connection-name')
            fprintf('%s\n', '        MyConnection --value Abc123')
            fprintf('%s\n', '    Update a VPN connection shared key. (autogenerated)')
            fprintf('%s\n', '        az network vpn-connection shared-key update --connection-name MyConnection --resource-group')
            fprintf('%s\n', '        MyResourceGroup --subscription MySubscription --value Abc123')
            fprintf('%s\n', 'For more specific examples, use: az find "az network vpn-connection shared-key update"')
