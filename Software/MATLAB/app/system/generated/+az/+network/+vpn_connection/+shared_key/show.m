classdef show < azure.AzureBase
    ...
    methods
        function this = show()
            ...
            this.BaseCmd = 'az network vpn-connection shared-key show ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    Retrieve a VPN connection shared key. (autogenerated)')
            fprintf('%s\n', '        az network vpn-connection shared-key show --connection-name MyConnection --resource-group')
            fprintf('%s\n', '        MyResourceGroup --subscription MySubscription')
            fprintf('%s\n', 'For more specific examples, use: az find "az network vpn-connection shared-key show"')
