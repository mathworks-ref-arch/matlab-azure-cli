classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            ...
            % This command can only be used to update the tags for an application security group. Name and
            % resource group are immutable and cannot be updated.
            this.BaseCmd = 'az network asg update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --name -n           : The name of the application security group.')
            ...
            fprintf('%s\n', 'For more specific examples, use: az find "az network asg update"')
