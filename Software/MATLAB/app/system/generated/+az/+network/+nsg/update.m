classdef update < azure.AzureBase
    ...
    methods
        function this = update()
            ...
            % This command can only be used to update the tags of an NSG. Name and resource group are
            % immutable and cannot be updated.
            this.BaseCmd = 'az network nsg update ';
        end
    ...
    methods (Static = true)
        function help(~)
            ...
            fprintf('%s\n', '    --name -n           : Name of the network security group.')
            ...
            fprintf('%s\n', '        az network nsg update --name MyNsg --resource-group MyResourceGroup --set')
            fprintf('%s\n', '        tags.CostCenter=MyBusinessGroup')
            fprintf('%s\n', 'For more specific examples, use: az find "az network nsg update"')
